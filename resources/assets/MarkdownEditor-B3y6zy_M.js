import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{i as t}from"./src-ZrWcv8kM.js";import{At as n,Dt as r,Et as i,J as a,Ot as o,Tt as s,bt as c,jt as l,t as u,wt as d,xt as f}from"./src-TXtvocpz.js";import{B as p,Bt as m,I as h,L as g,Lt as _,N as ee,Nt as te,g as v,j as y,jt as ne,nt as re}from"./OPFS-WcvpNv6j.js";import{c as ie,g as b,p as x,s as S,v as C,y as ae}from"./ecosystem-skus-Bz92tN57.js";import{n as oe,t as w}from"./preload-helper-DFTwEg7x.js";import{_ as se,a as ce,g as le,h as ue,n as de,v as fe}from"./registry-D9EPHR_5.js";import{a as pe,f as me}from"./UnifiedMessaging-DLBZRnRi.js";import{a as he,n as ge,r as _e,t as ve}from"./view-ingress-validation-BFwuw_Yo.js";import{h as ye,m as be,o as xe,p as Se,r as Ce,s as we}from"./open-policy-DV4wO_gQ.js";import{a as Te,o as T}from"./Settings-kVSqy0Nt.js";import{a as Ee,d as E,l as D,u as O}from"./Base64Data-Dn-vYTrP.js";import{S as k,a as De,b as Oe,d as A,g as ke,h as Ae,i as je,l as Me,o as j,p as Ne,u as Pe,v as M,x as Fe,y as Ie}from"./markdown-assets-YuK9363c.js";import{i as Le,o as Re,s as ze}from"./icon-C6atVd0v.js";import{_ as Be,a as N,c as P,g as Ve,h as F,i as He,n as Ue,o as We}from"./storage-bridge-BX3aqg3G.js";import{n as Ge,o as Ke,r as qe,s as Je}from"./render-DLWeqYav.js";import{l as I,n as Ye,s as Xe}from"./sku-ingress-Bz4a0XHD.js";import{n as Ze,t as Qe}from"./registry-CXAYuDcM.js";import{a as $e,i as L,t as R}from"./channel-actions-DkmBPovk.js";import{a as et,i as tt,r as nt,t as rt}from"./highlight-elZpRW0e.js";function it(e){return{load(){try{let t=localStorage.getItem(e);return t?JSON.parse(t):null}catch{return null}},save(t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}},clear(){try{localStorage.removeItem(e)}catch{}}}}function at(){return a`
        <div
    ...
    `}function st(){let e=a`<div class="view-viewer__chrome" data-viewer-chrome></div>`;return e.append(at(),ot()),e}function z(){return(z=e((()=>{u()})))()}function ct(e){let t=document.createElement(`pre`);t.className=`markdown-viewer-raw`,t.toggleAttribute(`data-raw-target`,!0),t.setAttribute(`aria-label`,`Raw content`),t.hidden=!0,e?.slot&&(t.slot=e.slot);let n=document.createElement(`code`);return n.className=`code-highlight-source`,n.setAttribute(`contenteditable`,`plaintext-only`),n.setAttribute(`spellcheck`,`false`),n.setAttribute(`autocapitalize`,`off`),n.setAttribute(`autocorrect`,`off`),t.appendChild(n),t}function lt(){return(lt=e((()=>{u()})))()}var ut,dt,ft,B;function pt(){return(pt=e((()=>{u(),pe(),ut=e=>{if(typeof e==`string`||typeof Blob<`u`&&e instanceof Blob)return e;if(e&&typeof e==`object`&&`data`in e){let t=e.data;if(typeof t==`string`||t&&typeof Blob<`u`&&t instanceof Blob)return t}return null},dt=e=>String(e||`attachment`).toLowerCase().replace(/[^a-z0-9-]/g,`-`).replace(/-+/g,`-`).replace(/^-+|-+$/g,``)||`attachment`,ft=async(e,t=`view-ipc`)=>{let n=[];for(let r of e){let e=ut(r);if(e)try{let i=r&&typeof r==`object`&&`source`in r?String(r.source||t):t,a=await O(e,{namePrefix:dt(i),uriComponent:!0});n.push({hash:String(a.hash||``),name:String(a.name||a.file?.name||`attachment`),mimeType:String(a.type||a.file?.type||`application/octet-stream`),size:Number(a.size||a.file?.size||0),source:i,data:a.file})}catch(e){console.warn(`[UniformViewTransport] Attachment normalization failed:`,e)}}return n},B=async e=>{let n=await ft(e.attachments||[],e.source),r={...e.data||{},...n.length>0?{attachments:n,file:n[0]?.data,files:n.map(e=>e.data)}:{}},i=t({type:e.type,source:e.source,destination:e.destination,contentType:e.contentType,data:r,purpose:e.purpose||(n.length>0?[`attach`,`deliver`]:[`deliver`,`mail`]),protocol:`window`,op:e.op||(n.length>0?`attach`:`deliver`),srcChannel:e.source,dstChannel:e.destination,metadata:{...e.metadata||{},attachmentCount:n.length}});return me(i)}})))()}function mt(e){return e===`light`||e===`dark`?e:typeof globalThis.matchMedia==`function`&&globalThis.matchMedia(`(prefers-color-scheme: light)`).matches?`light`:`dark`}function V(e){if(e===`light`||e===`dark`||e===`system`)return e;if(typeof e==`string`){let t=e.trim().toLowerCase();if(t===`light`||t===`dark`||t===`system`)return t}}function ht(e){if(e!=null){if(typeof e==`string`)return V(e.trim());if(typeof e==`object`){let t=e;return V(t.colorScheme??t.scheme??t.theme)}}}function gt(e){if(e)return e.colorScheme?e.colorScheme:V(e.params?.colorScheme??e.params?.theme)}var H;function _t(){return(_t=e((()=>{H=`/*
...
@scope (markdown-view,
  ...
  @layer base {
    ...
    */
    ...
    html[data-vk-open] .cw-view-viewer-shell,
    html[data-vk-open] .view-viewer,
    :host-context(html[data-vk-open]) .cw-view-viewer-shell,
    :host-context(html[data-vk-open]) .view-viewer {
      min-block-size: 0;
      block-size: 100%;
      max-block-size: 100%;
    }
