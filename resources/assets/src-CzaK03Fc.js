import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{$ as t,A as n,At as r,Ct as i,F as a,Ft as o,G as s,J as c,Mt as l,N as u,P as d,Pt as f,Q as p,R as m,V as h,W as g,X as _,Z as ee,_t as v,ct as y,h as b,it as x,kt as S,q as C,rt as w,t as T,tt as E,vt as D,z as O}from"./src-Df9qw5g4.js";import{Bt as k,Ct as A,Et as te,Lt as ne,Mt as re,Nt as j,Rt as M,W as ie,wt as ae,zt as oe}from"./OPFS-DerEKBql.js";import{n as se,t as ce}from"./preload-helper-DFTwEg7x.js";import{o as N,r as le}from"./image-DMBFUs7g.js";import{o as ue,s as P}from"./icon-P0jJel5-.js";import{i as F,l as de,o as fe,p as pe,r as me,t as he,u as ge}from"./storage-bridge-IG4cbt3b.js";import{A as _e,C as ve,D as ye,E as be,F as xe,I as Se,L as Ce,M as we,N as Te,O as Ee,P as De,S as Oe,T as ke,_ as Ae,a as je,b as Me,c as Ne,d as Pe,f as Fe,g as Ie,h as Le,i as Re,j as ze,k as Be,l as Ve,m as He,n as Ue,o as We,r as Ge,s as Ke,t as qe,u as Je,v as Ye,w as Xe,x as Ze,y as Qe}from"./launcher-state-C3sIO3Bx.js";import{r as $e}from"./render-DLWeqYav.js";function I(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}function et(){return(et=e((()=>{})))()}var L,tt;function R(){return(R=e((()=>{T(),S(),P(),L=class extends g(){theme=`default`;render(e){return c`<slot></slot>`}constructor(){super()}onRender(){return super.onRender()}connectedCallback(){let e=super.connectedCallback?.()??this;return e.loadStyleLibrary(ue()),i(e),e}onInitialize(){let e=super.onInitialize()??this;return e.loadStyleLibrary(ue()),e}},I([C({source:`attr`})],L.prototype,`theme`,void 0),L=I([s(`ui-element`)],L),tt=L})))()}var nt,rt,it,at,ot,st,ct,lt,ut,dt,z,ft,pt,mt;function ht(){return(ht=e((()=>{T(),nt=`2147483600`,rt=new Map,it=new Map,at=null,ot=[`[data-chrome-flyout-anchor]`,`.env-shell-taskbar__clock`,`.env-ui-statusbar__clock`,`.env-device-tray`,`.speed-dial-chrome-rail`,`.speed-dial-core-rail`],st=e=>e&&(e.dataset.chromeFlyoutSide===`start`||e.closest?.(`.speed-dial-chrome-rail, [data-chrome-flyout-side='start']`))?`start`:`end`,ct=()=>{if(typeof document<`u`){if(document.querySelector(`.env-shell-chrome[data-desktop]`))return!0;let e=document.querySelector(`[data-chrome-layout]`);if(e?.dataset.chromeLayout===`desktop`)return!0;if(e?.dataset.chromeLayout===`mobile`)return!1}return typeof matchMedia<`u`&&matchMedia(`(min-width: 641px)`).matches},lt=e=>{at=e},ut=e=>{let t=`data-env-shell-overlays`,n=e||at||document.querySelector(`.env-shell-root`)||document.querySelector(`#app`)||document.body,r=n.querySelector(`[${t}]`);if(r)return r.style.zIndex||(r.style.zIndex=nt),r;try{let e=globalThis.__ENV_OVERLAY_MOUNT__;if(typeof e==`function`)return e(n)}catch{}let i=document.createElement(`div`);return i.setAttribute(t,``),i.className=`env-shell-overlays`,i.setAttribute(`data-part`,`env-overlays`),i.style.cssText=`position:fixed;inset:0;pointer-events:none;z-index:${nt};box-sizing:border-box;`,n.appendChild(i),i},dt=(e,t,n)=>{let r=ct(),i=n?.align??st(n?.anchor);if(e.dataset.flyoutAlign=i,e.style.position=`fixed`,e.style.zIndex=String(Number(nt)+1),e.style.pointerEvents=`auto`,e.style.margin=`0`,r){e.style.top=`auto`,e.style.bottom=`4.5rem`,e.style.transform=`none`,i===`start`?(e.style.left=`0.75rem`,e.style.right=`auto`):(e.style.left=`auto`,e.style.right=`0.75rem`);return}if(t===`calendar`){e.style.top=`50%`,e.style.left=`50%`,e.style.right=`auto`,e.style.bottom=`auto`,e.style.transform=`translate(-50%, -50%)`;return}e.style.top=`calc(env(safe-area-inset-top, 0px) + 0.75rem)`,e.style.left=`50%`,e.style.right=`auto`,e.style.bottom=`auto`,e.style.transform=`translateX(-50%)`},z=e=>{let t=rt.get(e);if(!t)return;rt.delete(e);let n=it.get(e);it.delete(e),n?.disposeDismiss(),n?.unregisterBack();try{let e=t.el;typeof e.close==`function`?e.close():(e.removeAttribute(`open`),e.hidden=!0),e.dispatchEvent(new CustomEvent(`chrome-flyout-close`,{bubbles:!0}))}catch{}},ft=e=>{rt.has(e.kind)&&z(e.kind);for(let t of[...rt.keys()])t!==e.kind&&z(t);rt.set(e.kind,{...e,close:()=>z(e.kind)}),e.el.hidden=!1,e.el.removeAttribute(`hidden`),e.el.setAttribute(`open`,``),it.set(e.kind,{disposeDismiss:a({root:document,inside:e.el,isInside:t=>e.contains(t.target),exceptSelectors:ot,onDismiss:()=>z(e.kind)}),unregisterBack:u({id:`chrome-flyout-${e.kind}`,kind:`overlay`,element:e.el,isActive:()=>rt.get(e.kind)?.el===e.el&&e.el.isConnected&&!e.el.hidden&&e.el.hasAttribute(`open`),close:()=>(z(e.kind),!0)})})},pt=e=>rt.has(e),mt=(e,t)=>{if(pt(e)){z(e);return}let n=t();ft(n)}})))()}var gt;function _t(){return(_t=e((()=>{gt=`/*
...
@layer components {
  ...
  .ui-cal-flyout__day[data-today][data-selected] {
    box-shadow: 0 0 0 2px color-mix(in oklab, var(--cal-base-color) 70%, #fff 20%) inset;
...
}`})))()}function vt(e){try{let t=new Intl.Locale(e),n=(t.weekInfo??t.getWeekInfo?.())?.firstDay;if(typeof n==`number`&&n>=1&&n<=7)return n%7}catch{}return 0}function yt(e,t){let n=new Intl.DateTimeFormat(e,{weekday:`short`,timeZone:`UTC`}),r=[];for(let e=0;e<7;e++){let i=(t+e)%7;r.push(n.format(new Date(Et+i*Dt)))}return r}function bt(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}function xt(e,t,n){let r=new Date,i=new Date(e,t,1),a=new Date(e,t+1,0).getDate(),o=(i.getDay()-n+7)%7,s=Math.ceil((o+a)/7)*7,c=[];for(let n=0;n<s;n++){let i=n-o+1,a=new Date(e,t,i);c.push({date:a,day:a.getDate(),otherMonth:a.getMonth()!==t,isToday:bt(a,r)})}return c}function St(){if(kt?.isConnected)return kt;let e=ut(),t=e.querySelector(`ui-calendar-flyout`);return t||(t=document.createElement(`ui-calendar-flyout`),t.hidden=!0,e.appendChild(t)),kt=t,t}function Ct(e){mt(Tt,()=>{let t=St(),n=document.documentElement.getAttribute(`data-theme`);return(n===`light`||n===`dark`)&&(t.dataset.theme=n,t.style.colorScheme=n),dt(t,Tt,{anchor:e}),t.open(),{kind:Tt,el:t,close:()=>{t.close(),z(Tt)},contains:e=>e instanceof Node&&t.contains(e)}})}var wt,Tt,Et,Dt,Ot,kt;function At(){return(At=e((()=>{T(),y(),S(),R(),P(),ht(),_t(),wt=f(gt),Tt=`calendar`,Et=Date.UTC(2023,0,1),Dt=864e5,Ot=class extends L{#e;#t;#n=null;#r=null;styles=function(){return wt};render=function(){return c`<div class="ui-cal-flyout__panel" part="panel">
        ...
        </div>`};constructor(){super();let e=new Date;this.#e=e.getFullYear(),this.#t=e.getMonth()}onRender(){super.onRender(),this.#i(),this.#c()}disconnectedCallback(){this.#r?.(),this.#r=null,super.disconnectedCallback?.()}#i(){let e=this.shadowRoot;if(!e||this.#r)return;let t=D(e,`click`,e=>{let t=e.target,n=t?.closest?.(`[data-nav]`);if(n){n.dataset.nav===`prev`?this.#a(-1):n.dataset.nav===`next`&&this.#a(1);return}let r=t?.closest?.(`.ui-cal-flyout__day`);r&&this.#s(r)});this.#r=()=>t?.()}#a(e){this.#t+=e,this.#t<0?(this.#t=11,--this.#e):this.#t>11&&(this.#t=0,this.#e+=1),this.#c()}#o(){let e=new Date;this.#e=e.getFullYear(),this.#t=e.getMonth(),this.#c()}#s(e){let t=e.dataset.date;t&&(this.#n=new Date(t),this.shadowRoot?.querySelectorAll(`.ui-cal-flyout__day[data-selected]`)?.forEach(e=>e.removeAttribute(`data-selected`)),e.setAttribute(`data-selected`,``),this.dispatchEvent(new CustomEvent(`calendar-select`,{bubbles:!0,composed:!0,detail:{date:this.#n}})))}#c(){let e=this.shadowRoot;if(!e)return;let t=typeof navigator<`u`?navigator.language:void 0,n=vt(t??`en-US`),r=new Date,i=e.querySelector(`.ui-cal-flyout__today`);i&&(i.textContent=r.toLocaleDateString(t,{weekday:`long`,month:`long`,day:`numeric`,year:`numeric`}));let a=e.querySelector(`.ui-cal-flyout__month-label`);a&&(a.textContent=new Date(this.#e,this.#t,1).toLocaleDateString(t,{month:`long`,year:`numeric`}));let o=e.querySelector(`.ui-cal-flyout__weekdays`);o&&o.replaceChildren(...yt(t??`en-US`,n).map(e=>{let t=document.createElement(`span`);return t.className=`ui-cal-flyout__weekday`,t.setAttribute(`role`,`columnheader`),t.textContent=e,t}));let s=e.querySelector(`.ui-cal-flyout__grid`);if(s){let e=xt(this.#e,this.#t,n);s.replaceChildren(...e.map(e=>{let n=document.createElement(`button`);return n.type=`button`,n.className=`ui-cal-flyout__day`,n.textContent=String(e.day),n.dataset.date=e.date.toISOString(),n.setAttribute(`role`,`gridcell`),e.otherMonth&&n.setAttribute(`data-other-month`,``),e.isToday&&n.setAttribute(`data-today`,``),this.#n&&bt(e.date,this.#n)&&n.setAttribute(`data-selected`,``),n.setAttribute(`aria-label`,e.date.toLocaleDateString(t,{weekday:`long`,month:`long`,day:`numeric`,year:`numeric`})),n}))}}open(){this.#o(),this.removeAttribute(`hidden`),this.hidden=!1,this.setAttribute(`open`,``)}close(){this.hidden=!0,this.setAttribute(`hidden`,``),this.removeAttribute(`open`)}toggle(e){this.hasAttribute(`open`)?this.close():this.open()}},Ot=I([s(`ui-calendar-flyout`)],Ot),kt=null})))()}function jt(){let e=Ft.get();return typeof e==`function`?e:null}var Mt,Nt,Pt,Ft;function It(){return(It=e((()=>{Mt=`__CWSP_SPEED_DIAL_VIEW_OPENER_V1__`,Nt=`__CWSP_HOME_OVERLAY_MOUNT_V1__`,Pt=e=>{let t=globalThis;return{get:()=>e in t?t[e]:null,set:n=>{t[e]=n}}},Ft=Pt(Mt),Pt(Nt)})))()}var Lt;function Rt(){return(Rt=e((()=>{Lt=`/*
...
}`})))()}function zt(){if(vn?.isConnected)return vn;let e=ut(),t=e.querySelector(`ui-quick-settings`);return t||(t=document.createElement(`ui-quick-settings`),t.hidden=!0,e.appendChild(t)),vn=t,t}function Bt(e){mt(Ut,()=>{let t=zt(),n=document.documentElement.getAttribute(`data-theme`);return(n===`light`||n===`dark`)&&(t.dataset.theme=n,t.style.colorScheme=n),dt(t,Ut,{anchor:e}),t.open(),{kind:Ut,el:t,close:()=>{t.close(),z(Ut)},contains:e=>e instanceof Node&&t.contains(e)}})}function Vt(){z(Ut)}var Ht,Ut,Wt,Gt,Kt,qt,Jt,Yt,Xt,Zt,Qt,$t,en,tn,nn,rn,an,on,sn,cn,ln,un,dn,fn,pn,mn,hn,gn,_n,vn;function yn(){return(yn=e((()=>{T(),y(),S(),R(),P(),It(),ht(),Rt(),Ht=f(Lt),Ut=`quick-settings`,Wt=`data-theme`,Gt=`rs-appearance-theme`,Kt=`appearance.theme`,qt=[`rs-settings`,`cwsp-settings`,`u2-settings`],Jt=()=>{try{return matchMedia?.(`(prefers-color-scheme: dark)`)?.matches??!0}catch{return!0}},Yt=e=>{for(let t of qt)try{let n=localStorage.getItem(t);if(!n)continue;let r=JSON.parse(n);if(!r||typeof r!=`object`)continue;r.appearance={...r.appearance??{},theme:e},localStorage.setItem(t,JSON.stringify(r))}catch{}},Xt=()=>{try{let e=document.documentElement.getAttribute(Wt);if(e===`light`||e===`dark`)return e;let t=localStorage.getItem(Gt);if(t===`light`||t===`dark`)return t}catch{}return Jt()?`dark`:`light`},Zt=e=>{let t=document.documentElement,n=e===`auto`?Jt()?`dark`:`light`:e,r=e===`auto`?`auto`:e;t.setAttribute(`data-scheme`,r),t.setAttribute(Wt,n),t.style.colorScheme=n;try{document.body&&(document.body.style.colorScheme=n)}catch{}try{document.querySelectorAll(`.env-shell-root, [data-shell], ui-window`).forEach(e=>{let t=e;t.dataset.theme=n,t.style.colorScheme=n;let r=t.shadowRoot?.querySelector?.(`.app-shell`);r&&(r.dataset.theme=n,r.style.colorScheme=n)})}catch{}try{localStorage.setItem(Gt,e===`auto`?`auto`:e),localStorage.setItem(Kt,e===`auto`?`auto`:e)}catch{}e!==`auto`&&Yt(e),t.dispatchEvent(new CustomEvent(`u2-theme-change`,{bubbles:!0,detail:{source:`quick-settings`,theme:n,preference:e}}))},Qt=()=>{try{let e=String(localStorage.getItem(Gt)||``).trim().toLowerCase();if(e===`light`||e===`dark`||e===`auto`)return e;let t=String(localStorage.getItem(Kt)||``).trim().toLowerCase();if(t===`light`||t===`dark`||t===`auto`)return t}catch{}return`auto`},$t=()=>{let e=globalThis;if(e.__CWSP_AUTO_THEME_FOLLOW__)return;e.__CWSP_AUTO_THEME_FOLLOW__=!0;let t=typeof matchMedia==`function`?matchMedia(`(prefers-color-scheme: dark)`):null;if(!t)return;let n=()=>{Qt()===`auto`&&Zt(`auto`)};try{t.addEventListener(`change`,n)}catch{try{t.addListener(n)}catch{}}try{n()}catch{}},en=e=>{document.documentElement.style.setProperty(`--orientation-lock`,e?`unlocked`:`locked`),document.documentElement.style.setProperty(`--orientation-lock-angle`,e?`0deg`:`90deg`),Promise.try(async()=>{try{let t=screen.orientation;if(e){t.unlock?.();return}if(typeof t.lock!=`function`)return;let n=t.lock(t.type||`natural`);n&&typeof n.catch==`function`&&await n.catch(()=>{})}catch(e){console.warn(e)}})?.catch?.(console.warn.bind(console))},tn=`env-night-filter`,nn=`2147483001`,rn=`rs-night-filter`,an=`rs-brightness-filter`,on=e=>Math.max(0,Math.min(100,Number.isFinite(e)?e:0)),sn=()=>{let e=document.getElementById(tn);if(e instanceof HTMLElement)return e;let t=document.createElement(`div`);return t.id=tn,t.setAttribute(`aria-hidden`,`true`),t.style.cssText=[`dynamic-range-limit:no-limit`,`color-space:display-p3`,`position:fixed`,`inset:0`,`pointer-events:none`,`z-index:${nn}`,`background-color:color(display-p3 1 0.55 0.24)`,`mix-blend-mode:multiply`,`opacity:0`,`visibility:hidden`,`transition:opacity 160ms ease`].join(`;`),(document.body??document.documentElement).appendChild(t),t},cn=e=>{let t=on(e),n=sn(),r=t/100;n.style.opacity=String(r),n.style.visibility=r>=.01?`visible`:`hidden`;try{localStorage.setItem(rn,String(t))}catch{}},ln=e=>{let t=on(e);sn(),t<=50?.4+t/50*.6:1+(t-50)/50*.2;try{localStorage.setItem(an,String(t))}catch{}},un=(e,t)=>{try{let n=localStorage.getItem(e);if(n==null)return t;let r=Number(n);return Number.isFinite(r)?on(r):t}catch{return t}},dn=()=>{let e=un(rn,0),t=un(an,50);return cn(e),ln(t),{night:e,brightness:t}},typeof document<`u`&&(document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,()=>dn(),{once:!0}):dn()),fn=[`wifi`,`bluetooth`,`focus`,`airplane`,`orientation`],pn={light:`sun`,dark:`moon`},mn={light:`Light`,dark:`Dark`},hn=e=>{let t=e.querySelector(`[data-qs-tile="theme"]`);if(!t)return;let n=Xt();t.querySelector(`ui-icon`)?.setAttribute(`icon`,pn[n]);let r=t.querySelector(`[data-qs-tile-sub]`);r&&(r.textContent=mn[n]),t.setAttribute(`aria-pressed`,n===`dark`?`true`:`false`)},gn=e=>{let t=e.shadowRoot,n=t?.querySelector(`.qs-panel`);if(!t||!n||n.hasAttribute(`data-qs-wired`))return;n.setAttribute(`data-qs-wired`,``),hn(t),t.querySelector(`[data-qs-tile="theme"]`)?.addEventListener(`click`,()=>{let e=Xt()===`dark`?`light`:`dark`;Zt(e),hn(t)});let r=e=>!!e?.getAttribute?.(`aria-pressed`)&&e?.getAttribute?.(`aria-pressed`)===`true`;t.querySelector?.(`[data-qs-tile="orientation"]`)?.addEventListener?.(`click`,e=>{let t=v((e?.target?.matches?.(`[data-qs-tile="orientation"]`)?e?.target:e?.target?.querySelector?.(`[data-qs-tile="orientation"]`))||e?.target,`[data-qs-tile="orientation"]`),n=r(t);en(n);let i=t?.matches?.(`ui-icon`)?t:t?.querySelector?.(`ui-icon`);i&&i.setAttribute?.(`icon`,n?`device-rotate`:`lock`),i&&i.setAttribute?.(`icon-style`,`duotone`)});for(let e of fn){let n=t.querySelector(`[data-qs-tile="${e}"]`);n&&n.addEventListener(`click`,()=>{let e=n.getAttribute(`aria-pressed`)!==`true`;n.setAttribute(`aria-pressed`,String(e));let t=n.querySelector(`[data-qs-tile-sub]`);t&&(t.textContent=e?`On`:`Off`)})}let{night:i,brightness:a}=dn(),o=t.querySelector(`[data-qs-slider="night"]`),s=t.querySelector(`[data-qs-slider="brightness"]`);o&&(o.value=String(i),o.addEventListener(`input`,()=>cn(o.valueAsNumber))),s&&(s.value=String(a),s.addEventListener(`input`,()=>ln(s.valueAsNumber)));let c=e=>{Vt();let t=()=>{let t=jt();if(typeof t==`function`){t(e,{});return}let n=`#${e}`;typeof location<`u`&&location.hash!==n&&w(n)};typeof requestAnimationFrame==`function`?requestAnimationFrame(t):queueMicrotask(t)};t.querySelectorAll(`[data-qs-open]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=String(e.getAttribute(`data-qs-open`)||``).trim();(t===`settings`||t===`explorer`)&&c(t)})})},_n=class extends L{constructor(){super()}styles=()=>Ht;render=()=>c`
...
</div>`;onRender(){return super.onRender(),gn(this),this}open(){hn(this.shadowRoot),this.removeAttribute(`hidden`),this.hidden=!1,this.setAttribute(`open`,``)}close(){this.hidden=!0,this.setAttribute(`hidden`,``),this.removeAttribute(`open`)}toggle(e){this.hasAttribute(`open`)?this.close():this.open()}},_n=I([s(`ui-quick-settings`)],_n),vn=null,Promise.try(()=>{typeof requestAnimationFrame==`function`&&requestAnimationFrame(()=>{Promise.try(async()=>{let e=screen?.orientation?.lock;if(typeof e!=`function`)return;let t=e.call(screen.orientation,`natural`);t&&typeof t.catch==`function`&&await t.catch(()=>{})}).catch(()=>{})})}).catch(()=>{});try{$t()}catch{}})))()}var bn;function xn(){return(xn=e((()=>{bn=`/*
...
@layer components {
  ...
  env-shell-container[data-env-native-task] .env-shell-chrome[data-desktop] {
    ...
    </div>`,r=n.querySelector(`.env-status-bar__pct`);return r instanceof HTMLElement&&x(r,{properties:{textContent:e.batteryPct}}),n}function Nn(e,t,n){let r=document.createElement(`ui-statusbar`);r.className=`env-ui-statusbar wf-chrome-no-select`,r.setAttribute(`part`,`status-bar`);let i=document.createElement(`div`);i.slot=`left`,i.className=`env-ui-statusbar__left`;let a=document.createElement(`time`);a.className=`env-ui-statusbar__clock`,a.dateTime=``,a.textContent=Dn(),a.setAttribute(`role`,`button`),a.setAttribute(`tabindex`,`0`),a.setAttribute(`aria-label`,`Calendar`),a.setAttribute(`aria-haspopup`,`dialog`),a.setAttribute(`data-chrome-flyout-anchor`,`calendar`);let o=document.createElement(`div`);o.className=`env-ui-statusbar__intro`,t&&(o.innerHTML=t),i.append(a,o);let s=document.createElement(`div`);s.slot=`center`;let c=document.createElement(`p`);c.className=`env-status-bar__meta`,s.appendChild(c);let l=document.createElement(`div`);l.slot=`right`,l.className=`env-ui-statusbar__right`;let u=Mn(n,`env-device-tray env-device-tray--footer`);u.setAttribute(`role`,`button`),u.setAttribute(`tabindex`,`0`),u.setAttribute(`aria-label`,`Quick settings`),u.setAttribute(`aria-haspopup`,`dialog`),u.setAttribute(`data-chrome-flyout-anchor`,`quick-settings`),l.appendChild(u);let d=e=>{e.preventDefault(),e.stopPropagation(),Ct(a)},f=e=>{e.preventDefault(),e.stopPropagation(),Bt(u)};a.addEventListener(`click`,d),a.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&d(e)}),u.addEventListener(`click`,f),u.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&f(e)}),r.append(i,s,l),re(()=>{let t=e.navEcho.value?` │ ${e.navEcho.value}`:``;c.textContent=`doc=${e.selectedPath.value} │ viewer=${e.viewerStatus.value} │ layout=${e.mqLabel.value}${t}`},[e.selectedPath,e.viewerStatus,e.mqLabel,e.navEcho],{triggerImmediately:!0});let p=()=>{let e=new Date;a.textContent=Dn(e),a.dateTime=e.toISOString()};p();let m=setInterval(p,15e3);return{element:r,dispose:()=>{clearInterval(m)}}}var Pn,Fn;function In(){return(In=e((()=>{T(),j(),ne(),N(),At(),yn(),R(),xn(),S(),Pn=f(bn),Fn=class extends tt{constructor(){super()}styles=()=>Pn;render=()=>c`
<div style="background-color: transparent;" part="left"   class="left"  ><slot name="left"  ></slot></div>
        ...
        <div style="background-color: transparent;" part="right"  class="right" ><slot name="right" ></slot></div>`},Fn=I([s(`ui-statusbar`)],Fn)})))()}function Ln(){return(Ln=e((()=>{T(),ze(),F()})))()}function B(e){globalThis.dispatchEvent?.(new CustomEvent(`view:toast`,{detail:{type:`success`,message:n(e)}}))}function V(e){globalThis.dispatchEvent?.(new CustomEvent(`view:toast`,{detail:{type:`error`,message:n(e)}}))}function Rn(){return(Rn=e((()=>{T()})))()}function zn(){if(H)return H;try{let e=localStorage.getItem(qn);if(!e)return H={},H;let t=JSON.parse(e);H=t&&typeof t==`object`?t:{}}catch{H={}}return H}function Bn(e){H=e;try{localStorage.setItem(qn,JSON.stringify(e))}catch{}}function Vn(e){let t=e&&typeof e==`object`?e:{},n=t.extras&&typeof t.extras==`object`?t.extras:{},r={};for(let[e,t]of Object.entries(n)){let n=String(e||``).trim();n&&(typeof t==`boolean`||typeof t==`number`||typeof t==`string`)&&(r[n]=t)}let i=Array.isArray(t.flags)?t.flags.map(e=>String(e||``).trim().toUpperCase()).filter(Boolean):[],a=Array.isArray(t.categories)?t.categories.map(e=>String(e||``).trim()).filter(Boolean):[];return{action:String(t.action||``).trim(),data:Yn(String(t.data||``)),mimeType:String(t.mimeType||``).trim(),extras:r,flags:i,categories:a,componentName:String(t.componentName||``).trim()}}function Hn(e){return!e||!e.action&&!e.data&&!e.mimeType&&!e.componentName&&(!e.flags||e.flags.length===0)&&(!e.categories||e.categories.length===0)&&(!e.extras||Object.keys(e.extras).length===0)}function Un(e){let t=Jn(e);return!t||t===`app:`?{}:Vn(zn()[t])}function Wn(e,t){let n=Jn(e);if(!n||n===`app:`)return{};let r=Vn(t),i={...zn()};return Hn(r)?delete i[n]:i[n]=r,Bn(i),r}function Gn(e){let t=Jn(e);if(!t||t===`app:`)return;let n={...zn()};delete n[t],Bn(n)}function Kn(e){return Un(e)}var qn,H,Jn,Yn;function Xn(){return(Xn=e((()=>{qn=`cwsp-app-launch-spec-v1`,H=null,Jn=e=>`app:${String(e||``).trim()}`,Yn=e=>{let t=String(e||``).trim();return!t||/^javascript:/i.test(t)?``:t}})))()}function Zn(e,t=64){let n=String(e||``).trim();if(!n||!/^https?:\/\//i.test(n))return``;try{let e=new URL(n).hostname;return e?`https://www.google.com/s2/favicons?domain=${encodeURIComponent(e)}&sz=${t}`:``}catch{return``}}function Qn(e){let t=String(e||``).trim().toLowerCase();return t?t.includes(`/_favicon/`)||t.includes(`s2/favicons`)||t.includes(`favicon`)?!0:(t.startsWith(`android-icon:`),!1):!1}function $n(e){let t=String(e||``).trim();return t?/^[a-z][a-z0-9+.-]*:/i.test(t)?t:`https://${t}`:``}function er(e){Sr=e}function tr(e){let t=e||(globalThis.chrome?.bookmarks??null);return!t?.getTree||!t?.getChildren?null:{resolveIconUrl:(e,t=128)=>{let n=String(e||``).trim();if(!/^https?:\/\//i.test(n))return``;let r=Zn(n,t);if(r)return r;try{let e=globalThis.chrome?.runtime;if(typeof e?.getURL==`function`){let r=new URL(e.getURL(`/_favicon/`));return r.searchParams.set(`pageUrl`,n),r.searchParams.set(`size`,String(t)),r.toString()}}catch{}return``},async listChildren(e){if(e)return(await wr(t,`getChildren`,e)||[]).map(Tr);let n=await wr(t,`getTree`)||[],r=[];for(let e of n)for(let t of e.children||[])r.push(Tr(t));return r},async search(e){let n=String(e||``).trim();if(!n)return this.listChildren();if(typeof t.search!=`function`){let e=await this.listChildren(),t=n.toLowerCase();return e.filter(e=>e.title.toLowerCase().includes(t)||String(e.url||``).toLowerCase().includes(t))}return(await wr(t,`search`,n)||[]).map(Tr)},async open(e){if(e.folder)return;let t=String(e.url||``).trim();if(t){try{let e=globalThis.chrome?.tabs;if(typeof e?.create==`function`){await Promise.resolve(e.create({url:t}));return}}catch{}globalThis.open?.(t,`_blank`,`noopener,noreferrer`)}},async remove(e){let n=String(e?.id||``).trim();if(!n)return!1;try{if(e.folder){if(typeof t.removeTree!=`function`)return!1;await wr(t,`removeTree`,n)}else{if(typeof t.remove!=`function`)return!1;await wr(t,`remove`,n)}return!0}catch{return!1}},async update(e,n){let r=String(e||``).trim();if(!r||typeof t.update!=`function`)return null;let i={};if(n.title!=null&&(i.title=String(n.title||``).trim()),n.url!=null){let e=$n(n.url);e&&(i.url=e)}try{let e=await wr(t,`update`,r,i);return e?Tr(e):null}catch{return null}},async create(e,n){if(typeof t.create!=`function`)return null;let r=String(n.title||``).trim();if(!r)return null;let i={parentId:String(e||`0`),title:r};if(n.url!=null){let e=$n(n.url);if(!e)return null;i.url=e}let a=async e=>{let n=await wr(t,`create`,{...i,parentId:e});return n?Tr(n):null};try{return await a(i.parentId)}catch{if(i.parentId===`0`)try{return await a(`1`)}catch{return null}return null}}}}function nr(){return Sr||tr()}function rr(){return!!nr()}function ir(){try{let e=localStorage.getItem(vr);if(!e)return[];let t=JSON.parse(e);return Array.isArray(t)?t.filter(e=>e&&e.id&&e.title).slice(0,br):[]}catch{return[]}}function ar(e){if(!e?.id||e.folder)return;let t=[e,...ir().filter(t=>t.id!==e.id)].slice(0,br);try{localStorage.setItem(vr,JSON.stringify(t))}catch{}}function or(){return Er(yr,xr)}function sr(e){return or().some(t=>t.id===e)}function cr(e){if(!e?.id||e.folder||!String(e.url||``).trim())return!1;let t=[e,...or().filter(t=>t.id!==e.id)].slice(0,xr);try{return localStorage.setItem(yr,JSON.stringify(t)),!0}catch{return!1}}function lr(e){let t=String(e||``).trim();if(!t)return!1;let n=or().filter(e=>e.id!==t);try{return localStorage.setItem(yr,JSON.stringify(n)),!0}catch{return!1}}function ur(e){let t=String(e?.id||``).trim();if(!t)return;let n=n=>n.map(n=>n.id===t?{...n,title:e.title||n.title,url:e.url||n.url}:n);try{Dr(yr,n(or()),xr),Dr(vr,n(ir()),br)}catch{}}function dr(e){let t=String(e||``).trim();if(t){lr(t);try{Dr(vr,ir().filter(e=>e.id!==t),br)}catch{}}}function fr(e,t=Or){let n=String(e||``).trim();if(!n)return``;try{let e=new URL(n,globalThis.location?.href);if(e.searchParams.has(`pageUrl`))return e.searchParams.set(`size`,String(t)),e.toString();if(e.hostname.endsWith(`google.com`)&&e.pathname.includes(`favicon`))return e.searchParams.set(`sz`,String(t)),e.toString()}catch{}return n}function pr(e,t){let n=String(e.url||``).trim();return n&&(Zn(n,Or)||Zn(n,128)||Zn(n,64)||t?.resolveIconUrl?.(n,Or)||t?.resolveIconUrl?.(n,128))||``}function mr(e,t,n,r=``){return gr(e,t,String(r||``).trim()||fr(pr(e,n),Or))}function hr(e,t=``){let n=String(e.url||``).trim();return JSON.stringify({state:{icon:e.folder?`folder`:`link`,label:e.title||n||`Bookmark`,action:e.folder?`open-path`:`open-link`},desc:{action:e.folder?`open-path`:`open-link`,href:e.folder?``:n,path:e.folder?`/bookmarks/${e.id}/`:`/bookmarks/${e.id}`,meta:{entityType:`bookmark`,bookmarkId:e.id,...t?{iconUrl:t}:{}}}})}function gr(e,t,n=``){if(e.folder||!String(e.url||``).trim())return null;let r=t??Ve(),i=Le(hr(e,n),r);return i?(Ge(i),i):null}async function _r(e,t,n){if(e.replaceChildren(),t.folder)return kr(e,`folder`),e.toggleAttribute(`data-bookmark-bitmap`,!1),``;let r=String(t.url||``).trim(),i=[],a=Zn(r,Or);a&&i.push(a);let o=Zn(r,128);o&&!i.includes(o)&&i.push(o);let s=Zn(r,64);s&&!i.includes(s)&&i.push(s);let c=n?.resolveIconUrl?.(r,Or)||``;c&&!i.includes(c)&&i.push(c);let l=n?.resolveIconUrl?.(r,128)||``;l&&!i.includes(l)&&i.push(l);let u=n?.resolveIconUrl?.(r,64)||``;u&&!i.includes(u)&&i.push(u);try{let e=globalThis.chrome?.runtime;if(typeof e?.getURL==`function`&&r){let t=new URL(e.getURL(`/_favicon/`));t.searchParams.set(`pageUrl`,r),t.searchParams.set(`size`,String(Or));let n=t.toString();n&&!i.includes(n)&&i.push(n)}}catch{}return kr(e,`link`),e.toggleAttribute(`data-bookmark-bitmap`,!1),i.length?await new Promise(t=>{let n=0,r=()=>{if(n>=i.length){t(``);return}let a=i[n++],o=document.createElement(`img`);o.className=`env-shell-app-menu__tile-favicon`,o.alt=``,o.decoding=`async`,o.loading=`eager`,o.referrerPolicy=`no-referrer`,o.draggable=!1,o.addEventListener(`load`,()=>{e.replaceChildren(o),e.toggleAttribute(`data-bookmark-bitmap`,!0),t(a)},{once:!0}),o.addEventListener(`error`,()=>{r()},{once:!0}),o.src=a};r()}):``}var vr,yr,br,xr,Sr,Cr,wr,Tr,Er,Dr,Or,kr;function Ar(){return(Ar=e((()=>{Pe(),vr=`rs-app-menu-bookmark-recent`,yr=`rs-app-menu-bookmark-pinned`,br=12,xr=16,Sr=null,Cr=()=>{try{let e=globalThis.chrome?.runtime?.lastError;return e?Error(String(e.message||e)):null}catch{return null}},wr=(e,t,...n)=>{let r=e[t];if(typeof r!=`function`)return Promise.reject(Error(`chrome.bookmarks.${String(t)} missing`));try{let t=r.apply(e,n);if(t!=null&&typeof t.then==`function`)return t}catch(e){return Promise.reject(e)}return new Promise((t,i)=>{try{r.apply(e,[...n,e=>{let n=Cr();n?i(n):t(e)}])}catch(e){i(e)}})},Tr=e=>{let t=typeof e.url==`string`&&e.url?e.url:void 0;return{id:String(e.id),title:String(e.title||e.url||e.id||`Bookmark`),url:t,folder:!t,parentId:e.parentId}},Er=(e,t)=>{try{let n=localStorage.getItem(e);if(!n)return[];let r=JSON.parse(n);return Array.isArray(r)?r.filter(e=>e&&e.id&&e.title&&!e.folder).slice(0,t):[]}catch{return[]}},Dr=(e,t,n)=>{localStorage.setItem(e,JSON.stringify(t.slice(0,n)))},Or=256,kr=(e,t)=>{let n=document.createElement(`ui-icon`);n.setAttribute(`icon`,t),n.setAttribute(`icon-style`,`duotone`),n.setAttribute(`aria-hidden`,`true`),n.style.setProperty(`--icon-size`,`1.75rem`),n.style.setProperty(`--icon-padding`,`0px`),n.style.setProperty(`--icon-color`,`currentColor`),n.style.color=`currentColor`,e.append(n),customElements.whenDefined(`ui-icon`).then(()=>{n.isConnected&&(n.getAttribute(`icon`)||n.setAttribute(`icon`,t),n.style.setProperty(`--icon-size`,`1.75rem`),n.style.setProperty(`--icon-padding`,`0px`))})}})))()}function jr(e){let t=e.info||{},n=String(t.packageName||e.fallback.packageName||``).trim(),r=String(t.label||e.fallback.label||e.title||n).trim(),i=[[`Label`,r],[`Package`,n],[`Activity`,String(t.componentName||e.fallback.componentName||`—`)],[`Version`,`${t.versionName||`—`} (${t.versionCode??`—`})`],[`Installer`,String(t.installer||`—`)],[`Enabled`,t.enabled===!1?`no`:`yes`],[`System`,t.system?t.updatedSystem?`updated system`:`yes`:`no`],[`Installed`,zr(t.firstInstallTime)],[`Updated`,zr(t.lastUpdateTime)]],a=Br(`
        <form class="speed-dial-editor__form" autocomplete="off">
            <header class="modal-header">
                <h2 class="modal-title">App info</h2>
                <p class="modal-description">${U(r)}</p>
            </header>
            <div class="modal-fields">
                ${i.map(([e,t])=>`
                    <div class="modal-field">
                        <label>${U(e)}</label>
                        <input type="text" readonly value="${U(t)}" />
                    </div>`).join(``)}
            </div>
    ...
    `),o=a.__cwspClose;a.querySelector(`form`)?.addEventListener(`click`,t=>{let n=t.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`);n===`close`&&(t.preventDefault(),o?.()),n===`system`&&(t.preventDefault(),Promise.resolve(e.onOpenSystem?.()).finally(()=>o?.()))})}function Mr(e){let t=Un(e.packageName),n=new Set((t.flags||[]).map(e=>e.toUpperCase())),r=Br(`
        <form class="speed-dial-editor__form" autocomplete="off">
            <header class="modal-header">
                <h2 class="modal-title">Edit launch</h2>
                <p class="modal-description">${U(e.title)} — action, data URI, extras, flags</p>
            </header>
            <div class="modal-fields">
                <div class="modal-field">
                    <label for="am-launch-component">Activity</label>
                    <input id="am-launch-component" name="componentName" type="text" value="${U(t.componentName||e.defaultComponent||``)}" placeholder="pkg/.MainActivity" />
                </div>
                <div class="modal-field">
                    <label for="am-launch-action">Intent action</label>
                    <input id="am-launch-action" name="action" type="text" value="${U(t.action||``)}" placeholder="android.intent.action.MAIN" />
                </div>
                <div class="modal-field">
                    <label for="am-launch-data">Data URI</label>
                    <input id="am-launch-data" name="data" type="text" value="${U(t.data||``)}" placeholder="https://…  content://…  app scheme" />
                </div>
                <div class="modal-field">
                    <label for="am-launch-mime">MIME</label>
                    <input id="am-launch-mime" name="mimeType" type="text" value="${U(t.mimeType||``)}" placeholder="text/plain" />
                </div>
                <div class="modal-field">
                    <label for="am-launch-categories">Categories (comma)</label>
                    <input id="am-launch-categories" name="categories" type="text" value="${U((t.categories||[]).join(`, `))}" placeholder="android.intent.category.LAUNCHER" />
                </div>
                <div class="modal-field">
                    <label>Flags</label>
                    <div>
                ...
                <div class="modal-field">
                    ...
                    <textarea id="am-launch-extras" name="extras" rows="5" placeholder='{"debug": true}'>${U(Vr(t.extras))}</textarea>
                </div>
            </div>
            <div class="modal-actions" role="group">
    ...
    `),i=r.__cwspClose,a=r.querySelector(`form`),o=()=>{let e=[...r.querySelectorAll(`input[name="flag"]:checked`)].map(e=>e.value),t=String(r.querySelector(`[name="categories"]`)?.value||``).split(`,`).map(e=>e.trim()).filter(Boolean);return Vn({componentName:r.querySelector(`[name="componentName"]`)?.value,action:r.querySelector(`[name="action"]`)?.value,data:r.querySelector(`[name="data"]`)?.value,mimeType:r.querySelector(`[name="mimeType"]`)?.value,categories:t,flags:e,extras:Hr(r.querySelector(`[name="extras"]`)?.value||``)})};a?.addEventListener(`click`,t=>{let n=t.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`);n===`cancel`&&(t.preventDefault(),i?.()),n===`reset`&&(t.preventDefault(),Gn(e.packageName),e.onSave?.({}),B(`Launch reset to default`),i?.())}),a?.addEventListener(`submit`,t=>{t.preventDefault();let n=o();Wn(e.packageName,n),e.onSave?.(n),B(Hn(n)?`Launch reset to default`:`Launch saved`),i?.()})}function Nr(e,t=`Uninstall`){return globalThis.confirm?.(`${t} “${e}”?`)===!0}function Pr(e){let t=()=>{document.visibilityState===`visible`&&(document.removeEventListener(`visibilitychange`,t),e())};document.addEventListener(`visibilitychange`,t),globalThis.setTimeout?.(e,1600)}function Fr(e){let t=[[`Title`,e.title||`—`],[`URL`,e.url||`—`],[`Id`,e.id],[`Type`,e.folder?`Folder`:`Bookmark`]],n=Br(`
        <form class="speed-dial-editor__form" autocomplete="off">
            <header class="modal-header">
                <h2 class="modal-title">${e.folder?`Folder info`:`Bookmark info`}</h2>
                <p class="modal-description">${U(e.title)}</p>
            </header>
            <div class="modal-fields">
                ${t.map(([e,t])=>`
                    <div class="modal-field">
    ...
    `),r=n.__cwspClose;n.querySelector(`form`)?.addEventListener(`click`,e=>{e.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`)===`close`&&(e.preventDefault(),r?.())})}function Ir(e){let t=e.showUrl!==!1;return new Promise(n=>{let r=!1,i=Br(`
        <form class="speed-dial-editor__form" autocomplete="off">
            <header class="modal-header">
                <h2 class="modal-title">${U(e.heading)}</h2>
                ${e.description?`<p class="modal-description">${U(e.description)}</p>`:``}
            </header>
            <div class="modal-fields">
                <div class="modal-field">
                    <label for="am-bm-title">Title</label>
                    <input id="am-bm-title" name="title" type="text" value="${U(e.initialTitle||``)}" />
                </div>
                ${t?`<div class="modal-field">
                    <label for="am-bm-url">URL</label>
                    <input id="am-bm-url" name="url" type="url" value="${U(e.initialUrl||``)}" placeholder="https://" />
                </div>`:``}
            </div>
            <div class="modal-actions" role="group">
                <span></span>
                <button type="button" data-action="cancel" class="btn secondary">Cancel</button>
                <button type="submit" class="btn save">${U(e.submitLabel||`Save`)}</button>
            </div>
        </form>
    `),a=i.__cwspClose,o=e=>{r||(r=!0,a?.(),n(e))},s=i.querySelector(`form`);s?.addEventListener(`click`,e=>{e.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`)===`cancel`&&(e.preventDefault(),o(null))}),i.addEventListener(`cancel`,()=>o(null)),s?.addEventListener(`submit`,e=>{e.preventDefault();let n=String(i.querySelector(`[name="title"]`)?.value||``).trim();if(!n){V(`Title is required`);return}if(!t){o({title:n});return}let r=$n(i.querySelector(`[name="url"]`)?.value||``);if(!r){V(`URL is required`);return}o({title:n,url:r})})})}function Lr(e){let t=e.entry;(async()=>{let n=await Ir({heading:t.folder?`Rename folder`:`Edit bookmark`,description:t.folder?t.title:`${t.title} — Chrome bookmark`,initialTitle:t.title,initialUrl:t.url||``,showUrl:!t.folder,submitLabel:`Save`});if(!n)return;if(!e.api.update){V(`Bookmark edit unavailable`);return}let r=await e.api.update(t.id,t.folder?{title:n.title}:{title:n.title,url:n.url});if(!r){V(t.folder?`Could not rename folder`:`Could not update bookmark`);return}ur(r),B(t.folder?`Folder renamed`:`Bookmark updated`),e.onSaved?.(r)})()}var Rr,U,zr,Br,Vr,Hr;function Ur(){return(Ur=e((()=>{Rn(),Xn(),Ar(),Rr=[`NEW_TASK`,`CLEAR_TOP`,`SINGLE_TOP`,`CLEAR_TASK`,`NO_HISTORY`,`REORDER_TO_FRONT`,`MULTIPLE_TASK`],U=e=>String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`),zr=e=>{let t=Number(e);if(!Number.isFinite(t)||t<=0)return`—`;try{return new Date(t).toLocaleString()}catch{return String(t)}},Br=e=>{let t=document.createElement(`dialog`);t.className=`speed-dial-editor env-shell-app-menu__chrome-editor`,t.innerHTML=e;let n=()=>{try{t.open&&t.close()}catch{}t.remove()};t.addEventListener(`cancel`,e=>{e.preventDefault(),n()}),t.__cwspClose=n,document.body.append(t);try{t.showModal()}catch{t.setAttribute(`open`,``)}return t},Vr=e=>{if(!e||!Object.keys(e).length)return``;try{return JSON.stringify(e,null,2)}catch{return``}},Hr=e=>{let t=String(e||``).trim();if(!t)return{};if(t.startsWith(`{`))try{return Vn({extras:JSON.parse(t)}).extras||{}}catch{}let n={};for(let e of t.split(/\r?\n/)){let t=e.indexOf(`=`);if(t<1)continue;let r=e.slice(0,t).trim(),i=e.slice(t+1).trim();r&&(n[r]=i===`true`||i===`false`?i===`true`:/^-?\d+(\.\d+)?$/.test(i)?Number(i):i)}return n}})))()}function Wr(){return(Wr=e((()=>{ze(),Ln(),Ur(),T()})))()}var Gr,Kr,qr,W,G,K,Jr,Yr,Xr,q,Zr,Qr,$r,ei,J,ti,ni,ri,ii,ai,oi,si,ci,li,ui,di,fi,Y,pi;function mi(){return(mi=e((()=>{y(),T(),Wr(),Ln(),Gr=320,Kr=220,qr=`2147483640`,W=`important`,G=0,K=null,Jr=null,Yr=null,Xr=null,q=[],Zr=new Map,Qr=new Map,$r=new Map,ei=new Map,J=new Map,ti=[`left-start`,`right-end`,`left-end`,`bottom-start`,`top-start`],ni=(e,t)=>{let n=b(e,{...t,strategy:`js`});return typeof requestAnimationFrame==`function`&&requestAnimationFrame(()=>{n.update?.()}),n},ri=()=>{let e=document.documentElement,t=String(e.getAttribute(`data-theme`)||``).trim().toLowerCase();if(t===`light`||t===`dark`)return t;let n=String(e.getAttribute(`data-scheme`)||``).trim().toLowerCase();if(n===`light`||n===`dark`)return n;try{let e=String(localStorage.getItem(`rs-appearance-theme`)||``).trim().toLowerCase();if(e===`light`||e===`dark`)return e}catch{}return typeof matchMedia==`function`&&matchMedia(`(prefers-color-scheme: light)`).matches?`light`:`dark`},ii=(e,t)=>{e.style.setProperty(`position`,`fixed`,W),e.style.setProperty(`box-sizing`,`border-box`,W),e.style.setProperty(`min-width`,t?`188px`:`220px`,W),e.style.setProperty(`max-width`,`min(320px, calc(100vw - 24px))`,W),e.style.setProperty(`padding`,t?`0.3rem`:`0.4rem`,W),e.style.setProperty(`border-radius`,`14px`,W),e.style.setProperty(`pointer-events`,`auto`,W),e.style.setProperty(`backdrop-filter`,`blur(10px)`,W),e.style.setProperty(`-webkit-backdrop-filter`,`blur(10px)`,W),e.style.removeProperty(`border`),e.style.removeProperty(`background`),e.style.removeProperty(`color`),e.style.removeProperty(`box-shadow`);let n=ri();e.dataset.theme=n,e.style.setProperty(`color-scheme`,n===`light`?`light only`:`dark only`,W)},ai=e=>{e.style.setProperty(`list-style`,`none`,W),e.style.setProperty(`list-style-type`,`none`,W),e.style.setProperty(`margin`,`0`,W),e.style.setProperty(`padding`,`0`,W),e.style.setProperty(`display`,`flex`,W),e.style.setProperty(`flex-direction`,`column`,W),e.style.setProperty(`align-items`,`stretch`,W),e.style.setProperty(`gap`,`0.2rem`,W),e.style.setProperty(`width`,`100%`,W),e.style.setProperty(`box-sizing`,`border-box`,W)},oi=(e,t)=>{if(e.style.setProperty(`appearance`,`none`,W),e.style.setProperty(`-webkit-appearance`,`none`,W),e.style.setProperty(`box-sizing`,`border-box`,W),e.style.setProperty(`width`,`100%`,W),e.style.setProperty(`max-width`,`100%`,W),e.style.setProperty(`margin`,`0`,W),e.style.setProperty(`display`,`grid`,W),e.style.setProperty(`grid-template-columns`,`1.375rem minmax(0, 1fr) auto`,W),e.style.setProperty(`align-items`,`center`,W),e.style.setProperty(`justify-items`,`start`,W),e.style.setProperty(`gap`,`0.55rem`,W),e.style.setProperty(`border`,`none`,W),e.style.setProperty(`border-radius`,`10px`,W),e.style.setProperty(`padding`,`0.5rem 0.6rem`,W),e.style.setProperty(`min-height`,`2.35rem`,W),e.style.setProperty(`font`,`inherit`,W),e.style.setProperty(`font-size`,`0.8125rem`,W),e.style.setProperty(`line-height`,`1.25`,W),e.style.setProperty(`text-align`,`start`,W),e.style.setProperty(`cursor`,`pointer`,W),e.style.removeProperty(`background`),e.style.removeProperty(`background-color`),!t)e.style.setProperty(`color`,`inherit`,W);else{let t=ri()===`light`?`#9f1239`:`#fecaca`;e.style.setProperty(`color`,t,W),e.style.setProperty(`--cw-menu-fg`,t,W)}},si=()=>{let e=document.getElementById(`cw-unified-context-menu-style`);e||(e=document.createElement(`style`),e.id=`cw-unified-context-menu-style`,document.head.appendChild(e)),e.textContent=`
        .cw-context-menu-layer {
            position: fixed;
            inset: 0;
            z-index: var(--cw-context-menu-layer-z, ${qr});
            pointer-events: none;
        }
    ...
    `},ci=()=>{for(let e of q)try{e()}catch{}q=[]},li=e=>{for(let[t,n]of Array.from(ei.entries()))t>=e&&(clearTimeout(n),ei.delete(t));for(let[t,n]of Array.from(J.entries()))t>=e&&(clearTimeout(n),J.delete(t))},ui=e=>{li(e);for(let[t,n]of Array.from(Zr.entries()))t>=e&&($r.get(t)?.dispose(),$r.delete(t),n.remove(),Zr.delete(t),Qr.delete(t))},di=e=>{for(let[t,n]of Array.from(J.entries()))t>=e&&(clearTimeout(n),J.delete(t))},fi=(e,t,n,r,i)=>{let a=document.createElement(`div`);a.className=`cw-context-menu${t?` cw-context-menu--compact`:``}`,a.setAttribute(`role`,`menu`),a.dataset.menuDepth=String(n),a.style.zIndex=String(n+1);let o=document.createElement(`ul`);o.className=`cw-context-menu__list`,ai(o),a.appendChild(o);let s=(e,n,a)=>{if(r!==G||!Jr?.isConnected||!K?.isConnected||(ui(a),!e.children?.length))return;let o=fi(e.children,t,a,r,i);o.classList.add(`cw-context-menu--submenu`),K.appendChild(o),Zr.set(a,o),Qr.set(a,n),$r.set(a,ni(o,{origin:{type:`element`,element:n},placement:`right-start`,fallbacks:ti,strategy:`js`}))},c=(e,t,n)=>{let r=ei.get(n);r&&clearTimeout(r),di(n);let i=setTimeout(()=>{ei.delete(n),s(e,t,n)},Gr);ei.set(n,i)},l=e=>{let t=J.get(e);t&&clearTimeout(t);let n=setTimeout(()=>{J.delete(e),ui(e)},Kr);J.set(e,n)};for(let t of e){let e=document.createElement(`button`);e.type=`button`,e.className=`cw-context-menu__item${t.danger?` cw-context-menu__item--danger`:``}`,e.setAttribute(`role`,`menuitem`),e.disabled=!!t.disabled,oi(e,!!t.danger);let i=!!t.children?.length;if(e.innerHTML=`
            ...
            <div class="modal-fields">
                <div class="modal-field">
                    ...
                    <select id="am-chrome-shape" name="shape">
                        ${Oe.map(e=>`<option value="${e.value}"${Ee(t.shape,`circle`)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
                <div class="modal-field">
                    <label for="am-chrome-display">Icon display</label>
                    <select id="am-chrome-display" name="iconDisplay">
                        ${Ze.map(e=>`<option value="${e.value}"${(ye(t.iconDisplay)||`colored`)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
                <div class="modal-field">
                    <label for="am-chrome-icon-scale">Icon scale (inside plate)</label>
                    <select id="am-chrome-icon-scale" name="iconScale">
                        ${qe.map(e=>`<option value="${e.value}"${He(t.iconScale)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
...
}`})))()}function Va(){return document.documentElement.dataset.cwspShellRole===`launcher`||globalThis.__RS_SHELL_ROLE__===`launcher`}function Ha(){return Va()||rr()}function Ua(){return Va()?`launcher`:rr()?`bookmarks`:null}async function Wa(){if(oo)return oo;try{return await ce(()=>import(`./launcher-bridge-Md9u0ZQh.js`),[],import.meta.url)}catch{return null}}function Ga(){if(!ro){ro=!0;try{document.adoptedStyleSheets=[...document.adoptedStyleSheets,no]}catch{}}}function Ka(){return document.querySelector(`.env-shell-root`)||document.querySelector(`env-shell-container`)||document.querySelector(`.env-shell-chrome`)?.parentElement||document.body}function qa(e,t){let n=document.createElement(`div`);n.className=`env-shell-app-menu__drag-ghost`,n.setAttribute(`aria-hidden`,`true`);let r=e.cloneNode(!0);r.className=`env-shell-app-menu__drag-ghost-icon ui-ws-item-icon shaped`,r.setAttribute(`data-shape`,Ee(e.getAttribute(`data-shape`),`circle`));let i=document.createElement(`span`);return i.className=`env-shell-app-menu__drag-ghost-label`,i.textContent=t,n.append(r,i),n}function Ja(e,t){let n=Ee(t.chrome.shape,so);e.setAttribute(`data-shape`,n),e.classList.add(`ui-ws-item-icon`,`shaped`);let r=String(t.chrome.iconUrl||``).trim()||String(t.resourceUrl||``).trim(),i=Me(t.chrome.iconScale),a=gi(r)?ki(r,i):``,o=String(a||(gi(r)?``:r)||``).trim(),s=ye(t.chrome.iconDisplay)||ke({iconDisplay:t.chrome.iconDisplay,iconUrl:o||r,isLauncherApp:!!t.launcher,isBookmarkFavicon:!!(o||r)&&!t.launcher});e.setAttribute(`data-icon-display`,s),je(e,Xe(s,t.chrome.iconScale)),e.replaceChildren();let c=()=>{Re(e),Be(e)};if(s===`glyph`){let n=String(t.chrome.icon||t.fallbackGlyph||`device-mobile`).trim()||`device-mobile`,r=document.createElement(`ui-icon`);r.setAttribute(`icon`,n),r.setAttribute(`icon-style`,`duotone`),r.setAttribute(`aria-hidden`,`true`),e.append(r),c();return}if(s===`colored`){let n=document.createElement(`img`);n.className=t.launcher?`ui-ws-item-icon-img`:`ui-ws-item-icon-img env-shell-app-menu__tile-favicon`,n.alt=``,n.decoding=`async`,n.draggable=!1,n.referrerPolicy=`no-referrer`,!t.launcher&&(Qn(o)||Qn(r))?n.toggleAttribute(`data-bookmark-favicon`,!0):t.launcher&&n.toggleAttribute(`data-launcher-icon`,!0),o?n.src=o:n.toggleAttribute(`data-icon-pending`,!0),e.append(n),c(),gi(r)&&Oi(r,i).then(e=>{e&&n.isConnected&&(n.src=e,n.removeAttribute(`data-icon-pending`),c())});return}let l=ve({display:s,glyph:String(t.chrome.icon||t.fallbackGlyph||`device-mobile`),resourceUrl:o||void 0,launcher:t.launcher,className:`ui-ws-item-icon-native`});e.append(l),c(),t.launcher&&o&&s!==`glyph`&&(Pi(l,o,s),c()),gi(r)&&Oi(r,i).then(e=>{e&&l.isConnected&&(Pi(l,e,s),c())})}function Ya(e,t,n,r){let i=()=>Ke(t),a=typeof window<`u`&&(window.matchMedia?.(`(pointer: coarse)`)?.matches||`ontouchstart`in window);e.draggable=!a,a||(e.addEventListener(`dragstart`,e=>{let t=i();if(e.dataTransfer?.setData(`text/plain`,t),e.dataTransfer?.setData(`application/json`,t),e.dataTransfer){e.dataTransfer.effectAllowed=`copy`;try{e.dataTransfer.setDragImage(n,24,24)}catch{}}document.documentElement.toggleAttribute(`data-app-menu-dragging`,!0)}),e.addEventListener(`dragend`,()=>{document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1)}));let o,s=null,c=0,l=0,u=!1,d=!1,f=!1,p=null,m=()=>{o&&=(clearTimeout(o),void 0)},h=()=>{if(m(),u=!1,d&&(d=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),p?.remove(),p=null,s!=null)){try{e.releasePointerCapture(s)}catch{}s=null}},g=(r,i,a)=>{if(!d){u=!1,d=!0,f=!0,e.classList.add(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!0),p=qa(n,t.label),document.body.appendChild(p),p.style.transform=`translate(${r}px, ${i}px) translate(-50%, -50%)`;try{e.setPointerCapture(a)}catch{}}},_=(e,t)=>{p&&(p.style.transform=`translate(${e}px, ${t}px) translate(-50%, -50%)`)},ee=(e,n)=>{if(!Fe(e,n))return;let i=Ye(e,n);Ae(t,i??void 0)&&(B(`Pinned ${t.label} to desktop`),r.onPinned?.())},v=t=>{if(d){if(d=!1,u=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),p?.remove(),p=null,s!=null){try{e.releasePointerCapture(s)}catch{}s=null}ee(t.clientX,t.clientY)}};e.addEventListener(`pointerdown`,e=>{e.button===0&&(m(),s=e.pointerId,c=e.clientX,l=e.clientY,f=!1,d=!1,u=!1,o=setTimeout(()=>{o=void 0,u=!0,f=!0},io))},{passive:!0}),e.addEventListener(`pointermove`,e=>{if(o&&!d&&!u){let t=e.clientX-c,n=e.clientY-l;Math.hypot(t,n)>ao&&m();return}if(u&&!d){let t=e.clientX-c,n=e.clientY-l;Math.hypot(t,n)>ao&&g(e.clientX,e.clientY,e.pointerId);return}d&&(_(e.clientX,e.clientY),e.preventDefault())},{passive:!1}),e.addEventListener(`pointerup`,e=>{if(m(),u=!1,d){v(e);return}}),e.addEventListener(`pointercancel`,e=>{m(),u=!1,d&&v(e)}),e.addEventListener(`contextmenu`,()=>{h()},!0),e.addEventListener(`click`,e=>{f&&=(e.preventDefault(),e.stopPropagation(),!1)},!0)}async function Xa(e,t){let n=Kn(t.packageName),r=n.componentName||t.componentName;await e.launcherLaunch(t.packageName,r,Hn(n)?void 0:n)||V(`Unable to open “${t.label}”`)}function Za(e,t,n,r,i){let a=document.createElement(`button`);a.type=`button`,a.className=`env-shell-app-menu__tile`,a.setAttribute(`data-package`,e.packageName),a.title=`${e.label} — right-click: info / uninstall / launch; hold and drag`;let o=ca(e.packageName),s=document.createElement(`span`);s.className=`env-shell-app-menu__tile-icon ui-ws-item-icon shaped`;let c=document.createElement(`span`);c.className=`env-shell-app-menu__tile-label`,c.textContent=e.label,a.append(s,c);let l=e.iconCacheKey||e.packageName,u=(e=``)=>{Ja(s,{chrome:ua(o),fallbackGlyph:`device-mobile`,resourceUrl:e,launcher:!0})},d=Me(ua(o).iconScale);return u(wi(l,d)),Di(l,d).then(e=>{n===r()&&e&&u(e)}).catch(()=>{}),Ya(a,e,s,i),a.addEventListener(`contextmenu`,n=>{n.preventDefault(),n.stopPropagation(),pi({x:n.clientX,y:n.clientY,compact:!0,items:[{id:`place-desktop`,label:`Place on desktop`,icon:`desktop`,action:()=>{Ae(e)&&(B(`Placed “${e.label}” on desktop`),i.onPinned?.())}},{id:`icon-design`,label:`Icon design…`,icon:`palette`,action:()=>{pa({title:e.label,key:o,packageName:e.packageName,defaults:{shape:so,iconDisplay:`colored`},onSave:e=>{let t={...ua(o),...e},n=Me(t.iconScale),r=(e=``)=>{Ja(s,{chrome:t,fallbackGlyph:`device-mobile`,resourceUrl:e,launcher:!0})};r(wi(l,n)||(gi(String(t.iconUrl||``))?``:String(t.iconUrl||``).trim())),gi(String(t.iconUrl||``))?Oi(t.iconUrl,n).then(e=>{e&&r(e)}):Di(l,n).then(e=>{e&&r(e)})}})}},{id:`launch`,label:`Open`,icon:`arrow-square-out`,action:async()=>{try{await Xa(t,e)}catch{}}},{id:`app-info`,label:`App info`,icon:`info`,action:async()=>{let n=null;try{n=await t.launcherAppInfo?.(e.packageName)||null}catch{n=null}jr({title:e.label,fallback:{packageName:e.packageName,componentName:e.componentName,label:e.label},info:n,onOpenSystem:t.launcherOpenAppInfo?()=>t.launcherOpenAppInfo(e.packageName):void 0})}},...t.launcherOpenAppInfo?[{id:`android-settings`,label:`Android settings`,icon:`gear`,action:async()=>{try{await t.launcherOpenAppInfo(e.packageName)||V(`Cannot open Android settings for “${e.label}”`)}catch{V(`Cannot open Android settings for “${e.label}”`)}}}]:[],{id:`edit-launch`,label:`Edit launch…`,icon:`sliders`,action:()=>{Mr({title:e.label,packageName:e.packageName,defaultComponent:e.componentName})}},...t.launcherUninstall?[{id:`uninstall`,label:`Uninstall`,icon:`trash`,danger:!0,action:async()=>{if(Nr(e.label,`Uninstall`))try{if(!await t.launcherUninstall(e.packageName)){V(`Cannot uninstall “${e.label}”`);return}B(`Uninstall started for “${e.label}”`),Pr(()=>i.onAppsChanged?.())}catch{V(`Cannot uninstall “${e.label}”`)}}}]:[]]})}),a.addEventListener(`click`,async n=>{n.preventDefault(),n.stopPropagation();try{await Xa(t,e)}catch{}}),a}function Qa(e,t,n,r,i){if(t.folder||!String(t.url||``).trim())return;let a,o=!1,s=!1,c=0,l=0,u=-1,d=null,f=()=>{a!=null&&(clearTimeout(a),a=void 0)},p=()=>{if(f(),o=!1,s){s=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),d?.remove(),d=null;try{e.releasePointerCapture?.(u)}catch{}}},m=(r,i)=>{if(!s){o=!1,s=!0,e.classList.add(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!0),d=qa(n,t.title),document.body.appendChild(d),d.style.transform=`translate(${r}px, ${i}px) translate(-50%, -50%)`;try{e.setPointerCapture?.(u)}catch{}}},h=(n,a)=>{if(f(),o=!1,s){s=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),d?.remove(),d=null;try{e.releasePointerCapture?.(u)}catch{}if(Fe(n,a)){let e=Ye(n,a)??void 0,o=String(r.current||``).trim()||pr(t,nr());mr(t,e,nr(),o)&&(B(`Placed “${t.title}” on desktop`),i.onPinned?.())}}};e.addEventListener(`pointerdown`,e=>{(e.button==null||e.button===0)&&(c=e.clientX,l=e.clientY,u=e.pointerId,s=!1,o=!1,f(),a=setTimeout(()=>{a=void 0,o=!0},io))}),e.addEventListener(`pointermove`,e=>{if(!s&&!o){if(a==null)return;let t=e.clientX-c,n=e.clientY-l;t*t+n*n>100&&f();return}if(o&&!s){let t=e.clientX-c,n=e.clientY-l;t*t+n*n>100&&m(e.clientX,e.clientY);return}d&&(d.style.transform=`translate(${e.clientX}px, ${e.clientY}px) translate(-50%, -50%)`,e.preventDefault())},{passive:!1}),e.addEventListener(`pointerup`,e=>h(e.clientX,e.clientY)),e.addEventListener(`pointercancel`,e=>h(e.clientX,e.clientY)),e.addEventListener(`contextmenu`,()=>p(),!0)}function $a(e,t,n,r,i){e.addEventListener(`contextmenu`,a=>{if(a.preventDefault(),a.stopPropagation(),t.folder){pi({x:a.clientX,y:a.clientY,compact:!0,items:[{id:`open-folder`,label:`Open folder`,icon:`folder-open`,action:()=>{e.click()}},{id:`bm-info`,label:`Info`,icon:`info`,action:()=>{Fr(t)}},...n.update?[{id:`bm-edit`,label:`Rename folder…`,icon:`pencil`,action:()=>{Lr({entry:t,api:n,onSaved:()=>i.onAppsChanged?.()})}}]:[],...n.remove?[{id:`bm-delete`,label:`Delete folder`,icon:`trash`,danger:!0,action:async()=>{if(Nr(t.title,`Delete`))try{if(!await n.remove(t)){V(`Could not delete “${t.title}”`);return}B(`Deleted “${t.title}”`),dr(t.id),i.onAppsChanged?.()}catch{V(`Could not delete “${t.title}”`)}}}]:[]]});return}let o=sr(t.id);pi({x:a.clientX,y:a.clientY,compact:!0,items:[{id:`place-desktop`,label:`Place on desktop`,icon:`desktop`,action:()=>{mr(t,void 0,n,String(r.current||``).trim()||pr(t,n))&&(B(`Placed “${t.title}” on desktop`),i.onPinned?.())}},{id:`icon-design`,label:`Icon design…`,icon:`palette`,action:()=>{let i=la(t.id);pa({title:t.title,key:i,pageUrl:String(t.url||``).trim(),defaults:{shape:so,iconDisplay:`colored`},onSave:a=>{let o=e.querySelector(`.env-shell-app-menu__tile-icon`);if(!o)return;let s={...ua(i),...a},c=String(s.iconUrl||``).trim()||String(r.current||``).trim()||pr(t,n);Ja(o,{chrome:s,fallbackGlyph:t.folder?`folder`:`link`,resourceUrl:c}),c&&(r.current=c)}})}},o?{id:`unpin-start`,label:`Unpin from Start`,icon:`push-pin-slash`,action:()=>{lr(t.id)&&(B(`Unpinned “${t.title}”`),i.onStartPinsChanged?.())}}:{id:`pin-start`,label:`Pin to Start`,icon:`push-pin`,action:()=>{cr(t)&&(B(`Pinned “${t.title}” to Start`),i.onStartPinsChanged?.())}},{id:`open`,label:`Open`,icon:`arrow-square-out`,action:async()=>{ar(t);try{await n.open(t)}catch{}}},{id:`bm-info`,label:`Info`,icon:`info`,action:()=>{Fr(t)}},...n.update&&!t.folder?[{id:`bm-edit`,label:`Edit bookmark…`,icon:`pencil`,action:()=>{Lr({entry:t,api:n,onSaved:()=>i.onAppsChanged?.()})}}]:[],...n.remove?[{id:`bm-delete`,label:t.folder?`Delete folder`:`Delete`,icon:`trash`,danger:!0,action:async()=>{if(Nr(t.title,`Delete`))try{if(!await n.remove(t)){V(`Could not delete “${t.title}”`);return}B(`Deleted “${t.title}”`),dr(t.id),i.onAppsChanged?.()}catch{V(`Could not delete “${t.title}”`)}}}]:[]]})})}function eo(e,t,n,r){let i=document.createElement(`button`);i.type=`button`,i.className=`env-shell-app-menu__tile`,i.setAttribute(`data-bookmark-id`,e.id),e.folder&&i.setAttribute(`data-folder`,``),i.title=e.folder?`${e.title} — open folder`:`${e.title} — right-click: info / edit / delete; hold to drag`;let a=la(e.id),o=document.createElement(`span`);o.className=`env-shell-app-menu__tile-icon ui-ws-item-icon shaped`,o.setAttribute(`data-shape`,so);let s=document.createElement(`span`);s.className=`env-shell-app-menu__tile-label`,s.textContent=e.title,i.append(o,s);let c={current:``},l=t=>{let n=ua(a);if(n.shape||n.iconDisplay||n.icon||n.iconUrl){Ja(o,{chrome:n,fallbackGlyph:e.folder?`folder`:`link`,resourceUrl:String(n.iconUrl||t||``).trim()});return}o.setAttribute(`data-shape`,so)};return _r(o,e,t).then(e=>{c.current=e,l(e)}),Qa(i,e,o,c,n),$a(i,e,t,c,n),i.addEventListener(`click`,async n=>{if(n.preventDefault(),n.stopPropagation(),!document.documentElement.hasAttribute(`data-app-menu-dragging`)){if(e.folder){r(e.id,e.title);return}ar(e);try{await t.open(e)}catch{}}}),i}function to(){Ga();let e=Ua(),t=document.createElement(`div`);t.className=`env-shell-app-menu`,t.hidden=!0,t.setAttribute(`role`,`dialog`),t.setAttribute(`aria-modal`,`false`),t.setAttribute(`aria-label`,e===`bookmarks`?`Bookmarks`:`Apps`),e&&t.setAttribute(`data-menu-mode`,e);let n=()=>{try{let e=document.documentElement,n=(e.getAttribute(`data-theme`)||``).toLowerCase(),r=(e.style.colorScheme||``).trim().toLowerCase(),i=n===`light`||n===`dark`?n:r===`light`||r===`dark`?r:``;if(i===`light`||i===`dark`){t.dataset.theme=i,t.style.colorScheme=i;return}delete t.dataset.theme,t.style.colorScheme=`inherit`}catch{}};n();let r=()=>n();document.addEventListener(`u2-theme-change`,r);let i=new MutationObserver(r);try{i.observe(document.documentElement,{attributes:!0,attributeFilter:[`data-theme`,`data-scheme`,`style`]})}catch{}let a=document.createElement(`div`);a.className=`env-shell-app-menu__panel`,e===`bookmarks`&&a.setAttribute(`data-layout`,`start-split`);let o=document.createElement(`div`);o.className=`env-shell-app-menu__banner`,o.hidden=!0;let s=document.createElement(`p`);s.className=`env-shell-app-menu__banner-text`,s.textContent=`Set CWSP Launcher as Home`;let c=document.createElement(`button`);c.type=`button`,c.className=`env-shell-app-menu__banner-action btn`,c.textContent=`Set as default`,o.append(s,c);let l=document.createElement(`input`);l.type=`search`,l.className=`env-shell-app-menu__search`,l.placeholder=e===`bookmarks`?`Search bookmarks`:`Search apps`,l.autocomplete=`off`,l.inputMode=`search`,l.setAttribute(`aria-label`,e===`bookmarks`?`Search bookmarks`:`Search apps`);let u=document.createElement(`div`);u.className=`env-shell-app-menu__tools`;let d=document.createElement(`select`);d.className=`env-shell-app-menu__sort`,d.setAttribute(`aria-label`,`Sort apps`);for(let[e,t]of ya){let n=document.createElement(`option`);n.value=e,n.textContent=t,d.appendChild(n)}let f=document.createElement(`select`);f.className=`env-shell-app-menu__sort-dir`,f.setAttribute(`aria-label`,`Sort order`);for(let[e,t]of[[`asc`,`A–Z / oldest`],[`desc`,`Z–A / newest`]]){let n=document.createElement(`option`);n.value=e,n.textContent=t,f.appendChild(n)}let p=()=>{let e=Ta();d.value=e.sortBy,f.value=e.sortDir};p(),u.append(l,d,f);let m=document.createElement(`div`);m.className=`env-shell-app-menu__start-body`,m.hidden=e!==`bookmarks`;let h=document.createElement(`div`);h.className=`env-shell-app-menu__start-left`,h.setAttribute(`aria-label`,`Pinned and recent bookmarks`);let g=document.createElement(`div`);g.className=`env-shell-app-menu__start-heading`,g.textContent=`Pinned`;let _=document.createElement(`div`);_.className=`env-shell-app-menu__start-recent env-shell-app-menu__start-pinned`;let ee=document.createElement(`div`);ee.className=`env-shell-app-menu__start-heading`,ee.textContent=`Recent`;let v=document.createElement(`div`);v.className=`env-shell-app-menu__start-recent`,h.append(g,_,ee,v);let y=document.createElement(`div`);y.className=`env-shell-app-menu__start-right`;let b=document.createElement(`div`);b.className=`env-shell-app-menu__crumb`;let x=document.createElement(`div`);x.className=`env-shell-app-menu__crumb-nav`;let S=document.createElement(`div`);S.className=`env-shell-app-menu__crumb-actions`,b.append(x,S);let C=document.createElement(`div`);C.className=`env-shell-app-menu__grid`,C.setAttribute(`data-part`,`grid`),C.setAttribute(`aria-label`,e===`bookmarks`?`Bookmarks`:`Installed apps`),y.append(b,C),m.append(h,y),e===`bookmarks`?a.append(o,u,m):a.append(o,u,C),t.appendChild(a),Ka().appendChild(t);let w=!1,T=0,E=``,D,O=[],k=()=>{if(!Ha()){t.hidden=!0,t.toggleAttribute(`data-open`,!1);return}t.hidden=!w,t.toggleAttribute(`data-open`,w)},A=()=>{w&&(w=!1,t.toggleAttribute(`data-page`,!1),k(),t.dispatchEvent(new CustomEvent(`env-app-menu-close`,{bubbles:!0})))};t.addEventListener(`env-app-menu-request-close`,e=>{e.stopPropagation(),A()});let te=()=>{Ha()&&(n(),w=!0,k(),N(),t.dispatchEvent(new CustomEvent(`env-app-menu-open`,{bubbles:!0})))},ne=()=>{t.toggleAttribute(`data-page`,!0),te()},re=()=>{w?A():te()},j={onPinned:()=>{A()},onStartPinsChanged:()=>{N()},onAppsChanged:()=>{N()}},M=e=>{let t=nr();if(!t?.create){V(`Cannot create bookmark here`);return}let n=O.length?O[O.length-1]:null,r=n?.id||`0`,i=n?.title||`Bookmarks`;(async()=>{let n=await Ir({heading:e===`folder`?`New folder`:`New bookmark`,description:`Add to “${i}” (Chrome bookmarks)`,showUrl:e===`url`,initialTitle:e===`folder`?`New folder`:``,initialUrl:e===`url`?`https://`:``,submitLabel:`Create`});if(!n)return;let a=await t.create(r,{title:n.title,url:e===`url`?n.url:void 0});if(!a){V(e===`folder`?`Could not create folder`:`Could not create bookmark`);return}B(e===`folder`?`Created folder “${a.title}”`:`Created “${a.title}”`),N()})()},ie=(e,t)=>{let n=document.createElement(`button`);return n.type=`button`,n.className=`env-shell-app-menu__crumb-action`,n.textContent=e,n.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),t()}),n};S.append(ie(`New bookmark`,()=>M(`url`)),ie(`New folder`,()=>M(`folder`))),C.addEventListener(`contextmenu`,e=>{e.target?.closest?.(`[data-bookmark-id]`)||Ua()===`bookmarks`&&nr()?.create&&(e.preventDefault(),e.stopPropagation(),pi({x:e.clientX,y:e.clientY,compact:!0,items:[{id:`new-bookmark`,label:`New bookmark…`,icon:`bookmark-simple`,action:()=>M(`url`)},{id:`new-folder`,label:`New folder…`,icon:`folder-plus`,action:()=>M(`folder`)}]}))});let ae=()=>{if(x.replaceChildren(),S.hidden=e!==`bookmarks`||!nr()?.create,e!==`bookmarks`)return;let t=document.createElement(`button`);t.type=`button`,t.className=`env-shell-app-menu__crumb-item`,t.textContent=`Bookmarks`,t.addEventListener(`click`,()=>{O=[],N()}),x.appendChild(t),O.forEach((e,t)=>{let n=document.createElement(`span`);n.className=`env-shell-app-menu__crumb-sep`,n.textContent=`›`;let r=document.createElement(`button`);r.type=`button`,r.className=`env-shell-app-menu__crumb-item`,r.textContent=e.title,r.addEventListener(`click`,()=>{O=O.slice(0,t+1),N()}),x.append(n,r)})},oe=async(e,t)=>{let n=[];try{n=await e.launcherList(E||void 0)}catch{n=[]}if(t!==T)return;C.replaceChildren();let r=Ta();if(r.sortBy===`color`&&(await Fa(n,C),t!==T))return;if(n=La(n,r),n.length===0){let e=document.createElement(`p`);e.className=`env-shell-app-menu__empty`,e.textContent=E?`No matching apps`:`No apps found`,C.appendChild(e);return}let i=document.createDocumentFragment();for(let r of n)i.appendChild(Za(r,e,t,()=>T,j));C.appendChild(i)},se=(e,t)=>{O.push({id:e,title:t}),E=``,l.value=``,N()},ce=async(e,t)=>{ae();let n=(t,n,r)=>{if(t.replaceChildren(),n.length===0){let e=document.createElement(`p`);e.className=`env-shell-app-menu__empty env-shell-app-menu__empty--compact`,e.textContent=r,t.appendChild(e);return}for(let r of n)t.appendChild(eo(r,e,j,se))};n(_,or(),`No pinned bookmarks`),n(v,ir(),`No recent bookmarks`);let r=[];try{if(E)r=await e.search(E);else{let t=O.length?O[O.length-1].id:void 0;r=await e.listChildren(t)}}catch{r=[]}if(t!==T)return;if(C.replaceChildren(),r.length===0){let e=document.createElement(`p`);e.className=`env-shell-app-menu__empty`,e.textContent=E?`No matching bookmarks`:`This folder is empty`,C.appendChild(e);return}let i=document.createDocumentFragment(),a=Ta().sortDir===`desc`?-1:1,o=r.filter(e=>e.folder),s=r.filter(e=>!e.folder),c=(e,t)=>String(e.title||``).localeCompare(String(t.title||``),void 0,{numeric:!0,sensitivity:`base`})*a;for(let t of[...o.sort(c),...s.sort(c)])i.appendChild(eo(t,e,j,se));C.appendChild(i)},N=async()=>{let e=++T;o.hidden=!0,u.hidden=!1,l.hidden=!1;let n=Ua();if(!n){k();return}if(t.setAttribute(`data-menu-mode`,n),n===`bookmarks`){a.setAttribute(`data-layout`,`start-split`),m.hidden=!1,a.contains(m)||(a.append(o,u,m),C.parentElement!==y&&y.append(b,C));let t=nr();if(!t){o.hidden=!1,s.textContent=`Bookmarks API unavailable in this context`,c.hidden=!0,l.hidden=!0,u.hidden=!0,m.hidden=!0;return}c.hidden=!0,await ce(t,e);return}a.removeAttribute(`data-layout`),m.hidden=!0,C.parentElement!==a&&a.append(C);let r=await Wa();if(e!==T)return;if(!r?.launcherList||!r?.launcherLaunch||!r?.launcherIcon){o.hidden=!1,s.textContent=`Launcher bridge unavailable — rebuild the Capacitor APK`,c.hidden=!0,l.hidden=!0,u.hidden=!0,C.hidden=!0;return}let i=!1;try{i=await r.launcherIsDefault()}catch{i=!1}e===T&&(i?o.hidden=!0:(o.hidden=!1,s.textContent=`Set CWSP Launcher as Home for full launcher integration`,c.hidden=!1),l.hidden=!1,u.hidden=!1,C.hidden=!1,await oe(r,e))};d.addEventListener(`change`,()=>{let e=d.value;Ea({sortBy:e,sortDir:wa(e)}),p()}),f.addEventListener(`change`,()=>{Ea({sortDir:f.value===`desc`?`desc`:`asc`})});let le=()=>{p(),w&&N()};window.addEventListener(_a,le),l.addEventListener(`input`,()=>{E=l.value.trim(),D&&clearTimeout(D),D=setTimeout(()=>{N()},180)}),c.addEventListener(`click`,async e=>{e.preventDefault(),e.stopPropagation();let t=await Wa();if(t){try{await t.launcherRequestDefault()}catch{}N()}});let ue=e=>{if(!w||document.documentElement.hasAttribute(`data-app-menu-dragging`))return;let n=typeof e.composedPath==`function`?e.composedPath():[];for(let e of n)if(e===t||e===a||e instanceof Element&&t.contains(e)||e instanceof Element&&e.closest?.(`.cw-context-menu-layer`)||e instanceof Element&&e.closest?.(`.env-shell-app-menu__chrome-editor`)||e instanceof Element&&e.closest?.(`dialog.speed-dial-editor`))return;A()};document.addEventListener(`pointerdown`,ue,{capture:!0});let P=[`.env-shell-app-menu__tile`,`.env-shell-app-menu__search`,`.env-shell-app-menu__sort`,`.env-shell-app-menu__sort-dir`,`.env-shell-app-menu__tools`,`.env-shell-app-menu__banner`,`.env-shell-app-menu__pin-menu`,`.env-shell-app-menu__crumb-item`,`.env-shell-app-menu__start-heading`,`.env-shell-app-menu__chrome-editor`,`.env-shell-app-menu__drag-ghost`,`.cw-context-menu-layer`,`dialog.speed-dial-editor`].join(`, `),F=null,de=e=>e instanceof Element&&!!e.closest(P),fe=e=>{if(w&&(e.button==null||e.button===0)){if(document.documentElement.hasAttribute(`data-app-menu-dragging`)||de(e.target)){F=null;return}F={id:e.pointerId,x:e.clientX,y:e.clientY}}},pe=e=>{if(!F||F.id!==e.pointerId)return;let t=e.clientX-F.x,n=e.clientY-F.y;F=null,w&&(document.documentElement.hasAttribute(`data-app-menu-dragging`)||de(e.target)||Math.hypot(t,n)>14||A())},me=e=>{F?.id===e.pointerId&&(F=null)};return t.addEventListener(`pointerdown`,fe),t.addEventListener(`pointerup`,pe),t.addEventListener(`pointercancel`,me),k(),{element:t,toggle:re,open:te,openPage:ne,close:A,isOpen:()=>w,refresh:N,dispose:()=>{D&&clearTimeout(D),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),document.removeEventListener(`pointerdown`,ue,{capture:!0}),t.removeEventListener(`pointerdown`,fe),t.removeEventListener(`pointerup`,pe),t.removeEventListener(`pointercancel`,me),document.removeEventListener(`u2-theme-change`,r),window.removeEventListener(_a,le);try{i.disconnect()}catch{}t.remove()}}}var no,ro,io,ao,oo,so;function co(){return(co=e((()=>{S(),P(),Pe(),Rn(),Xn(),Ur(),Bi(),mi(),be(),ga(),Ar(),Ra(),Ba(),se(),no=f(za),ro=!1,io=420,ao=10,oo=null,so=`circle`})))()}var lo,uo,fo,po,mo;function ho(){return(ho=e((()=>{Pe(),lo=null,uo=e=>{let t=Je(e.id);return Math.max(0,Number(t?.androidWidgetId)||0)},fo=(e,t)=>{let n=t.getBoundingClientRect();return{widgetId:e,x:n.left,y:n.top,w:Math.max(8,n.width),h:Math.max(8,n.height),dpr:Number(window.devicePixelRatio)||1}},po=e=>{if(!lo)return;let t=e||document.getElementById(`home`);t&&t.querySelectorAll(`[data-speed-dial-item][data-widget="android"][data-layer="icons"]`).forEach(e=>{let t=(Qe||[]).find(t=>t?.id===e.dataset.id);if(!t)return;let n=uo(t);if(!n)return;let r=fo(n,e);lo.widgetAttach(r)})},mo=()=>{lo?.widgetHideAll?.()}})))()}var go,_o,vo,yo,bo,xo,So,Co,wo,To,Eo,Do,Oo,ko,Ao,jo,Mo,No,Po;function Fo(){return(Fo=e((()=>{ze(),Pe(),ho(),go=`/user/workspaces/`,_o=`cwsp:workspace-page`,vo=`cw::workspace::pages`,yo=e=>`${go}${e}/`,bo=()=>[`side-a`,`side-b`,`side-c`].map(e=>({id:e,label:`Side ${e.slice(-1).toUpperCase()}`,path:yo(e)})),xo=()=>({activeId:`side-a`,pages:bo(),snapshots:{}}),So=()=>{try{let e=localStorage.getItem(vo);if(!e)return xo();let t=JSON.parse(e);return!t||!Array.isArray(t.pages)||!t.pages.length?xo():{activeId:String(t.activeId||t.pages[0].id),pages:t.pages.map(e=>({id:String(e.id||``).trim(),label:String(e.label||e.id),path:String(e.path||yo(e.id))})).filter(e=>e.id),snapshots:t.snapshots&&typeof t.snapshots==`object`?t.snapshots:{}}}catch{return xo()}},Co=e=>({items:(e?.items||[]).map(e=>{let t=String(e.meta?.iconUrl||``);if(!/^(data:|blob:)/i.test(t))return e;let n={...e.meta||{}};return/^data:/i.test(t)&&e.id?n.iconUrl=Ie(String(e.id),t):delete n.iconUrl,{...e,meta:n}})}),wo=e=>{try{localStorage.setItem(vo,JSON.stringify(e))}catch(e){console.warn(`[workspace-pages] catalog persist failed`,e)}},To=e=>{try{window.dispatchEvent(new CustomEvent(_o,{detail:{id:e,pages:Eo()}}))}catch{}},Eo=()=>So().pages,Do=()=>So().activeId||`side-a`,Oo=()=>{let e=So();e.pages.some(t=>t.id===e.activeId)&&(e.snapshots[e.activeId]=Co(Ne()),wo(e))};try{let e=globalThis;e.__CWSP_WORKSPACE_SNAPSHOT_SYNC_BOUND__||(e.__CWSP_WORKSPACE_SNAPSHOT_SYNC_BOUND__=!0,window.addEventListener(Ue,Oo))}catch{}ko=async e=>{try{let t=we(`/user/`);if(!t?.mkdir||!t.writable)return;if(await t.mkdir(`/user/`,`workspaces`).catch(()=>void 0),await t.mkdir(go,e.id).catch(()=>void 0),t.writeFile){let n=new File([JSON.stringify({id:e.id,label:e.label,path:e.path},null,2)],`workspace.json`,{type:`application/json`});await t.writeFile(e.path,n).catch(()=>void 0)}}catch(t){console.warn(`[workspace-pages] explorer dir failed`,e.id,t)}},Ao=()=>{try{return matchMedia(`(prefers-reduced-motion: reduce)`).matches}catch{return!1}},jo=()=>{let e=document.querySelector(`.speed-dial-root`)||document.getElementById(`home`);if(!e)return[];let t=[...e.querySelectorAll(`.speed-dial-grid`)];return t.length?t:[e]},Mo=e=>{let t=e||(typeof document<`u`?document:null);t?.querySelectorAll&&(t.querySelectorAll(`.speed-dial-grid--turn-ghost`).forEach(e=>e.remove()),t.querySelectorAll(`[data-ws-turning]`).forEach(e=>{delete e.dataset.wsTurning,e.querySelectorAll(`.speed-dial-grid`).forEach(e=>{e.style.opacity=``})}))},No=e=>{let t=jo(),n=t[0]?.closest(`.speed-dial-root`)||t[0]||null;if(Mo(n),!t.length||Ao()||typeof t[0].animate!=`function`)return()=>void 0;let r=e<0?-1:1,i=`${-88*r}deg`,a=`${88*r}deg`,o=`${-18*r}%`,s=`${18*r}%`,c=n||t[0];c.dataset.wsTurning=r>0?`next`:`prev`;let l=[];for(let e of t){let t=e.cloneNode(!0);t.classList.add(`speed-dial-grid--turn-ghost`),t.dataset.wsGhost=`1`,t.setAttribute(`aria-hidden`,`true`),e.parentElement?.insertBefore(t,e.nextSibling),e.style.opacity=`0`,l.push(t),t.animate([{transform:`translateX(0) rotateY(0deg)`,opacity:1},{transform:`translateX(${o}) rotateY(${i})`,opacity:0}],{duration:180,easing:`cubic-bezier(.4, 0, .2, 1)`,fill:`forwards`})}let u=()=>{for(let e of t)e.style.opacity=``;for(let e of l)e.remove();delete c.dataset.wsTurning};return()=>{let e=t.map(e=>e.animate([{transform:`translateX(${s}) rotateY(${a})`,opacity:.2},{transform:`translateX(0) rotateY(0deg)`,opacity:1}],{duration:220,easing:`cubic-bezier(.22, 1, .36, 1)`,fill:`none`})),n=Promise.all(e.map(e=>e.finished.catch(()=>void 0))),r=new Promise(e=>{setTimeout(e,500)});Promise.race([n,r]).then(u)}},Po=e=>{let t=So(),n=t.pages.find(t=>t.id===e);if(!n)return!1;let r=t.activeId||t.pages[0].id;if(r===n.id)return!0;let i=Math.max(0,t.pages.findIndex(e=>e.id===r)),a=Math.max(0,t.pages.findIndex(e=>e.id===n.id))-i;Math.abs(a)>t.pages.length/2&&(a+=a>0?-t.pages.length:t.pages.length),t.snapshots[r]=Co(Ne()),t.activeId=n.id,wo(t),mo();let o=No(a);return We(t.snapshots[n.id]||{items:[]}),requestAnimationFrame(()=>{o(),requestAnimationFrame(()=>po())}),ko(n),To(n.id),!0}})))()}var Io,Lo,Ro,zo,Bo,Vo,Ho,Uo,Wo;function Go(){return(Go=e((()=>{Io=`cwsp:explorer-sort-change`,Lo=`cwsp-explorer-sort`,Ro=[[`name`,`Name`],[`date`,`Date modified`],[`type`,`Type`],[`size`,`Size`],[`kind`,`Kind (file / folder)`]],zo=new Set(Ro.map(([e])=>e)),Bo=(e,t=`name`)=>{let n=String(e||``).trim().toLowerCase();return n===`modified`||n===`mtime`||n===`updated`?`date`:n===`mime`||n===`ext`||n===`extension`?`type`:n===`bytes`||n===`length`?`size`:n===`folder`||n===`folders`?`kind`:zo.has(n)?n:t},Vo=(e,t=`asc`)=>{let n=String(e||``).trim().toLowerCase();return n===`desc`||n===`descending`||n===`newest`||n===`z-a`?`desc`:n===`asc`||n===`ascending`||n===`oldest`||n===`a-z`?`asc`:t},Ho=e=>e===`date`||e===`size`?`desc`:`asc`,Uo=()=>{try{let e=localStorage.getItem(Lo);if(e){let t=JSON.parse(e),n=Bo(t.sortBy);return{sortBy:n,sortDir:Vo(t.sortDir,Ho(n)),foldersFirst:t.foldersFirst!==!1}}}catch{}return{sortBy:`name`,sortDir:`asc`,foldersFirst:!0}},Wo=e=>{let t=Uo(),n=e.sortBy==null?t.sortBy:Bo(e.sortBy,t.sortBy),r={sortBy:n,sortDir:e.sortDir==null?t.sortDir:Vo(e.sortDir,Ho(n)),foldersFirst:e.foldersFirst==null?t.foldersFirst:!!e.foldersFirst};try{localStorage.setItem(Lo,JSON.stringify(r))}catch{}try{window.dispatchEvent(new CustomEvent(Io,{detail:r}))}catch{}return r}})))()}var Ko;function qo(){return(qo=e((()=>{Ko=`/*
...
`))},Zo=class extends L{styles=()=>Ko;onInitialize(){let e=super.onInitialize();return queueMicrotask(()=>{Yo(this),Jo(this),fe()?me().then(e=>Xo(this,e)):Xo(this,null,`Browser / PWA: use Mount folder (showDirectoryPicker).`)}),e??this}render=function(){let e=this,t=fe(),n=he();return c`<div class="explorer-settings" part="root">
            ...
            <section class="explorer-settings__card" hidden=${!t}>
                ...
                <div class="explorer-settings__actions">
                    <button class="btn btn--primary" type="button" disabled=${!t} on:click=${()=>{pe().then(()=>me().then(t=>Xo(e,t,`Opened system all-files settings.`)))}}>Allow all files</button>
                    <button class="btn" type="button" disabled=${!t} on:click=${()=>{ge().then(t=>{Xo(e,null,t?`SAF tree: ${t}`:`SAF pick cancelled.`),window.dispatchEvent(new CustomEvent(`cwsp:explorer-mount-change`))})}}>Pick SAF folder</button>
                </div>
            </section>
            <section class="explorer-settings__card">
                <h3 class="explorer-settings__title">
                ...
                <label class="explorer-settings__check">
                    <input type="checkbox" data-explorer-opfs-enabled checked=${ae()} disabled=${!A()} on:change=${e=>{te(e.currentTarget.checked),ie(),Te(`/user/`),Te(`/idb/`),_e(),window.dispatchEvent(new CustomEvent(`cwsp:explorer-mount-change`))}} />
            ...
            <section class="explorer-settings__card" hidden=${t||!n}>
                ...
                <div class="explorer-settings__actions">
                    <button class="btn" type="button" disabled=${!n} on:click=${()=>{de().then(t=>{t&&(De(t),Jo(e),window.dispatchEvent(new CustomEvent(`cwsp:explorer-mount-change`)))})}}>Mount folder</button>
                </div>
                <div data-explorer-mounts class="explorer-settings__mounts"></div>
            </section>
        </div>`}},Zo=I([s(`ui-explorer-settings`)],Zo),Qo=()=>{document.querySelectorAll(`ui-file-manager`).forEach(e=>{let t=e.shadowRoot?.querySelector(`.fm-root`);t?.classList.remove(`fm-root--settings`),t?.querySelector(`ui-explorer-settings`)?.remove()}),document.querySelector(`ui-explorer-settings`)?.remove()},D(window,`keydown`,e=>{e.key===`Escape`&&Qo()})})))()}var es,ts,ns,rs,is,as,os;function ss(){return(ss=e((()=>{T(),mi(),$o(),es=()=>document.querySelector(`ui-file-manager`),ts=()=>es()?.shadowRoot?.querySelector(`ui-explorer-settings`)??document.querySelector(`ui-explorer-settings`),ns=()=>p()&&ee()?!0:document.querySelector(`.cw-context-menu, .cw-context-menu-layer`)?(Y(),!0):ts()?(Qo(),!0):!1,rs=()=>{let e=globalThis;e.__CWSP_NATIVE_BACK__={handleBackPress:ns};let t=e.__CWSP_LAUNCHER_HOME__?.handleBackPress;e.__CWSP_LAUNCHER_HOME__={...e.__CWSP_LAUNCHER_HOME__||{},handleBackPress:()=>ns()||typeof t==`function`&&t()}},is=()=>{let e=globalThis;if(e.__CWSP_CAP_BACK_BOUND__)return;let t=e.Capacitor?.Plugins?.App;if(typeof t?.addListener==`function`){e.__CWSP_CAP_BACK_BOUND__=!0;try{t.addListener(`backButton`,()=>{ns()})}catch(e){console.warn(`[overlay-back] Capacitor backButton bind failed`,e)}}},as=()=>{E({id:`app-menu-overlay`,priority:_.SIDEBAR,isActive:()=>!!document.querySelector(`.env-shell-app-menu[data-open]`),close:()=>(document.querySelector(`.env-shell-app-menu`)?.dispatchEvent(new CustomEvent(`env-app-menu-request-close`,{bubbles:!0})),!0)}),E({id:`speed-dial-editor`,priority:_.MODAL,isActive:()=>!!document.querySelector(`dialog.speed-dial-editor[open], dialog.sd-icon-picker[open]`),close:()=>(document.querySelectorAll(`dialog.speed-dial-editor[open], dialog.sd-icon-picker[open]`).forEach(e=>{try{e.close()}catch{e.remove()}}),!0)})},os=()=>{let e=globalThis;if(e.__CWSP_LAUNCHER_BACK_STACK__){is(),rs();return}e.__CWSP_LAUNCHER_BACK_STACK__=!0;try{t({preventDefaultNavigation:!0,pushInitialState:!1})}catch{}as(),is(),rs()}})))()}var cs;function ls(){return(ls=e((()=>{cs=`/*
...
}`})))()}function us(e){return`${ys}${String(e||``).trim().toLowerCase()}`}function ds(){let e=document.querySelector(`.env-shell-chrome`);return e instanceof HTMLElement&&e.hasAttribute(`data-desktop`)?!1:e instanceof HTMLElement&&e.dataset.chromeLayout===`mobile`||typeof matchMedia==`function`&&matchMedia(`(max-width: 640px)`).matches}function fs(e,t){if(e.some(e=>{let t=String(e.id||``).trim().toLowerCase();return!t||t===`home`?!1:e.visible!==!1&&!e.minimized}))return!0;let n=String(t.value||`home`).trim().toLowerCase();if(n&&n!==`home`&&n!==`viewer`)return!0;let r=document.querySelector(`.env-shell-workspace`);if(!r)return!1;for(let e of r.querySelectorAll(`ui-window`)){if(!(e instanceof HTMLElement)||e.hidden||e.hasAttribute(`data-minimized`))continue;let t=getComputedStyle(e);if(t.display!==`none`&&t.visibility!==`hidden`&&!(Number.parseFloat(t.opacity||`1`)<=0))return!0}return!1}function ps(e=new Date){return En(e)}function ms(e){let t=oe([]);h(t),m(_s,t,{title:`Home`,icon:`house-line`},{},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,e.focusedTaskId.value=`home`,e.onHome()}),m(vs,t,{title:`Markdown`,icon:`article`},{},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,e.focusedTaskId.value=`viewer`,e.onViewer()});let n=document.createElement(`ui-taskbar`);n.className=`env-shell-taskbar wf-chrome-no-select`,n.setAttribute(`part`,`taskbar`),n.setAttribute(`data-type`,`desktop`);let r=document.createElement(`div`);r.className=`env-shell-taskbar__pins`;let i=document.createElement(`div`);i.className=`env-shell-taskbar__windows`;let a=document.createElement(`ui-task`);a.setAttribute(`title`,`Home`),a.setAttribute(`icon`,`house-line`),a.setAttribute(`data-id`,_s),a.setAttribute(`data-env-home`,``),a.setAttribute(`aria-label`,`Home`),a.setAttribute(`aria-haspopup`,`menu`),r.append(a);let o=document.createElement(`div`);o.className=`env-shell-taskbar__workspaces`,o.setAttribute(`aria-label`,`Workspaces`);let s=()=>{let e=Eo(),t=Do();o.replaceChildren();for(let n of e){let e=document.createElement(`button`);e.type=`button`,e.className=`env-shell-taskbar__workspace`,e.title=n.label,e.textContent=n.label.replace(/^Side\s+/i,``)||n.id.slice(-1).toUpperCase(),e.toggleAttribute(`data-active`,n.id===t),e.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),Po(n.id)}),o.append(e)}};s(),window.addEventListener(_o,s),r.append(o),os();let c=()=>{let e=ds();a.setAttribute(`title`,e?`Home`:`Start`),a.setAttribute(`aria-label`,e?`Home`:`Start`),a.setAttribute(`icon`,e?`house-line`:`aperture`),a.toggleAttribute(`data-env-start`,!e),e?a.setAttribute(`aria-keyshortcuts`,`LongPress`):a.removeAttribute(`aria-keyshortcuts`)};c();let l=document.createElement(`div`);l.className=`env-shell-taskbar__tray-host`;let u=document.createElement(`div`);u.className=`env-shell-taskbar__clock`,u.setAttribute(`role`,`button`),u.setAttribute(`tabindex`,`0`),u.setAttribute(`aria-label`,`Calendar`),u.setAttribute(`aria-haspopup`,`dialog`),u.setAttribute(`data-chrome-flyout-anchor`,`calendar`);let d=document.createElement(`span`);d.className=`env-shell-taskbar__clock-time`;let f=document.createElement(`span`);f.className=`env-shell-taskbar__clock-date`,u.append(d,f);let p=()=>{let{time:e,date:t}=ps();d.textContent=e,f.textContent=t,u.title=`${e} · ${t}`};p();let g=setInterval(p,xs),_=Mn(e.device,`env-device-tray env-device-tray--taskbar`);_.setAttribute(`role`,`button`),_.setAttribute(`tabindex`,`0`),_.setAttribute(`aria-label`,`Quick settings`),_.setAttribute(`aria-haspopup`,`dialog`),_.setAttribute(`data-chrome-flyout-anchor`,`quick-settings`);let ee=e=>{e.preventDefault(),e.stopPropagation(),Ct(u)},v=e=>{e.preventDefault(),e.stopPropagation(),Bt(_)};u.addEventListener(`click`,ee),u.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&ee(e)}),_.addEventListener(`click`,v),_.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&v(e)}),l.append(_,u);let y=document.createElement(`div`);y.className=`env-shell-navbar__switcher`,y.setAttribute(`role`,`menu`),y.setAttribute(`aria-label`,`Open apps`),y.hidden=!0;let b=document.createElement(`ul`);b.className=`env-shell-navbar__switcher-list`,y.appendChild(b),n.append(r,i,l,y);let x=Ha(),S=x?to():void 0,C=new Map,w=[],T=null,E=!1,D=!1,k=[];k.push(()=>clearInterval(g));let A=e=>w.find(t=>String(t.id||``).trim().toLowerCase()===e),te=t=>{let n=String(t||``).trim().toLowerCase();if(!n)return;let r=A(n),i=String(e.focusedTaskId.value||``).trim().toLowerCase(),a=!!r?.focused||i===n||i===`markdown`&&n===`viewer`||i===`viewer`&&(n===`viewer`||n===`markdown`);if(r?.minimized){r.minimized=!1,r.focused=!0,C.get(n)?.toggleAttribute(`data-minimized`,!1),e.focusedTaskId.value=n===`markdown`?`viewer`:n,e.onWindowTask?.(n);return}if(a&&r&&r.visible!==!1){r.minimized=!0,r.focused=!1,C.get(n)?.toggleAttribute(`data-minimized`,!0),e.onMinimizeWindow?.(n);return}e.focusedTaskId.value=n===`markdown`?`viewer`:n,e.onWindowTask?.(n)},ne=(t,r,i)=>{if(ds())return;t.preventDefault(),t.stopPropagation();let a=String(r||``).trim().toLowerCase(),o=!!A(a)?.minimized,s=[{id:o?`restore`:`minimize`,label:o?`Restore`:`Minimize`,icon:o?`arrow-square-out`:`minus`,action:()=>{o?(e.focusedTaskId.value=a,e.onWindowTask?.(a)):e.onMinimizeWindow?.(a)}},{id:`close`,label:`Close`,icon:`x`,danger:!0,action:()=>e.onCloseWindow?.(a)}];pi({x:t.clientX,y:t.clientY,compact:!0,anchor:t.target instanceof Element?t.target:n,items:s})};n.addEventListener(`contextmenu`,t=>{if(ds())return;let r=typeof t.composedPath==`function`?t.composedPath():[];for(let e of r)if(e instanceof Element&&e.closest?.(`ui-task`))return;t.preventDefault(),t.stopPropagation(),pi({x:t.clientX,y:t.clientY,compact:!0,anchor:n,items:[{id:`show-desktop`,label:`Show desktop`,icon:`desktop`,action:()=>e.onHome()},{id:`home`,label:`Home`,icon:`house-line`,action:()=>e.onHome()}]})});let j=()=>{D=!1,y.hidden=!0,b.replaceChildren(),n.removeAttribute(`data-switcher-open`)},M=()=>{let r=w.filter(e=>String(e.id||``).trim());if(b.replaceChildren(),r.length)for(let n of r){let r=String(n.id||``).trim().toLowerCase(),i=document.createElement(`li`);i.className=`env-shell-navbar__switcher-row`,i.setAttribute(`role`,`none`);let a=document.createElement(`button`);a.type=`button`,a.className=`env-shell-navbar__switcher-item`,a.setAttribute(`role`,`menuitem`),a.toggleAttribute(`data-active`,!!n.focused&&!n.minimized),a.toggleAttribute(`data-minimized`,!!n.minimized);let o=document.createElement(`ui-icon`);o.setAttribute(`icon`,n.icon||`app-window`),o.setAttribute(`icon-style`,`duotone`),o.setAttribute(`aria-hidden`,`true`);let s=document.createElement(`span`);s.className=`env-shell-navbar__switcher-label`,s.textContent=n.title||r,a.append(o,s),a.addEventListener(`click`,n=>{n.preventDefault(),n.stopPropagation(),j(),e.focusedTaskId.value=r;let i=us(r),a=O(t,i);a?a.focus=!0:e.onWindowTask?.(r)});let c=document.createElement(`button`);c.type=`button`,c.className=`env-shell-navbar__switcher-close`,c.setAttribute(`aria-label`,`Close ${n.title||r}`),c.title=`Close`;let l=document.createElement(`ui-icon`);l.setAttribute(`icon`,`x`),l.setAttribute(`icon-style`,`bold`),l.setAttribute(`aria-hidden`,`true`),c.appendChild(l),c.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.onCloseWindow?.(r),w=w.filter(e=>String(e.id||``).trim().toLowerCase()!==r),C.get(r)?.remove(),C.delete(r),w.length?M():j()}),i.append(a,c),b.appendChild(i)}else{let e=document.createElement(`li`);e.className=`env-shell-navbar__switcher-empty`,e.textContent=`No open apps`,b.appendChild(e)}D=!0,y.hidden=!1,n.setAttribute(`data-switcher-open`,``)},ie=()=>{T!=null&&(clearTimeout(T),T=null)},ae=()=>{n.toggleAttribute(`data-app-menu-open`,!!S?.isOpen())},se=()=>{j(),S?.close(),ae(),O(t,_s).focus=!0,e.onHome()},ce=()=>{j(),S?.toggle(),ae(),O(t,_s).focus=!0,e.focusedTaskId.value=`home`,de()},N=()=>{S&&!S.isOpen()&&(j(),S.open(),ae(),O(t,_s).focus=!0,e.focusedTaskId.value=`home`,de())},le=()=>{S&&(j(),S.openPage(),ae(),O(t,_s).focus=!0,e.focusedTaskId.value=`home`,de())};try{let e=globalThis;e.__CWSP_LAUNCHER_HOME__={...e.__CWSP_LAUNCHER_HOME__||{},openAppMenu:N,openAppMenuPage:le}}catch{}let ue=()=>{if(fs(w,e.focusedTaskId)){se();return}if(S?.isOpen()){S.close(),ae();return}ce()};a.addEventListener(`click`,e=>{if(E){e.preventDefault(),e.stopPropagation(),E=!1;return}if(x&&S){e.preventDefault(),e.stopPropagation(),ue();return}se()}),a.addEventListener(`pointerdown`,e=>{if(ds()&&(e.button==null||e.button===0)){E=!1,ie(),T=setTimeout(()=>{T=null,E=!0;try{a.releasePointerCapture?.(e.pointerId)}catch{}M()},bs);try{a.setPointerCapture?.(e.pointerId)}catch{}}},{capture:!0});let P=()=>{ie()};a.addEventListener(`pointerup`,P,{capture:!0}),a.addEventListener(`pointercancel`,P,{capture:!0}),a.addEventListener(`contextmenu`,e=>{ds()&&(e.preventDefault(),E=!0,ie(),M())});let F=e=>{if(!D)return;let t=typeof e.composedPath==`function`?e.composedPath():[];for(let e of t)if(e===y||e===a||e instanceof Element&&(e===y||y.contains(e)||e===a))return;j()};document.addEventListener(`pointerdown`,F,{capture:!0}),k.push(()=>document.removeEventListener(`pointerdown`,F,{capture:!0}));let de=()=>{let t=String(e.focusedTaskId.value||`home`),n=(e,t)=>{e.toggleAttribute(`data-env-active`,t),e.toggleAttribute(`data-active`,t),e.toggleAttribute(`data-focus`,t)};n(a,t===`home`);for(let[e,r]of C)n(r,t===e)};re(()=>{de()},[e.focusedTaskId],{triggerImmediately:!0});let fe=e=>{let n=String(e.id||``).trim().toLowerCase();if(!n||n===`home`)return;let r=us(n),a=e.title||n,o=String(e.icon||``).trim()||`app-window`,s=C.get(n);if(!s){let e=m(r,null,{title:a,icon:o},{viewId:n},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,te(n)});e.list=t,t.push(e),s=document.createElement(`ui-task`),s.setAttribute(`data-id`,r),s.setAttribute(`data-view`,n),s.setAttribute(`title`,a),s.setAttribute(`aria-label`,a),s.setAttribute(`icon`,o),s.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),te(n)}),s.addEventListener(`contextmenu`,e=>{ne(e,n,a)}),C.set(n,s),i.appendChild(s)}s.setAttribute(`title`,a),s.setAttribute(`aria-label`,a),s.setAttribute(`icon`,o),s.toggleAttribute(`data-minimized`,!!e.minimized),s.hidden=e.visible===!1},pe=n=>{w=Array.isArray(n)?n.slice():[];let r=new Set;for(let t of n){let n=String(t.id||``).trim().toLowerCase();n&&n!==`home`&&(r.add(n),fe(t),t.focused&&(e.focusedTaskId.value=n))}for(let[e,n]of[...C.entries()]){if(r.has(e))continue;let i=us(e),a=O(t,i);if(a){let e=t.indexOf(a);e>=0&&t.splice(e,1)}n.remove(),C.delete(e)}de(),D&&M()},me=n=>{let r=String(n||`home`).toLowerCase(),i=_s;r===`viewer`||r===`markdown`?i=vs:r!==`home`&&(i=us(r));let a=O(t,i);if(a){for(let e of t)e!==a&&(e.active=!1);a.active=!0}e.focusedTaskId.value=r===`markdown`?`viewer`:r,de()};if(queueMicrotask(c),S){let e=()=>ae();n.addEventListener(`env-app-menu-open`,e),n.addEventListener(`env-app-menu-close`,e),k.push(()=>{n.removeEventListener(`env-app-menu-open`,e),n.removeEventListener(`env-app-menu-close`,e)})}return{element:n,taskList:t,setFocusedTaskId:me,syncWindowTasks:pe,appMenu:S,openAppMenu:S?N:void 0,openAppMenuPage:S?le:void 0,isSwitcherOpen:()=>D,closeSwitcher:j,dispose:()=>{ie(),j(),S?.dispose();for(let e of k)try{e()}catch{}k.length=0,C.clear(),i.replaceChildren()}}}var hs,gs,_s,vs,ys,bs,xs;function Ss(){return(Ss=e((()=>{P(),j(),ne(),T(),mi(),In(),At(),yn(),co(),Fo(),ss(),R(),ls(),S(),hs=f(cs),gs=class extends tt{constructor(){super()}styles=()=>hs;render=()=>c`<div part="taskbar" class="taskbar"><slot></slot></div>`},gs=I([s(`ui-taskbar`)],gs),_s=`#env-home`,vs=`#env-viewer`,ys=`#env-win-`,bs=420,xs=3e4})))()}function Cs(e){if(typeof Uint8Array.fromBase64==`function`)return Uint8Array.fromBase64(e);let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}async function ws(e,t=`gzip`){if(typeof CompressionStream>`u`)throw Error(`Compression Streams API is not supported in this browser`);let n=new DecompressionStream(t),r=n.writable.getWriter(),i=n.readable.getReader();r.write(e),r.close();let a=[],o=!1;for(;!o;){let{value:e,done:t}=await i.read();o=t,e&&a.push(e)}let s=a.reduce((e,t)=>e+t.length,0),c=new Uint8Array(s),l=0;for(let e of a)c.set(e,l),l+=e.length;return c}async function Ts(e,t,n=`font/woff2`){if(As.has(t))return As.get(t);let r=new Blob([e],{type:n}),i=URL.createObjectURL(r);return As.set(t,i),i}async function Es(e){let{base64:t,family:n,style:r=`normal`,weight:i=`normal`,compressed:a=!1}=e,o=`${n}-${r}-${i}`;if(js.has(o))return js.get(o);let s=Cs(t),c=await Ts(a?await ws(s):s,o,a?`application/octet-stream`:`font/woff2`),l=new FontFace(n,`url(${c}) format('woff2')`,{style:r,weight:typeof i==`string`?i:`${i}`,display:`swap`});return await l.load(),document.fonts.add(l),js.set(o,l),l}async function Ds(e){let t=e.map(e=>Es(e));return Promise.all(t)}async function Os(){return Ms||(Ms=ce(()=>import(`./font-registry-BefiOUvg.js`).then(e=>typeof e.loadFontRegistryShards==`function`?e.loadFontRegistryShards().then(e=>({fontRegistry:e})):{fontRegistry:e.fontRegistry}),[],import.meta.url).catch(e=>{console.error(`Failed to load font registry:`,e)}),Ms)}async function ks(){let e=await Os();return Ds(Object.values(e.fontRegistry))}var As,js,Ms;function Ns(){return(Ns=e((()=>{se(),As=new Map,js=new Map,Ms=null})))()}var Ps;function Fs(){return(Fs=e((()=>{Ps=`/*
 * Filename: index.scss
...
}`})))()}var Rs;function zs(){return(zs=e((()=>{Ns(),S(),Fs(),Ls(),Rs=async e=>{await ks().catch(()=>void 0),await l(Ps)?.catch(()=>void 0),e?.includeGlobalNativeControls&&await l(Is)?.catch(()=>void 0)}})))()}var Bs;function Vs(){return(Vs=e((()=>{Bs=`:host(ui-task), :host(ui-task) * {
  box-sizing: border-box;
  user-select: none;
  touch-action: manipulation;
  -webkit-user-drag: none;
...
:host(ui-task:not([data-active])) {
  opacity: 0.6;
}`})))()}var Hs,Us,Ws,Gs;function Ks(){return(Ks=e((()=>{R(),S(),T(),Vs(),Hs=f(Bs),Us=e=>{let t=``;if(typeof e==`string`)t=e;else if(typeof e==`object`&&e&&`value`in e){let n=e.value;t=n==null?``:String(n)}else e!=null&&typeof e!=`object`&&(t=String(e));(!t||t===`undefined`||t===`null`||t===`[object Object]`)&&(t=``);let n=t.trim().charAt(0);return n?n.toUpperCase():`?`},Ws=(e,t,n)=>{let r=e.getAttribute(t);return r!=null&&String(r).trim()?String(r).trim():n},Gs=class extends tt{title;icon;constructor(){super()}styles=()=>Hs;render=function(){let e=Ws(this,`title`,`Task`),t=Ws(this,`icon`,`app-window`),n=Us(e);return c`
        ...
        `}},I([C({source:`attr`})],Gs.prototype,`title`,void 0),I([C({source:`attr`})],Gs.prototype,`icon`,void 0),Gs=I([s(`ui-task`)],Gs)})))()}var qs;function Js(){return(Js=e((()=>{qs=`ui-taskbar[data-type=desktop] > ui-task[data-focus] {
...
:host(ui-taskbar[data-type=desktop]) ::slotted(ui-task[data-focus]) {
  ...
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}`})))()}function Ys(){return(Ys=e((()=>{y(),S(),Js(),f(qs)})))()}var Xs;function Zs(){return(Zs=e((()=>{Xs=`ui-taskbar[data-type=mobile] > ui-task[data-focus] {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}
...
}`})))()}var Ic,Lc,Rc,zc,Bc,Vc,Hc;function Uc(){return(Uc=e((()=>{T(),y(),S(),R(),P(),ic(),Nc(),Fc(),Ic=f(Pc),Lc=`minus`,Rc=`corners-out`,zc=`corners-in`,Bc=`x`,Vc=Object.freeze({w:240,h:160}),Hc=class extends L{titleHandler;contentHandler;footerHandler;resizer;#e=M(0);#t=M(0);#n=null;#r=null;#i=null;#a=null;#o=null;#s=null;#c=null;#l=!1;#u=0;#d=0;#f=null;#p=null;#m=null;styles=function(){return Ic};render=function(){return c`<div class="window-container" part="window-container">
