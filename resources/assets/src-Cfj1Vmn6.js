import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{At as t,J as n,Mt as r,Ot as i,Tt as a,bt as o,l as s,s as c,t as l}from"./src-TXtvocpz.js";import{Bt as u,Lt as d,zt as f}from"./OPFS-WcvpNv6j.js";import{c as p,f as m,g as h,h as g,i as _,l as v,m as y,r as b,s as ee,u as te}from"./ecosystem-skus-Bz92tN57.js";import{n as ne,o as re,r as ie,t as x}from"./history-base-C5FHF9Xl.js";import{r as S}from"./shell-preference-DNduHyVr.js";import{n as C,t as w}from"./preload-helper-DFTwEg7x.js";import{a as T,c as E,d as D,f as ae,l as oe,u as se}from"./registry-D9EPHR_5.js";import{n as ce,t as le}from"./templates-C66WQ7dZ.js";import{a as ue,d as de}from"./UnifiedMessaging-DLBZRnRi.js";import{r as fe}from"./BootLoader-BDcUVGvD.js";import{B as pe,K as me}from"./airpad-cwsp-client-parity-CaWYseCI.js";import{c as he,m as ge,n as _e,o as ve,y as O}from"./open-policy-DV4wO_gQ.js";import{a as ye,i as be,r as xe,t as Se}from"./SettingsTypes-DZTe8_Y6.js";import{c as k,o as Ce,t as we}from"./process-ingress-Ca7FTwXt.js";import{t as Te,v as Ee}from"./remote-connection-runtime-BqtSIGLy.js";import{a as De,c as Oe,i as ke,n as Ae,o as je,r as Me,s as Ne}from"./Settings-kVSqy0Nt.js";import{c as Pe,l as Fe,n as Ie,o as Le,r as Re,s as ze,u as A}from"./Theme-DISv7xcL.js";import{n as Be,r as Ve}from"./capacitor-permissions-DeazvCZP.js";import{i as He,r as Ue}from"./capacitor-settings-permissions-DkzN5Fmd.js";import{a as We,c as Ge,d as Ke,f as qe,i as Je,l as Ye,m as Xe,n as Ze,o as Qe,p as $e,r as et,s as tt,u as nt}from"./web-DKfZpZWN.js";import{s as rt}from"./icon-C6atVd0v.js";import{a as it,c as at,d as ot,f as st,h as ct,i as lt,l as ut,m as dt,n as ft,o as pt,p as mt,r as ht,s as gt,u as _t}from"./shells-hz-wANCW.js";import{c as vt,i as yt,l as bt,n as xt,o as St,r as Ct,s as wt}from"./CustomInstructions-DXSQ7tFf.js";import{i as Tt,n as Et,r as Dt}from"./admin-doors-DKuDENp1.js";import{n as Ot}from"./registry-CXAYuDcM.js";import{a as kt,r as At}from"./channel-actions-DkmBPovk.js";import{i as jt,n as Mt}from"./highlight-elZpRW0e.js";function j(){return(j=e((()=>{})))()}var M,Nt,Pt,Ft,It;function Lt(){return(Lt=e((()=>{i(),j(),M=`data-settings-view-css`,Nt=e=>r(String(e||``),`settings-view`),Pt=`
...
`,Ft=e=>{if(e&&!e.classList?.contains(`view-settings`)||typeof document>`u`)return;if(document.head?.querySelector(`style[${M}]`)){e&&a(e);return}let t=Nt(`/*
...
@layer components {
  ...
  @container settings-view (max-inline-size: 480px) {
    ...
    </header>`})))()}var cn,I,L,ln,un,R,dn,fn,pn,mn,hn;function gn(){return(gn=e((()=>{l(),Pe(),cn=[{hex:Le,label:`Cyan`},{hex:`#4f8eb5`,label:`Steel`},{hex:`#64748b`,label:`Slate`},{hex:`#3b82f6`,label:`Blue`},{hex:`#6366f1`,label:`Indigo`},{hex:`#14b8a6`,label:`Teal`},{hex:`#22c55e`,label:`Green`},{hex:`#f59e0b`,label:`Amber`},{hex:`#ef4444`,label:`Red`},{hex:`#ec4899`,label:`Pink`},{hex:`#8b5cf6`,label:`Violet`}],I={wallpaper:`From wallpaper`,"material-you":`From Material You`,"system-wallpaper":`From system wallpaper`,"speed-dial":`From Speed Dial wallpaper`,custom:`Custom hue`},L=(e,t)=>{if(e===`auto`)return`Auto (${I[t]})`;let n=I[e];return e===t?`${n} (default)`:n},ln=()=>{let e=ze();return n`<section class="card settings-tab-panel" data-tab-panel="appearance">
      <h3>Appearance</h3>
          ...
          <textarea class="form-input code-highlight-source" rows="10" spellcheck="false" autocomplete="off" autocapitalize="off" wrap="off" data-language="json" data-field="appearance.markdown.extensions" placeholder='[
  {
    ...
    </section>`})))()}var yn;function bn(){return(bn=e((()=>{l(),yn=()=>n`<section class="card settings-tab-panel is-active" data-tab-panel="ai">
      <h3>AI</h3>
    ...
    </section>`})))()}var xn;function Sn(){return(Sn=e((()=>{l(),xn=()=>n`<section class="card settings-tab-panel" data-tab-panel="mcp">
      <h3>MCP</h3>
      <div class="mcp-section" data-mcp-section></div>
      <div class="mcp-actions">
        <button class="btn" type="button" data-action="add-mcp-server">Add MCP server</button>
      </div>
    </section>`})))()}var Cn;function wn(){return(wn=e((()=>{l(),Cn=()=>n`<section class="card settings-tab-panel" data-tab-panel="server">
      <h3>Server</h3>
    ...
    </section>`})))()}var Tn;function En(){return(En=e((()=>{l(),d(),wt(),ce(),Tn=(e={})=>{let t=f({instructions:[],activeId:``,editingId:null,newLabel:``,newInstruction:``,isAdding:!1}),r=n`<div class="custom-instructions-editor">
        <div class="ci-row">
            <div class="ci-header">
