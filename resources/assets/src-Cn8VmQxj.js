import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{Et as t,J as n,Nt as r,jt as i,kt as a,l as o,s,t as c,xt as l}from"./src-DQ3ENLm5.js";import{Bt as u,Lt as d,zt as f}from"./OPFS-D1pjQjho.js";import{c as p,f as m,g as h,h as g,i as _,l as v,m as y,r as b,s as x,u as ee}from"./ecosystem-skus-Bz92tN57.js";import{n as te,o as ne,r as re,t as ie}from"./history-base-C5FHF9Xl.js";import{r as S}from"./shell-preference-DNduHyVr.js";import{n as C,t as w}from"./preload-helper-DFTwEg7x.js";import{a as T,c as E,d as D,f as O,l as ae,u as oe}from"./registry-DPH9Npl0.js";import{n as se,t as ce}from"./templates-C66WQ7dZ.js";import{a as le,d as ue}from"./UnifiedMessaging-Ba94p4_5.js";import{r as de}from"./BootLoader-BzKvT1RK.js";import{B as fe,K as pe}from"./airpad-cwsp-client-parity-CaWYseCI.js";import{c as me,m as he,n as ge,o as _e,y as ve}from"./open-policy-DV4wO_gQ.js";import{a as ye,i as k,r as be,t as xe}from"./SettingsTypes-DZTe8_Y6.js";import{c as Se,o as Ce,t as we}from"./process-ingress-BpIFHdVu.js";import{t as Te,v as Ee}from"./remote-connection-runtime-EVtL3jHm.js";import{a as De,c as Oe,i as ke,n as Ae,o as je,r as Me,s as Ne}from"./Settings-C-3GRbtg.js";import{c as Pe,l as Fe,n as Ie,o as Le,r as Re,s as ze,u as Be}from"./Theme-D1ZVMssO.js";import{n as Ve,r as He}from"./capacitor-permissions-DeazvCZP.js";import{i as Ue,r as We}from"./capacitor-settings-permissions-DkzN5Fmd.js";import{a as Ge,c as Ke,d as qe,f as Je,i as Ye,l as Xe,m as Ze,n as Qe,o as $e,p as et,r as tt,s as A,u as nt}from"./web-tSmcqtd8.js";import{s as rt}from"./icon-BBRnO5Ir.js";import{a as it,c as at,d as ot,f as st,h as ct,i as lt,l as ut,m as dt,n as ft,o as pt,p as mt,r as ht,s as gt,u as _t}from"./shells-B3EpQHyM.js";import{c as vt,i as yt,l as bt,n as j,o as M,r as xt,s as St}from"./CustomInstructions-DvR1SMs5.js";import{i as Ct,n as wt,r as Tt}from"./admin-doors-DKuDENp1.js";import{n as Et}from"./registry-Cb7op9kN.js";import{a as Dt,r as Ot}from"./channel-actions-DkmBPovk.js";import{i as kt,n as At}from"./highlight-BeXsjyH3.js";function jt(){return(jt=e((()=>{})))()}var N,Mt,Nt,Pt,Ft;function It(){return(It=e((()=>{a(),jt(),N=`data-settings-view-css`,Mt=e=>r(String(e||``),`settings-view`),Nt=`
...
`,Pt=e=>{if(e&&!e.classList?.contains(`view-settings`)||typeof document>`u`)return;if(document.head?.querySelector(`style[${N}]`)){e&&t(e);return}let n=Mt(`/*
...
@layer components {
  ...
  @container settings-view (max-inline-size: 480px) {
...
}`);n.trim()||(n=Nt);let r=document.createElement(`style`);r.setAttribute(N,``),r.textContent=n,document.head?.appendChild(r),e&&t(e)},Ft=e=>{if(!e)return;let t=()=>{if(!e.isConnected){requestAnimationFrame(t);return}Pt(e)};e.isConnected?Pt(e):requestAnimationFrame(t)}})))()}function Lt(){return(Lt=e((()=>{c()})))()}function Rt(e){ie();let t=String(e.view||``).trim().replace(/^\/+/,``).toLowerCase();if(h(t))return y(t)||`/${t}`;let n={...e.params||{}},r;if(t===`settings`){let e=gt(lt(String(n.section||``).trim()));delete n.section,r=ne(e?`/settings/${e}`:`/settings`)}else r=ne(t&&t!==`home`?re(`/${t}`):`/`);let i=r;if(Object.keys(n).length>0){let e=new URLSearchParams(n).toString();i+=(i.includes(`?`)?`&`:`?`)+e}return i}function zt(e,t={}){let n=Rt(e);if(h(e.view)||/^https?:\/\//i.test(n)){globalThis.location.assign(n);return}t.replace?history.replaceState(t.state??e,``,n):history.pushState(t.state??e,``,n),globalThis?.dispatchEvent?.(new CustomEvent(`route-change`,{detail:e}))}function Bt(e,t){zt({view:e,params:t})}function Vt(){return(Vt=e((()=>{de(),oe(),p(),S(),te(),at(),[...ae],O(`home`,E)})))()}function Ht(){return(Ht=e((()=>{})))()}function Ut(){return(Ut=e((()=>{ft(),T(),Et(),Vt(),de(),Ht()})))()}var Wt,Gt,Kt,qt,Jt,P,Yt,F,I,Xt;function Zt(){return(Zt=e((()=>{Wt=[`en`,`ru`,`en-GB`,`en-US`],Gt=e=>e===`en`?`English (generic)`:e===`ru`?`Russian`:e===`en-GB`?`English (UK)`:`English (US)`,Kt=e=>{let t=(e||``).trim();return t?t===`ru`||t.startsWith(`ru-`)?`ru`:t===`en-GB`?`en-GB`:t===`en-US`?`en-US`:t===`en`||t.startsWith(`en-`)?`en`:null:null},qt=()=>{let e=new Set,t=typeof navigator<`u`?[...navigator.languages||[],navigator.language]:[];for(let n of t){let t=Kt(n);t&&e.add(t)}for(let t of Wt)e.add(t);return Array.from(e)},Jt=()=>{let e=new Set([`ru`,`en`]),t=typeof navigator<`u`?[...navigator.languages||[],navigator.language]:[];for(let n of t){let t=(n||``).trim();t&&t!==`en`&&t!==`ru`&&e.add(t)}return Array.from(e)},P=(e,t)=>{let n=Number((e||``).trim());return Number.isFinite(n)?n:t},Yt=(e,t,n,r)=>{let i=Number.parseFloat((e||``).trim());return Number.isFinite(i)?Math.max(n,Math.min(r,i)):t},F=(e,t=``)=>{if(!e)return t;let n=e.value.trim();return!n&&e instanceof HTMLInputElement&&e.type===`password`?t:n||t},I=(e,t)=>e?!!e.checked:t,Xt=e=>{if(typeof e.composedPath==`function`){for(let t of e.composedPath())if(t instanceof Element)return t}let t=e.target;return t instanceof Element?t:t instanceof Text?t.parentElement:null}})))()}var Qt,$t,en;function tn(){return(tn=e((()=>{c(),Qt=e=>{let t={id:(e?.id||`mcp-${Date.now()}-${Math.random().toString(16).slice(2,8)}`).trim(),serverLabel:(e?.serverLabel||``).trim(),origin:(e?.origin||``).trim(),clientKey:(e?.clientKey||``).trim(),secretKey:(e?.secretKey||``).trim()};return n`<div class="field mcp-row" data-mcp-id=${t.id}>
            <label class="field">
    ...
    </header>`})))()}var sn,cn,L,ln,un,dn,fn,pn,mn,hn,gn;function R(){return(R=e((()=>{c(),Pe(),sn=[{hex:Le,label:`Cyan`},{hex:`#4f8eb5`,label:`Steel`},{hex:`#64748b`,label:`Slate`},{hex:`#3b82f6`,label:`Blue`},{hex:`#6366f1`,label:`Indigo`},{hex:`#14b8a6`,label:`Teal`},{hex:`#22c55e`,label:`Green`},{hex:`#f59e0b`,label:`Amber`},{hex:`#ef4444`,label:`Red`},{hex:`#ec4899`,label:`Pink`},{hex:`#8b5cf6`,label:`Violet`}],cn={wallpaper:`From wallpaper`,"material-you":`From Material You`,"system-wallpaper":`From system wallpaper`,"speed-dial":`From Speed Dial wallpaper`,custom:`Custom hue`},L=(e,t)=>{if(e===`auto`)return`Auto (${cn[t]})`;let n=cn[e];return e===t?`${n} (default)`:n},ln=()=>{let e=ze();return n`<section class="card settings-tab-panel" data-tab-panel="appearance">
      <h3>Appearance</h3>
      ...
      <div class="field appearance-base-color" data-appearance-color>
        ...
        <div class="appearance-custom" data-appearance-custom hidden>
          ...
          <div class="appearance-swatches" role="listbox" aria-label="Accent color">
            ${sn.map(e=>n`<button type="button" class="appearance-swatch" data-color="${e.hex}" title="${e.label}" aria-label="${e.label}" style="background:${e.hex}"></button>`)}
          </div>
    ...
    </section>`},un={auto:`Uses this app’s default source.`,wallpaper:`Dominant color from the launcher / environment wallpaper.`,"material-you":`Android Material You system accent.`,"system-wallpaper":`Dominant color from the OS desktop wallpaper.`,"speed-dial":`Dominant color from the Speed Dial wallpaper.`,custom:`Manual swatch, hue, or color picker.`},dn=e=>{let t=Be(e);if(!t)return 200;let n=parseInt(t.slice(1,3),16)/255,r=parseInt(t.slice(3,5),16)/255,i=parseInt(t.slice(5,7),16)/255,a=Math.max(n,r,i),o=a-Math.min(n,r,i);if(o<1e-4)return 200;let s=0;return s=a===n?(r-i)/o%6:a===r?(i-n)/o+2:(n-r)/o+4,s=Math.round(s*60),s<0?s+360:s},fn=e=>{let t=(Number(e)%360+360)%360,n=e=>{let n=(e+t/30)%12,r=.57-.1806*Math.max(Math.min(n-3,9-n,1),-1);return Math.round(255*r).toString(16).padStart(2,`0`)};return`#${n(0)}${n(8)}${n(4)}`},pn=e=>{let t=e.querySelector(`[data-field="appearance.colorSource"]`);return Fe(t?.value)?t.value:`auto`},mn=(e,t)=>{let n=e.querySelector(`[data-field="appearance.colorSource"]`),r=e.querySelector(`[data-appearance-custom]`),i=e.querySelector(`[data-appearance-source-hint]`),a=Fe(t)?t:`auto`;n&&(n.value=a),r&&(r.hidden=a!==`custom`),i&&(i.textContent=un[a])},hn=(e,t)=>{let n=e.querySelector(`[data-field="appearance.color"]`),r=e.querySelector(`[data-field="appearance.hue"]`),i=Be(t)||`#5a9ec8`;n&&(n.value=i),r&&(r.value=String(dn(i))),e.querySelectorAll(`.appearance-swatch`).forEach(e=>{e.setAttribute(`aria-selected`,Be(e.dataset.color)===i?`true`:`false`)})},gn=e=>{let t=e.querySelector(`[data-field="appearance.color"]`);return Be(t?.value)}})))()}var _n;function vn(){return(vn=e((()=>{c(),_n=()=>n`<section class="card settings-tab-panel" data-tab-panel="markdown">
          ...
          <textarea class="form-input code-highlight-source" rows="10" spellcheck="false" autocomplete="off" autocapitalize="off" wrap="off" data-language="json" data-field="appearance.markdown.extensions" placeholder='[
  {
    ...
    "enabled": true
    ...
    </section>`})))()}var yn;function z(){return(z=e((()=>{c(),yn=()=>n`<section class="card settings-tab-panel is-active" data-tab-panel="ai">
      <h3>AI</h3>
    ...
    </section>`})))()}var bn;function xn(){return(xn=e((()=>{c(),bn=()=>n`<section class="card settings-tab-panel" data-tab-panel="mcp">
      <h3>MCP</h3>
      <div class="mcp-section" data-mcp-section></div>
      <div class="mcp-actions">
        <button class="btn" type="button" data-action="add-mcp-server">Add MCP server</button>
      </div>
    </section>`})))()}var Sn;function Cn(){return(Cn=e((()=>{c(),Sn=()=>n`<section class="card settings-tab-panel" data-tab-panel="server">
      <h3>Server</h3>
      ...
      <label class="field checkbox form-checkbox">
    ...
    </section>`})))()}var wn;function Tn(){return(Tn=e((()=>{c(),d(),St(),se(),wn=(e={})=>{let t=f({instructions:[],activeId:``,editingId:null,newLabel:``,newInstruction:``,isAdding:!1}),r=n`<div class="custom-instructions-editor">
        <div class="ci-row">
            <div class="ci-header">
        ...
        <div class="ci-actions">
            ...
            </div>`;s.addEventListener(`click`,n=>{let r=n.target.closest(`[data-action]`)?.getAttribute(`data-action`);if(r===`activate`&&vt(a.id).then(p).then(()=>e.onUpdate?.()),r===`edit`&&(t.editingId=a.id,l()),r===`delete`&&confirm(`Delete "${a.label}"?`)&&yt(a.id).then(p).then(()=>e.onUpdate?.()),r===`save-edit`){let n=s.querySelector(`[data-edit-field='label']`),r=s.querySelector(`[data-edit-field='instruction']`);bt(a.id,{label:n.value.trim()||a.label,instruction:r.value.trim()}).then(()=>(t.editingId=null,p())).then(()=>e.onUpdate?.())}r===`cancel-edit`&&(t.editingId=null,l())}),i.append(s)}},u=()=>{a.replaceChildren(),a.append(n`<option value="">None (use default)</option>`);for(let e of t.instructions??[]){let r=n`<option value="${e.id}">${e.label}</option>`;e.id===t.activeId&&(r.selected=!0),a.append(r)}},d=(e,t)=>!e||e.length<=t?e||``:e.slice(0,t).trim()+`…`,p=async()=>{let e=await M(),n=Array.isArray(e)?{instructions:e,activeId:``,activeInstruction:null}:e;t.instructions=n?.instructions??[],t.activeId=n?.activeId??``,l(),u()};return r.addEventListener(`click`,n=>{let r=n.target.closest(`[data-action]`)?.getAttribute(`data-action`);if(r===`add`&&(t.isAdding=!0,o.hidden=!1,s.value=``,c.value=``,s.focus()),r===`cancel-add`&&(t.isAdding=!1,o.hidden=!0),r===`save-new`){let n=s.value.trim(),r=c.value.trim();if(!r){c.focus();return}j(n||`Custom`,r).then(e=>{if(e)return t.isAdding=!1,o.hidden=!0,p()}).then(()=>e.onUpdate?.())}if(r===`add-templates`){let n=new Set((t.instructions??[]).map(e=>e.label.trim().toLowerCase())),r=ce.filter(e=>!n.has(e.label.trim().toLowerCase()));if(!r.length){alert(`All templates are already added.`);return}xt(r.map(e=>({label:e.label,instruction:e.instruction,enabled:e.enabled}))).then(p).then(()=>e.onUpdate?.())}}),a.addEventListener(`change`,()=>{let t=a.value||``;vt(t||null).then(p).then(()=>e.onUpdate?.())}),p(),r}})))()}var En;function Dn(){return(Dn=e((()=>{c(),Tn(),En=e=>n`<section class="card settings-tab-panel" data-tab-panel="instructions" data-section="instructions">
      <h3>Recognition Instructions</h3>
      <div data-custom-instructions="editor">
        ${wn({onUpdate:()=>e(`Instructions updated.`)})}
      </div>
    </section>`})))()}var On;function kn(){return(kn=e((()=>{c(),On=()=>n`<section class="card settings-tab-panel" data-tab-panel="extension" data-section="extension" hidden>
      <h3>Extension</h3>
      <label class="field">
    ...
    ${nn()}
  </div>`;Ft(l),si();let u=fi(),d=pi(),f=ct(u,d),p=bi(e.isExtension,e.hubSection);if(u!==`none`){let t=e.hubSection||p.hubSection||`hub`;p.hubSection=f.length&&!f.includes(t)?`hub`:t}let m=mt(p);if(l.dataset.hubSettingsSection=p.hubSection||t,Ci(l,p),f.length>1){let e=l.querySelector(`.settings-screen__top`),t=l.querySelector(`[data-settings-tabs]`);if(e&&t){let r=document.createElement(`nav`);r.className=`settings-tab-actions settings-sku-nav`,r.setAttribute(`data-settings-sku-nav`,``),r.setAttribute(`aria-label`,`Settings area`);for(let e of Vi){if(!f.includes(e.id))continue;let t=document.createElement(`button`);t.className=`settings-tab-btn`,t.type=`button`,t.setAttribute(`data-action`,`open-settings-section`),t.setAttribute(`data-section`,e.id),t.append(n`<ui-icon class="settings-sku-nav__icon" icon="${e.icon}" icon-style="duotone" aria-hidden="true"></ui-icon>`,n`<span>${e.label}</span>`),t.classList.toggle(`is-active`,e.id===(p.hubSection||`hub`)),r.appendChild(t)}e.insertBefore(r,t)}}u===`launcher`&&d===null&&mi().then(e=>{e.length&&(Bi(),globalThis.dispatchEvent(new CustomEvent(`cwsp-settings-section`)))}),ut(l,m),m===`full`&&(p.surface===`capacitor`||p.surface===`native`)&&(l.querySelector(`[data-tab-panel="server"]`)?.remove(),l.querySelector(`[data-action="switch-settings-tab"][data-tab="server"]`)?.remove());let h=e=>pt(l,e),v=e=>{let t=String(e?.getAttribute(`data-apk-sku`)||e?.closest(`[data-apk-sku-row]`)?.getAttribute(`data-apk-sku-row`)||``).trim();return t&&ee(t)&&t!==`crx`?t:``},y=e=>{let t=v(e||null),n=lt(l.dataset.hubSettingsSection||`hub`),r=t||(fi()!==`none`&&n!==`hub`?dt(n):g()||`launcher`);return{sku:r,packageName:b(r)||``,manifest:_(r)}},x=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`&&e.trim()&&e!==`?`){let t=Number(e);return Number.isFinite(t)?t:null}return null},te=(e,t)=>{let n=e=>String(e||``).trim().split(/[+-]/)[0].split(`.`).map(e=>Number(String(e).replace(/[^0-9]/g,``))||0),r=n(e),i=n(t);if(!String(e||``).trim()&&!String(t||``).trim())return 0;let a=Math.max(r.length,i.length);for(let e=0;e<a;e++){let t=r[e]||0,n=i[e]||0;if(t!==n)return t<n?-1:1}return 0},ne=(e,t,n)=>{if(!e)return;let r=n,i=String(t.localVersionName||t.versionName||r?.versionName||``).trim(),a=x(t.localVersionCode??t.versionCode??r?.versionCode),o=String(t.localSignatureSha256||t.signatureSha256||``).slice(0,12),s=String(t.remoteVersionName||``).trim(),c=x(t.remoteVersionCode),l=t.installed===!1||r?.installed===!1?!1:t.installed===!0||r?.installed===!0||!!(i&&a!=null&&a!==0),u=c==null?``:` · gateway ${s||`?`} (${c})`,d=String(t.baseUrl||t.source||``).trim(),f=d?` · ${d}`:``;if(!l){e.textContent=`Not installed — Download & install to sideload.${u}${f}`;return}e.textContent=`Installed: ${i||`?`} (${a??`?`})`+(o?` · sig ${o}…`:``)+u+f},re=()=>({srcEl:l.querySelector(`[data-field="shell.apkUpdateSource"]`),endpointEl:l.querySelector(`[data-field="core.endpointUrl"]`),tokenEl:l.querySelector(`[data-field="core.ecosystemToken"]`),insecureEl:l.querySelector(`[data-field="core.allowInsecureTls"]`)}),ie=e=>{let{srcEl:t,endpointEl:n}=re(),r=String(t?.value||e?.shell?.apkUpdateSource||``).trim().toLowerCase();return r===`lan`||r===`relay`||r===`wan`?r:String(n?.value||e?.core?.endpointUrl||``).toLowerCase().includes(`192.168.0.200`)?`lan`:`wan`},S=e=>l.querySelector(e);r=l.querySelector(`[data-note]`);let C=S(`[data-field="ai.baseUrl"]`),T=S(`[data-field="ai.apiKey"]`),E=S(`[data-field="ui.showKey"]`),D=S(`[data-field="ai.model"]`),O=S(`[data-field="ai.customModel"]`),ae=l.querySelector(`[data-field-group="ai.customModel"]`),oe=S(`[data-field="ai.defaultReasoningEffort"]`),se=S(`[data-field="ai.defaultVerbosity"]`),ce=S(`[data-field="ai.maxOutputTokens"]`),le=S(`[data-field="ai.contextTruncation"]`),de=S(`[data-field="ai.promptCacheRetention"]`),fe=S(`[data-field="ai.maxToolCalls"]`),pe=S(`[data-field="ai.parallelToolCalls"]`),me=S(`[data-field="ai.requestTimeout.low"]`),he=S(`[data-field="ai.requestTimeout.medium"]`),ge=S(`[data-field="ai.requestTimeout.high"]`),_e=S(`[data-field="ai.maxRetries"]`),ve=()=>{let e=(D?.value||``).trim()===`custom`;ae&&(ae.hidden=!e),O&&(O.disabled=!e)};if(D){D.replaceChildren();for(let e of xe){let t=document.createElement(`option`);t.value=e,t.textContent=e,D.append(t)}let e=document.createElement(`option`);e.value=`custom`,e.textContent=`Custom...`,D.append(e),D.addEventListener(`change`,ve)}O?.addEventListener(`focus`,()=>{D&&(D.value=`custom`,ve())});let k=S(`[data-field="ai.responseLanguage"]`),be=S(`[data-field="ai.translateResults"]`),Se=S(`[data-field="ai.generateSvgGraphics"]`),Ce=S(`[data-field="speech.language"]`),we=S(`[data-field="appearance.theme"]`),Ee=S(`[data-field="appearance.fontSize"]`),De=l.querySelector(`[data-appearance-color]`),Pe=S(`[data-field="appearance.colorSource"]`),Fe=S(`[data-field="appearance.hue"]`),Le=S(`[data-field="appearance.color"]`),Re=S(`[data-field="appearance.markdown.preset"]`),ze=S(`[data-field="appearance.markdown.fontFamily"]`),Be=S(`[data-field="appearance.markdown.fontSizePx"]`),Ve=S(`[data-field="appearance.markdown.lineHeight"]`),We=S(`[data-field="appearance.markdown.contentMaxWidthPx"]`),Ge=S(`[data-field="appearance.markdown.printScale"]`),Ke=S(`[data-field="appearance.markdown.page.size"]`),qe=S(`[data-field="appearance.markdown.page.orientation"]`),Je=S(`[data-field="appearance.markdown.page.marginMm"]`),Ye=S(`[data-field="appearance.markdown.modules.typography"]`),Xe=S(`[data-field="appearance.markdown.modules.lists"]`),Ze=S(`[data-field="appearance.markdown.modules.tables"]`),Qe=S(`[data-field="appearance.markdown.modules.codeBlocks"]`),$e=S(`[data-field="appearance.markdown.modules.blockquotes"]`),et=S(`[data-field="appearance.markdown.modules.media"]`),tt=S(`[data-field="appearance.markdown.modules.printBreaks"]`),A=S(`[data-field="appearance.markdown.plugins.smartTypography"]`),nt=S(`[data-field="appearance.markdown.plugins.softBreaksAsBr"]`),rt=S(`[data-field="appearance.markdown.plugins.externalLinksNewTab"]`),at=l.querySelector(`[data-field="appearance.markdown.customCss"]`),ft=l.querySelector(`[data-field="appearance.markdown.printCss"]`),ht=l.querySelector(`[data-field="appearance.markdown.extensions"]`),_t=S(`[data-field="core.ntpEnabled"]`),vt=S(`[data-field="core.mode"]`),yt=S(`[data-field="core.endpointUrl"]`),bt=S(`[data-field="core.userId"]`),j=S(`[data-field="core.userKey"]`),M=S(`[data-field="core.ecosystemToken"]`),xt=S(`[data-field="core.preferBackendSync"]`),St=S(`[data-field="core.encrypt"]`),wt=S(`[data-field="core.appClientId"]`),Et=S(`[data-field="core.allowInsecureTls"]`),Dt=S(`[data-field="core.ops.allowUnencrypted"]`),Ot=S(`[data-field="core.admin.httpsOrigin"]`),kt=S(`[data-field="core.admin.httpOrigin"]`),jt=S(`[data-field="core.admin.path"]`),N=S(`[data-field="core.socket.accessToken"]`),Mt=S(`[data-field="core.socket.routeTarget"]`),Nt=S(`[data-field="core.socket.clientAccessToken"]`),Pt=S(`[data-field="core.socket.allowAccessTokenWithoutUserKey"]`),It=S(`[data-field="shell.maintainHubSocketConnection"]`),Lt=S(`[data-field="shell.clipboardBroadcastTargets"]`),Rt=S(`[data-field="shell.pushLocalClipboardToLan"]`),zt=S(`[data-field="shell.clipboardPushIntervalMs"]`),Vt=S(`[data-field="shell.enableRemoteClipboardBridge"]`),Ht=S(`[data-field="shell.acceptInboundClipboardData"]`),Ut=S(`[data-field="shell.clipboardInboundAllowIds"]`),Wt=S(`[data-field="shell.accessTokenBypassesClipboardAllowlist"]`),Kt=S(`[data-field="shell.clipboardShareDestinationIds"]`),Zt=S(`[data-field="shell.applyRemoteClipboardToDevice"]`),tn=S(`[data-field="shell.acceptContactsBridgeData"]`),rn=S(`[data-field="shell.acceptSmsBridgeData"]`),on=S(`[data-field="shell.enableNativeSms"]`),sn=S(`[data-field="shell.enableNativeContacts"]`),cn=l.querySelector(`[data-admin-preview]`),L=l.querySelector(`[data-mcp-section]`),un=l.querySelector(`[data-section="extension"]`),dn=l.querySelector(`[data-extension-tab]`);if(k){k.replaceChildren();let e=document.createElement(`option`);e.value=`auto`,e.textContent=`Auto-detect`,k.append(e);let t=document.createElement(`option`);t.value=`follow`,t.textContent=`Follow source/context`,k.append(t);for(let e of Jt()){let t=document.createElement(`option`);t.value=e,t.textContent=e===`ru`?`Russian`:e===`en`?`English`:e,k.append(t)}}if(Ce){Ce.replaceChildren();for(let e of qt()){let t=document.createElement(`option`);t.value=e,t.textContent=Gt(e),Ce.append(t)}}l.addEventListener(`input`,e=>{e.target?.matches?.(`[data-field^="core."]`)&&xn()}),l.addEventListener(`change`,e=>{e.target?.matches?.(`[data-field^="core."]`)&&xn()});let R=e=>{let t=it(m),n=e||t,r=()=>l.querySelectorAll(`.settings-screen__body > [data-tab-panel]`);[...r()].some(e=>e.getAttribute(`data-tab-panel`)===n)||(n=r()[0]?.getAttribute(`data-tab-panel`)||t),l.querySelector(`[data-settings-tabs]`)?.setAttribute(`data-active-tab`,n);let i=l.querySelectorAll(`[data-action="switch-settings-tab"][data-tab]`);for(let e of Array.from(i)){let t=e,r=t.getAttribute(`data-tab`)===n;t.classList.toggle(`is-active`,r),t.setAttribute(`aria-selected`,String(r))}let a=r();for(let e of Array.from(a)){let t=e,r=t.getAttribute(`data-tab-panel`)===n;r?t.removeAttribute(`hidden`):t.hidden=!0,t.classList.toggle(`is-active`,r)}};l.addEventListener(`click`,e=>{let t=Xt(e),n=t?.closest?.(`[data-action="open-settings-section"][data-section]`);if(n&&l.contains(n)){e.preventDefault(),e.stopPropagation();let t=String(n.getAttribute(`data-section`)||`hub`).toLowerCase();if(ot(t),Bi(),fi()===`hub`){let e=gt(t);Bt(`settings`,e?{section:e}:{})}else globalThis.dispatchEvent(new CustomEvent(`cwsp-settings-section`,{detail:{section:t}}));return}let r=t?.closest?.(`[data-action="switch-settings-tab"][data-tab]`);r&&l.contains(r)&&(e.preventDefault(),e.stopPropagation(),R(r.getAttribute(`data-tab`)||it(m)))},!0);let vn=e=>{let t=it(m),n=(e||``).trim().toLowerCase();return n?n===`style`||n===`styles`||n===`styling`?h(`markdown`)?`markdown`:t:new Set([...h(`appearance`)?[`appearance`]:[],...h(`markdown`)?[`markdown`]:[],...h(`ai`)?[`ai`]:[],...h(`mcp`)?[`mcp`]:[],...h(`server`)?[`server`]:[],...h(`instructions`)?[`instructions`]:[],...h(`extension`)?[`extension`]:[],...Ii(p)]).has(n)?n:t:t},z=()=>{let e=M?.value?.trim()||j?.value?.trim()||N?.value?.trim()||``;return{mode:vt?.value||`native`,endpointUrl:yt?.value?.trim()||``,userId:bt?.value?.trim()||``,ecosystemToken:e,userKey:e,encrypt:!!St?.checked,preferBackendSync:(xt?.checked??!0)!==!1,appClientId:wt?.value?.trim()||``,allowInsecureTls:!!Et?.checked,useCoreIdentityForAirPad:!0,socket:{accessToken:e,routeTarget:Mt?.value?.trim()||``,selfId:``,clientAccessToken:Nt?.value?.trim()||``,allowAccessTokenWithoutUserKey:!!Pt?.checked},admin:{httpsOrigin:Ot?.value?.trim()||``,httpOrigin:kt?.value?.trim()||``,path:jt?.value?.trim()||`/`},ops:{allowUnencrypted:!!Dt?.checked}}},xn=()=>{if(!cn)return;let e=Ct(z());cn.textContent=`Resolved: ${e.https} · ${e.http}`},Cn=e=>{try{o(s.EXPLORER_PATH,e),Bt(`explorer`),ue({type:`content-explorer`,destination:`explorer`,data:{action:`view`,path:e},metadata:{source:`settings`}}),c(`Explorer: ${e}`)}catch(e){console.warn(`[Settings] Failed to open explorer path:`,e),c(`Failed to open Explorer path.`)}};Promise.resolve((async()=>((p.surface===`capacitor`||p.surface===`native`)&&await Ae().catch(()=>null),(p.surface===`crx`||p.isExtension)&&await Me().catch(()=>null),Ni(()=>je())))()).then(t=>{C&&(C.value=(t?.ai?.baseUrl||``).trim()),T&&(T.value=(t?.ai?.apiKey||``).trim());let n=(t?.ai?.model||`gpt-5.6-luna`).trim(),r=(t?.ai?.customModel||``).trim();if(D){let e=xe.includes(n);n===`custom`||!e&&n?(D.value=`custom`,O&&(O.value=r||n)):(D.value=e?n:`gpt-5.6-luna`,O&&(O.value=r)),ve()}if(oe&&(oe.value=t?.ai?.defaultReasoningEffort||`medium`),se&&(se.value=t?.ai?.defaultVerbosity||`medium`),ce&&(ce.value=String(t?.ai?.maxOutputTokens??4e5)),le&&(le.value=t?.ai?.contextTruncation||`disabled`),de&&(de.value=t?.ai?.promptCacheRetention||`in-memory`),fe&&(fe.value=String(t?.ai?.maxToolCalls??8)),pe&&(pe.checked=(t?.ai?.parallelToolCalls??!0)!==!1),me&&(me.value=String(t?.ai?.requestTimeout?.low??6e4)),he&&(he.value=String(t?.ai?.requestTimeout?.medium??3e5)),ge&&(ge.value=String(t?.ai?.requestTimeout?.high??9e5)),_e&&(_e.value=String(t?.ai?.maxRetries??2)),k&&(k.value=t?.ai?.responseLanguage||`auto`),be&&(be.checked=!!t?.ai?.translateResults),Se&&(Se.checked=!!t?.ai?.generateSvgGraphics),Ce&&(Ce.value=t?.speech?.language||`en-US`),we&&(we.value=t?.appearance?.theme||`auto`),Ee&&(Ee.value=t?.appearance?.fontSize||`medium`),De&&(De.hidden=!1,mn(l,String(t?.appearance?.colorSource||`auto`)),hn(l,String(t?.appearance?.color||``))),Re&&(Re.value=t?.appearance?.markdown?.preset||`default`),ze&&(ze.value=t?.appearance?.markdown?.fontFamily||`system`),Be&&(Be.value=String(t?.appearance?.markdown?.fontSizePx??16)),Ve&&(Ve.value=String(t?.appearance?.markdown?.lineHeight??1.7)),We&&(We.value=String(t?.appearance?.markdown?.contentMaxWidthPx??860)),Ge&&(Ge.value=String(t?.appearance?.markdown?.printScale??1)),Ke&&(Ke.value=t?.appearance?.markdown?.page?.size||`auto`),qe&&(qe.value=t?.appearance?.markdown?.page?.orientation||`portrait`),Je&&(Je.value=String(t?.appearance?.markdown?.page?.marginMm??12)),Ye&&(Ye.checked=(t?.appearance?.markdown?.modules?.typography??!0)!==!1),Xe&&(Xe.checked=(t?.appearance?.markdown?.modules?.lists??!0)!==!1),Ze&&(Ze.checked=(t?.appearance?.markdown?.modules?.tables??!0)!==!1),Qe&&(Qe.checked=(t?.appearance?.markdown?.modules?.codeBlocks??!0)!==!1),$e&&($e.checked=(t?.appearance?.markdown?.modules?.blockquotes??!0)!==!1),et&&(et.checked=(t?.appearance?.markdown?.modules?.media??!0)!==!1),tt&&(tt.checked=(t?.appearance?.markdown?.modules?.printBreaks??!0)!==!1),A&&(A.checked=!!t?.appearance?.markdown?.plugins?.smartTypography),nt&&(nt.checked=!!t?.appearance?.markdown?.plugins?.softBreaksAsBr),rt&&(rt.checked=(t?.appearance?.markdown?.plugins?.externalLinksNewTab??!0)!==!1),at&&(at.value=(t?.appearance?.markdown?.customCss||``).trim()),ft&&(ft.value=(t?.appearance?.markdown?.printCss||``).trim()),ht){let e=Array.isArray(t?.appearance?.markdown?.extensions)?t.appearance?.markdown?.extensions:[];ht.value=e.length>0?JSON.stringify(e,null,2):``}_t&&(_t.checked=!!t?.core?.ntpEnabled),vt&&(vt.value=t?.core?.mode||`native`),yt&&(yt.value=(t?.core?.endpointUrl||``).trim()),bt&&(bt.value=(t?.core?.userId||``).trim());{let e=String(t?.core?.ecosystemToken||``).trim()||String(t?.core?.userKey||``).trim()||String(t?.core?.socket?.accessToken||t?.core?.socket?.airpadAuthToken||``).trim();M&&(M.value=e),j&&(j.value=e),N&&(N.value=e)}if(xt&&(xt.checked=(t?.core?.preferBackendSync??!0)!==!1),St&&(St.checked=!!t?.core?.encrypt),wt&&(wt.value=(t?.core?.appClientId||``).trim()),Mt&&(Mt.value=(t?.core?.socket?.routeTarget||t?.core?.socket?.selfId||``).trim()),Nt&&(Nt.value=(t?.core?.socket?.clientAccessToken||``).trim()),Pt&&(Pt.checked=(t?.core?.socket?.allowAccessTokenWithoutUserKey??!1)===!0),Et&&(Et.checked=!!t?.core?.allowInsecureTls),Dt&&(Dt.checked=!!t?.core?.ops?.allowUnencrypted),Ot&&(Ot.value=(t?.core?.admin?.httpsOrigin||``).trim()),kt&&(kt.value=(t?.core?.admin?.httpOrigin||``).trim()),jt&&(jt.value=(t?.core?.admin?.path||`/`).trim()||`/`),It&&(It.checked=!!t?.shell?.maintainHubSocketConnection),Lt&&(Lt.value=(t?.shell?.clipboardBroadcastTargets||``).trim()),Rt&&(Rt.checked=!!t?.shell?.pushLocalClipboardToLan),zt){let e=Number(t?.shell?.clipboardPushIntervalMs);zt.value=String(Number.isFinite(e)&&e>=800?Math.min(Math.round(e),6e4):2e3)}Vt&&(Vt.checked=(t?.shell?.enableRemoteClipboardBridge??!0)!==!1),Ht&&(Ht.checked=(t?.shell?.acceptInboundClipboardData??!0)!==!1),Ut&&(Ut.value=(t?.shell?.clipboardInboundAllowIds||``).trim()),Wt&&(Wt.checked=(t?.shell?.accessTokenBypassesClipboardAllowlist??!1)===!0),Kt&&(Kt.value=(t?.shell?.clipboardShareDestinationIds||``).trim()),Zt&&(Zt.checked=(t?.shell?.applyRemoteClipboardToDevice??!0)!==!1),tn&&(tn.checked=(t?.shell?.acceptContactsBridgeData??!1)===!0),rn&&(rn.checked=!He()&&(t?.shell?.acceptSmsBridgeData??!1)===!0),on&&(on.checked=!He()&&(t?.shell?.enableNativeSms??!1)===!0),sn&&(sn.checked=(t?.shell?.enableNativeContacts??!0)!==!1),xn(),en(L,Array.isArray(t?.ai?.mcp)?t.ai.mcp:[]),Te(t),Ie(t),Ti(l,t,p),At(l),e.onTheme?.(t?.appearance?.theme||`auto`),He()&&w(()=>import(`./cws-bridge-BQCvS5uE.js`).then(e=>(e.a(),e.n)).then(async e=>{let t=[...l.querySelectorAll(`[data-apk-local-version]`)];t.length&&await Promise.all(t.map(async t=>{let n=y(t);try{let r=await e.invokeCwsNative(`app:info`,n);ne(t,r?.echo||{},r)}catch{}}))}),[],import.meta.url).catch(()=>{})}).catch(()=>{en(L,[]),At(l)}),E?.addEventListener(`change`,()=>{T&&E&&(T.type=E.checked?`text`:`password`)});let wn=e=>{(async()=>{try{let t=await je();Ie({...t,appearance:{...t.appearance||{},...e}})}catch{Ie({appearance:{theme:`auto`,fontSize:`medium`,...e}})}})()};if(De?.addEventListener(`click`,e=>{let t=e.target?.closest?.(`.appearance-swatch`);if(!t)return;let n=t.dataset.color??``;mn(l,`custom`),hn(l,n),wn({color:n,colorSource:`custom`})}),Pe?.addEventListener(`change`,()=>{let e=pn(l);mn(l,e),wn({colorSource:e,color:e===`custom`?gn(l):void 0})}),Fe?.addEventListener(`input`,()=>{let e=fn(Number(Fe.value));mn(l,`custom`),hn(l,e),wn({color:e,colorSource:`custom`})}),Le?.addEventListener(`input`,()=>{let e=Le.value||``;mn(l,`custom`),hn(l,e),wn({color:e,colorSource:`custom`})}),we?.addEventListener(`change`,()=>{let t=we.value||`auto`;(async()=>{try{let e=await je();Ie({...e,appearance:{...e.appearance||{},theme:t}})}catch{Ie({appearance:{theme:t,fontSize:`medium`}})}e.onTheme?.(t)})()}),l.addEventListener(`click`,t=>{let n=Xt(t);if(n?.closest?.(`button[data-action="add-mcp-server"]`)&&L){L.querySelector(`.mcp-empty-note`)?.remove(),L.appendChild(Qt({id:`mcp-${Date.now()}-${Math.random().toString(16).slice(2,8)}`,serverLabel:``,origin:``,clientKey:``,secretKey:``}));return}let r=n?.closest?.(`button[data-action="remove-mcp-server"]`);if(r){r.closest(`.mcp-row`)?.remove(),L&&!L.querySelector(`[data-mcp-id]`)&&en(L,[]);return}if(n?.closest?.(`button[data-action="open-user-styles"]`)){Cn(`/user/styles/`);return}if(n?.closest?.(`button[data-action="open-assets-readonly"]`)){Cn(`/assets/`);return}if(n?.closest?.(`button[data-action="open-admin-https"]`)){Tt(z(),`https`);return}if(n?.closest?.(`button[data-action="open-admin-http"]`)){Tt(z(),`http`);return}if(n?.closest?.(`button[data-action="copy-admin-https"]`)){let e=Ct(z());navigator.clipboard?.writeText?.(e.https).then(()=>c(`HTTPS admin URL copied.`),()=>c(`Copy failed.`));return}if(n?.closest?.(`button[data-action="copy-admin-http"]`)){let e=Ct(z());navigator.clipboard?.writeText?.(e.http).then(()=>c(`HTTP admin URL copied.`),()=>c(`Copy failed.`));return}if(n?.closest?.(`button[data-action="open-native-app-settings"]`)){w(()=>import(`./clipboard-device-COza7uIZ.js`).then(e=>(e.n(),e.t)).then(e=>e.openAppClipboardRelatedSettings()),[],import.meta.url).then(()=>c(`App settings opened (native shell only).`)).catch(()=>c(`Native settings unavailable in this context.`));return}if(n?.closest?.(`button[data-action="open-native-notification-settings"]`)){w(()=>import(`./clipboard-device-COza7uIZ.js`).then(e=>(e.n(),e.t)).then(e=>e.openNativeNotificationSettings?.()),[],import.meta.url).then(()=>c(`Notification settings opened (native shell only).`)).catch(()=>c(`Native settings unavailable in this context.`));return}let i=n?.closest?.(`button[data-action="crx-control-pair"]`),a=n?.closest?.(`button[data-action="crx-control-unpair"]`);if(i||a){(async()=>{let e=l.querySelector(`[data-crx-control-status]`),t=()=>{try{globalThis.chrome?.runtime?.sendMessage?.({type:`cwsp-control-session-changed`})}catch{}};try{let n=await w(()=>import(`./crx-control-session-D7DIGdNp.js`),[],import.meta.url);if(a){await n.clearCrxControlSession(),e&&(e.textContent=await n.formatCrxControlSessionStatus()),c(`Control unpaired — Copy & Share / Paste by CWSP disabled.`,{tone:`warn`}),t();return}let r=String(l.querySelector(`[data-field="shell.localHubUrl"]`)?.value||``).trim(),i=String(document.documentElement.dataset.cwspControlOrigin||``).trim();e&&(e.textContent=`Control: waiting for pairing dialog…`),c(`Enter public token + device code in the pairing dialog…`);let o=await n.pairCrxControlWithModal({localHubUrl:r,preferredOrigins:i?[i]:[]});if(o.cancelled){e&&(e.textContent=await n.formatCrxControlSessionStatus()),c(`Pairing cancelled.`);return}e&&(e.textContent=o.ok?await n.formatCrxControlSessionStatus():`Control: ${o.error}`),o.ok?(c(`Paired Control at ${o.session.controlHost} (persistent).`),t()):c(o.error,{tone:`warn`})}catch(e){c(`Control pairing unavailable: ${e instanceof Error?e.message:String(e)}`,{tone:`warn`})}})();return}let o=n?.closest?.(`button[data-action="control-pairing-refresh"]`),s=n?.closest?.(`button[data-action="control-public-token-regenerate"]`);if(o||s){let e=!!t?.isTrusted;(async()=>{try{let t=String(location.hostname||``);if(location.protocol===`https:`&&t!==`localhost`&&t!==`127.0.0.1`){e&&c(`Pairing codes are shown on the device (phone/desk), not in the public Control SPA.`,{tone:`warn`});return}}catch{}let t=l.querySelector(`input[data-control-device-code], [data-control-device-code]`),n=l.querySelector(`input[data-control-public-token], [data-control-public-token]`),r=l.querySelector(`[data-secret-meta="control-device-code"]`),i=l.querySelector(`[data-secret-meta="control-public-token"]`),a=e=>{let a=String(e.deviceCode||``).trim(),o=Math.max(1,Math.round(Number(e.expiresInMs||0)/1e3)),s=String(e.publicToken||``).trim();t instanceof HTMLInputElement?t.value=a:t&&(t.textContent=a?`Code: ${a} (${o}s)`:`Code: …`),n instanceof HTMLInputElement?n.value=s:n&&(n.textContent=s?`Public token: ${s}`:`Public token: …`),r&&(r.textContent=a?`Expires in ${o}s`:``),i&&(i.textContent=s?`Stable until regenerated`:``)};try{e&&c(s?`Regenerating public token…`:`Refreshing pairing code…`,{tone:`warn`});try{let{invokeCwsNative:t}=await w(async()=>{let{invokeCwsNative:e}=await import(`./cws-bridge-BQCvS5uE.js`).then(e=>(e.a(),e.n));return{invokeCwsNative:e}},[],import.meta.url),n=await t(s?`control:public-token:regenerate`:`control:pairing:status`,{}),r=n?.controlPairing||n?.echo||{};if(r?.deviceCode||r?.publicToken){a(r),e&&c(s?`New public token generated — update the Control SPA.`:`Pairing code refreshed.`,{tone:`ok`});return}}catch{}let t=globalThis,n=Number(t.__CWSP_CONTROL_PORT__||29110)||29110,r=String(t.__CWSP_CONTROL_API_KEY__||`cwsp-neutralino-local`).trim(),i=await fetch(`http://127.0.0.1:${n}${s?`/service/pair/regenerate-public-token`:`/service/pair/display`}`,{method:s?`POST`:`GET`,headers:{Accept:`application/json`,"Content-Type":`application/json`,"X-API-Key":r},body:s?`{}`:void 0});if(!i.ok)throw Error(`Control HTTP ${i.status}`);a(await i.json()),e&&c(s?`New public token generated — update the Control SPA.`:`Pairing code refreshed.`,{tone:`ok`})}catch(t){e&&c(String(t?.message||t||`Pairing status unavailable`),{tone:`err`})}})();return}let u=n?.closest?.(`button[data-action="files-storage-pick-saf"]`),d=n?.closest?.(`button[data-action="files-storage-clear-saf"]`),f=n?.closest?.(`button[data-action="files-storage-show-paths"]`),m=n?.closest?.(`button[data-action="files-storage-share-readme"]`),g=n?.closest?.(`button[data-action="files-storage-open-explorer"]`),_=n?.closest?.(`button[data-action="files-storage-perm-status"]`),v=n?.closest?.(`button[data-action="files-storage-request-media"]`),b=n?.closest?.(`button[data-action="files-storage-request-all-files"]`);if(u||d||f||m||g||_||v||b){(async()=>{try{let{invokeCwsNative:e}=await w(async()=>{let{invokeCwsNative:e}=await import(`./cws-bridge-BQCvS5uE.js`).then(e=>(e.a(),e.n));return{invokeCwsNative:e}},[],import.meta.url),t=await je(),n=l.querySelector(`[data-files-saf-uri]`),r=l.querySelector(`[data-files-storage-paths]`),i=l.querySelector(`[data-files-perm-status]`),a=e=>{if(!n)return;let t=String(e||``).trim();n.textContent=t?`SAF folder: ${t.length>72?`${t.slice(0,36)}…${t.slice(-28)}`:t}`:`SAF folder: (not set)`},o=e=>{i&&(i.textContent=`Media/storage runtime: ${e.runtimeGranted===!0?`granted`:`missing`}`+(e.missingRuntime?` (${e.missingRuntime})`:``)+`\nAll-files access: ${e.allFilesAccess===!0?`granted`:`not granted`}`+(e.note?`\n${e.note}`:``))};if(d){t.shell={...t.shell||{},filesIncomingDir:``,filesLandingMode:t.shell?.filesLandingMode||`app`},await Oe(t),a(``),c(`SAF folder cleared.`,{tone:`ok`});return}let s=u?`files:storage:pick-landing`:m?`files:storage:share-readme`:g?`files:storage:open-explorer`:v?`files:storage:request-media`:b?`files:storage:request-all-files`:_?`files:storage:permissions-status`:`files:storage:status`,f=l.querySelector(`[data-field="shell.filesStagingRoot"]`),p=l.querySelector(`[data-field="shell.filesLandingMode"]`);c(u?`Opening folder picker…`:g?`Opening CWSP Files…`:v?`Requesting media permission…`:b?`Opening all-files settings…`:`Reading storage…`,{tone:`warn`});let h=await e(s,{stagingRoot:f?.value||t.shell?.filesStagingRoot||`app`,landingMode:p?.value||t.shell?.filesLandingMode||`app`,incomingDir:t.shell?.filesIncomingDir||``}),y=h?.echo||h?.envelope?.payload||{},x=y?.error||h?.error||(!h?.ok&&!y?.outgoingDir&&!y?.documentUri&&y?.runtimeGranted===void 0?`storage action failed`:``);if(x){c(String(x),{tone:`err`});return}if(u&&y?.incomingDir){t.shell={...t.shell||{},filesIncomingDir:String(y.incomingDir),filesLandingMode:`saf`},await Oe(t),p&&(p.value=`saf`),a(String(y.incomingDir)),c(`SAF folder saved. Landing mode set to SAF.`,{tone:`ok`});return}(y.runtimeGranted!==void 0||y.allFilesAccess!==void 0)&&o(y),r&&(y?.outgoingDir||y?.incomingAppDir||y?.readmePath||y?.note)&&(r.textContent=`Outgoing temp: ${y.outgoingDir||`?`}\nIncoming temp: ${y.incomingAppDir||`?`}\nLanding mode: ${y.landingMode||`?`}`+(y?.incomingDir?`\nSAF: ${y.incomingDir}`:``)+(y?.note&&y.runtimeGranted===void 0?`\n${y.note}`:``)),c(m?`Shared README — open it in another app to see the paths.`:g?`Opened document picker — look for CWSP Files (or Files app sidebar).`:b?`Enable “Allow access to manage all files”, then tap Refresh status.`:v?`Media permission dialog finished — see status.`:`Status updated.`,{tone:`ok`})}catch(e){c(String(e?.message||e||`Files storage action failed`),{tone:`err`})}})();return}let ee=n?.closest?.(`button[data-action="apk-update-check"]`),S=n?.closest?.(`button[data-action="apk-update-install"]`);if(ee||S){let e=S?`app:update:install`:`app:update:check`;(async()=>{c(S?`Downloading APK…`:`Checking for update…`,{tone:`warn`});try{let t=await je(),{srcEl:n,endpointEl:r,tokenEl:i,insecureEl:a}=re(),o=l.querySelector(`[data-apk-local-version]`),s=ie(t),u=(r?.value||t.core?.endpointUrl||``).trim(),d=(i?.value||``).trim()||ye(t),f=a?.checked??!!t.core?.allowInsecureTls,{invokeCwsNative:p}=await w(async()=>{let{invokeCwsNative:e}=await import(`./cws-bridge-BQCvS5uE.js`).then(e=>(e.a(),e.n));return{invokeCwsNative:e}},[],import.meta.url),m=S||ee,h=y(m),g=await p(e,{...h,source:s,endpointUrl:u,token:d,ecosystemToken:d,allowInsecureTls:f}),_=g?.echo||g?.envelope?.payload||{},v=_?.error||g?.error||(!g?.ok&&!g?.echo?`update failed`:``);if(v){c(String(v),{tone:`err`});return}let b=m.closest(`[data-apk-sku-row]`)?.querySelector(`[data-apk-local-version]`)||o;if(b&&(_?.localVersionCode!=null||_?.localVersionName||_?.versionName)&&ne(b,_,g),S){c(_?.launchedInstaller?`Installer launched — confirm on the system prompt.`:`Install request sent.`,{tone:`ok`});return}let C=x(_?.localVersionCode),T=x(_?.remoteVersionCode),E=String(_?.localVersionName||``).trim(),D=String(_?.remoteVersionName||``).trim(),O=_?.updateAvailable===!0||g?.updateAvailable===!0||T!=null&&C!=null&&T>C||te(D,E)>0,ae=_?.signatureCompatible!==!1,oe=_?.installed===!0,se=String(_?.reason||``);if(!ae){c(`Signature mismatch — remote APK not signed like this install (local ${C??`?`}, remote ${T??`?`}).`,{tone:`err`});return}if(!oe){c(`${h.sku}: not installed — remote ${T??`?`} (${D||`?`}). Download & install to sideload.`,{tone:`warn`});return}if(se===`gateway-older`||T!=null&&C!=null&&T<C&&!O){c(`${h.sku}: gateway older (local ${E||`?`} ${C}, remote ${D||`?`} ${T}). Publish the newer APK.`,{tone:`warn`});return}if(C==null&&T==null){c(`${h.sku}: native echo missing versions — try Check again.`,{tone:`err`});return}c(O?`${h.sku}: update available ${E||C} → ${D||T} (${C??`?`} → ${T??`?`}).`:`${h.sku}: current (local ${E||`?`} ${C??`?`}, remote ${D||`?`} ${T??`?`}) — Download & install will sideload.`,{tone:O?`warn`:`ok`})}catch(e){c(String(e?.message||e),{tone:`err`})}})();return}n?.closest?.(`button[data-action="save"]`)&&(async()=>{c(`Saving…`,{tone:`warn`});let t=await je(),n=t.appearance?.markdown?.extensions||[],r=h(`markdown`)&&ht?.value?.trim()||``;if(r)try{let e=JSON.parse(r);if(!Array.isArray(e))throw Error(`Markdown extensions JSON must be an array.`);n=e}catch(e){R(`markdown`),c(e?.message||`Invalid Markdown extensions JSON.`);return}let i={...t,ai:h(`ai`)?(()=>{let e={...t.ai||{},baseUrl:C?.value?.trim?.()||``,apiKey:T?.value?.trim?.()||``,model:D?.value||`gpt-5.6-luna`,customModel:D?.value===`custom`&&O?.value?.trim?.()||``,defaultReasoningEffort:oe?.value||`medium`,defaultVerbosity:se?.value||`medium`,maxOutputTokens:P(ce?.value,4e5),contextTruncation:le?.value||`disabled`,promptCacheRetention:de?.value||`in-memory`,maxToolCalls:P(fe?.value,8),parallelToolCalls:(pe?.checked??!0)!==!1,requestTimeout:{low:P(me?.value,6e4),medium:P(he?.value,3e5),high:P(ge?.value,9e5)},maxRetries:P(_e?.value,2),responseLanguage:k?.value||`auto`,translateResults:!!be?.checked,generateSvgGraphics:!!Se?.checked,mcp:h(`mcp`)?$t(L):t.ai?.mcp||[],customInstructions:t.ai?.customInstructions||[],activeInstructionId:t.ai?.activeInstructionId||``,processIngress:t.ai?.processIngress};return delete e.shareTargetMode,delete e.autoProcessShared,e})():t.ai||{},speech:h(`ai`)?{language:Ce?.value||`en-US`}:t.speech||{},core:h(`server`)?{...t.core,ntpEnabled:I(_t,!!t.core?.ntpEnabled),mode:F(vt,t.core?.mode||`native`)||`native`,endpointUrl:F(yt,t.core?.endpointUrl||``),userId:F(bt,t.core?.userId||``),ecosystemToken:F(M,t.core?.ecosystemToken||t.core?.userKey||t.core?.socket?.accessToken||``)||F(j,t.core?.userKey||``)||F(N,t.core?.socket?.accessToken||t.core?.socket?.airpadAuthToken||``),userKey:F(M,t.core?.ecosystemToken||t.core?.userKey||t.core?.socket?.accessToken||``)||F(j,t.core?.userKey||``)||F(N,t.core?.socket?.accessToken||t.core?.socket?.airpadAuthToken||``),encrypt:I(St,!!t.core?.encrypt),preferBackendSync:I(xt,(t.core?.preferBackendSync??!0)!==!1),appClientId:F(wt,t.core?.appClientId||``),allowInsecureTls:I(Et,!!t.core?.allowInsecureTls),useCoreIdentityForAirPad:!0,socket:(()=>{let e={...t.core?.socket||{}};delete e.airpadAuthToken;let n=F(M,t.core?.ecosystemToken||t.core?.userKey||t.core?.socket?.accessToken||``)||F(j,t.core?.userKey||``)||F(N,t.core?.socket?.accessToken||t.core?.socket?.airpadAuthToken||``);return{...e,accessToken:n,routeTarget:F(Mt,t.core?.socket?.routeTarget||``),selfId:``,clientAccessToken:F(Nt,t.core?.socket?.clientAccessToken||``),allowAccessTokenWithoutUserKey:I(Pt,!!t.core?.socket?.allowAccessTokenWithoutUserKey)}})(),admin:{...t.core?.admin||{},httpsOrigin:F(Ot,t.core?.admin?.httpsOrigin||``),httpOrigin:F(kt,t.core?.admin?.httpOrigin||``),path:F(jt,t.core?.admin?.path||`/`)||`/`},ops:{...t.core?.ops||{},allowUnencrypted:I(Dt,!!t.core?.ops?.allowUnencrypted)}}:{...t.core||{}},shell:h(`server`)?{...t.shell||{},maintainHubSocketConnection:I(It,!!t.shell?.maintainHubSocketConnection),clipboardBroadcastTargets:F(Lt,t.shell?.clipboardBroadcastTargets||``),pushLocalClipboardToLan:I(Rt,!!t.shell?.pushLocalClipboardToLan),clipboardPushIntervalMs:(()=>{let e=zt?.value,n=P(e,t.shell?.clipboardPushIntervalMs??2e3);return Math.min(6e4,Math.max(800,Math.round(n)))})(),enableRemoteClipboardBridge:I(Vt,(t.shell?.enableRemoteClipboardBridge??!0)!==!1),acceptInboundClipboardData:I(Ht,(t.shell?.acceptInboundClipboardData??!0)!==!1),clipboardInboundAllowIds:F(Ut,t.shell?.clipboardInboundAllowIds||``),accessTokenBypassesClipboardAllowlist:I(Wt,!!t.shell?.accessTokenBypassesClipboardAllowlist),clipboardShareDestinationIds:F(Kt,t.shell?.clipboardShareDestinationIds||``),applyRemoteClipboardToDevice:I(Zt,(t.shell?.applyRemoteClipboardToDevice??!0)!==!1),acceptContactsBridgeData:I(tn,!!t.shell?.acceptContactsBridgeData),acceptSmsBridgeData:!He()&&I(rn,!!t.shell?.acceptSmsBridgeData),enableNativeSms:!He()&&I(on,(t.shell?.enableNativeSms??!1)===!0),enableNativeContacts:I(sn,(t.shell?.enableNativeContacts??!0)!==!1)}:{...t.shell||{}},appearance:h(`appearance`)||h(`markdown`)?{theme:we?.value||`auto`,fontSize:Ee?.value||`medium`,color:gn(l),colorSource:pn(l),markdown:{preset:Re?.value||`default`,fontFamily:ze?.value||`system`,fontSizePx:P(Be?.value,16),lineHeight:Yt(Ve?.value,1.7,1.1,2.2),contentMaxWidthPx:P(We?.value,860),printScale:Yt(Ge?.value,1,.5,1.5),page:{size:Ke?.value||`auto`,orientation:qe?.value||`portrait`,marginMm:P(Je?.value,12)},modules:{typography:(Ye?.checked??!0)!==!1,lists:(Xe?.checked??!0)!==!1,tables:(Ze?.checked??!0)!==!1,codeBlocks:(Qe?.checked??!0)!==!1,blockquotes:($e?.checked??!0)!==!1,media:(et?.checked??!0)!==!1,printBreaks:(tt?.checked??!0)!==!1},plugins:{smartTypography:!!A?.checked,softBreaksAsBr:!!nt?.checked,externalLinksNewTab:(rt?.checked??!0)!==!1},customCss:at?.value||``,printCss:ft?.value||``,extensions:n||[]}}:t.appearance||{}};Ei(l,i,p),await Ri(i);let a=i,o=p.surface===`capacitor`||p.surface===`native`?Ue(a).catch(e=>(console.warn(`[Settings] native permission flow failed:`,e),{lines:[],results:[]})):Promise.resolve({lines:[],results:[]}),s=await Oe(a);if(!s){c(`Settings save returned no data.`,{tone:`err`});return}let u=!1;try{u=String(document.documentElement?.dataset?.cwspSurface||``).toLowerCase()===`cwsp-control`||/^(www\.)?cwsp\.u2re\.space$/i.test(String(location.hostname||``))}catch{u=!1}try{if(u){let e=globalThis.__CWSP_ENSURE_CONTROL_FOR_SAVE__;if(typeof e==`function`){let t=await e();if(!t?.ok){Ne(!1,t?.error||`Control not paired`),c(t?.error||`Pair phone Control (token + code + Accept) before Save`,{tone:`warn`});return}}}await Fi(l,s,p),u&&globalThis.__CWSP_CONTROL_BRIDGE_LIVE__&&Ne(!0)}catch(e){console.warn(`[Settings] backend settings:patch failed:`,e);let t=e instanceof Error?e.message:String(e);if(u&&Ne(!1,t),/pairing|unauthorized|401|403|Control/i.test(t)){c(t,{tone:`warn`});return}}Ti(l,s,p);let d=ke(),f=await o,m=f.lines,g=f.results.some(e=>e.granted===!1);w(()=>import(`./hub-socket-boot-DJDUcpCL.js`).then(e=>(e.r(),e.n)).then(async e=>{if(u){try{globalThis.__CWSP_CONTROL_BRIDGE_LIVE__||console.warn(`[Settings] Control not paired — settings saved locally only; pair to push to device`)}catch{}return}if(typeof e.nodeClipboardHubOwnsExclusiveWebsocket==`function`&&e.nodeClipboardHubOwnsExclusiveWebsocket()){try{let e=globalThis;if(e.__CWS_NODE_CLIPBOARD_HUB__===!1)return;let t=e.__WEBNATIVE_AUTH__||e.__NEUTRALINO_AUTH__,n=Number(t?.port)||29110,r=String(t?.host||`127.0.0.1`).trim()||`127.0.0.1`;if(n===8434&&r!==`127.0.0.1`&&r!==`localhost`||n!==29110)return;let i=String(t?.key||`cwsp-neutralino-local`),a=s.core,o=String(a?.ecosystemToken||a?.userKey||a?.socket?.accessToken||``).trim(),c={};a?.endpointUrl&&(c.remoteHost=String(a.endpointUrl).trim()),o&&(c.accessToken=o,c.clientToken=o),a?.userId&&(c.clientId=String(a.userId).trim()),c.force=!0,await fetch(`http://${r}:${n}/service/clipboard-hub`,{method:`POST`,headers:{"Content-Type":`application/json`,"X-API-Key":i},body:JSON.stringify(c),cache:`no-store`})}catch(e){console.warn(`[Settings] Node clipboard-hub reload skipped`,e)}return}if(typeof e.nativeShellOwnsExclusiveHubWebsocket==`function`&&e.nativeShellOwnsExclusiveHubWebsocket()){try{let{invokeCwsNative:e}=await w(async()=>{let{invokeCwsNative:e}=await import(`./cws-bridge-BQCvS5uE.js`).then(e=>(e.a(),e.n));return{invokeCwsNative:e}},[],import.meta.url);await e(`runtime:reload-settings`,{})}catch(e){console.warn(`[Settings] Java /ws reload skipped`,e)}return}await e.applyHubSocketFromSettings(s),w(()=>import(`./hub-socket-boot-DJDUcpCL.js`).then(e=>(e.s(),e.u)).then(e=>{typeof e.reconnectTransportAfterLifecycleResume==`function`&&e.reconnectTransportAfterLifecycleResume(`settings-save`)}),[],import.meta.url).catch(()=>void 0)}),[],import.meta.url),Ie(s),e.onTheme?.(s.appearance?.theme||`auto`);let _=[`Saved locally`];d.nativeSynced===!0?_.push(`synced to Android`):d.nativeSynced===!1&&!g?console.warn(`[Settings] native settings patch:`,d.nativeError||`not confirmed`):d.nativeSynced===!1&&_.push(`native sync failed${d.nativeError?`: ${d.nativeError}`:``}`);let v=(()=>{try{return String(globalThis.__CWSP_CONTROL_VIA__||``)}catch{return``}})(),y=v===`android`?`phone Control (Capacitor)`:v===`neutralino`?`desk Control (Neutralino)`:u?`Control`:`desk Control`;d.webnativeSynced===!0?_.push(`synced to ${y}`):d.webnativeSynced===!1&&_.push(`${y} sync failed${d.webnativeError?`: ${d.webnativeError}`:``}`),m.length&&_.push(...m);let b=`ok`;(g||d.webnativeSynced===!1)&&(b=`warn`),c(_.join(` · `),{tone:b})})().catch(e=>c(String(e),{tone:`err`}))}),e.isExtension){un&&(un.hidden=!1),dn&&(dn.hidden=!1);let e=n`<div class="ext-note">Extension mode: settings are stored in <code>chrome.storage.local</code>.</div>`,t=l.querySelector(`.settings-screen__footer`);t?t?.insertAdjacentElement?.(`beforebegin`,e):l.append(e)}let Tn=vn(e.initialTab);if(R(Tn),!l.querySelector(`.settings-screen__body > [data-tab-panel="${Tn}"]:not([hidden])`)){let e=l.querySelector(`.settings-screen__body > [data-tab-panel]`);e&&R(e.getAttribute(`data-tab-panel`)||Tn)}ve();let Dn=l.querySelectorAll(`.settings-screen__body > [data-tab-panel]`).length,kn=l.querySelectorAll(`[data-action="switch-settings-tab"][data-tab]`).length;try{globalThis.__CWSP_FRONTEND_DEBUG__?.log(`settings-view`,`info`,`mounted profile=${m} surface=${p.surface} tabs=${kn} panels=${Dn} active=${l.querySelector(`[data-settings-tabs]`)?.getAttribute(`data-active-tab`)}`)}catch{}if(Dn===0){let e=document.createElement(`section`);e.className=`card settings-tab-panel`,e.setAttribute(`data-tab-panel`,`cwsp`),e.innerHTML=`<h3>CWSP</h3><p class="field-hint">Settings panels failed to mount. Check logcat tag CwspWebView or __CWSP_FRONTEND_DEBUG__.tail().</p>`,l.querySelector(`.settings-screen__body`)?.appendChild(e),R(`cwsp`)}return l.addEventListener(`cwsp-settings-resync`,()=>{Ft(l),At(l),R(l.querySelector(`[data-settings-tabs]`)?.getAttribute(`data-active-tab`)||Tn)}),$=l,l}})))()}function Wi(e){return new Ki(e)}var Gi,Ki;function qi(){return(qi=e((()=>{d(),a(),Dt(),It(),Ui(),zi(),V(),Ke(),C(),Gi={appearance:{theme:`auto`,fontSize:`medium`},ai:{autoProcess:!0},general:{autosave:!0,notifications:!0}},Ki=class{id=`settings`;name=`Settings`;icon=`gear`;options;shellContext;element=null;settings=u(Gi);_sheet=null;_shadowSheet=null;_styleEl=null;lifecycle={onUnmount:()=>{l(this.element),this.clearSettingsStylesheet()},onShow:()=>{this.applySettingsStylesheet(),this.syncHubSectionFromLocation(),this.refreshLauncherSiblingNav(),this.element?.dispatchEvent(new CustomEvent(`cwsp-settings-resync`,{bubbles:!1})),t(this.element)},onHide:()=>{l(this.element)}};constructor(e={}){this.options=e,this.shellContext=e.shellContext;try{globalThis.addEventListener(`route-change`,this.onHubSettingsRoute),globalThis.addEventListener(`popstate`,this.onHubSettingsRoute),globalThis.addEventListener(`cwsp-settings-section`,this.onHubSettingsRoute)}catch{}}onHubSettingsRoute=()=>{this.syncHubSectionFromLocation()};render(e){e&&(this.options={...this.options,...e},this.shellContext=e.shellContext||this.shellContext),this.loadSettings();let t=this.isExtensionRuntime(),n=this.resolveAreaSection(e?.params?.section);return n&&this.element&&this.element.dataset.hubSettingsSection!==n&&(Bi(),this.element=null),this.element?this.element:(this.element=Hi({isExtension:t,initialTab:e?.params?.tab||e?.params?.focus,hubSection:n,onTheme:e=>{this.options.onThemeChange?.(e)}}),queueMicrotask(()=>Ft(this.element)),this.element)}getToolbar(){return null}isExtensionRuntime(){return globalThis.chrome!==void 0&&!!globalThis.chrome?.runtime?.id}resolveAreaSection(e){let t=st();if(t)return lt(e||t);if(fi()===`launcher`)return lt(e||_t()||`hub`)}async refreshLauncherSiblingNav(){if(fi()!==`launcher`)return;let e=pi(),t=await mi();hi(e,t)||this.remountSettings(this.resolveAreaSection()||`hub`)}remountSettings(e){if(!this.element)return;let t=this.element.parentNode;Bi();let n=Hi({isExtension:this.isExtensionRuntime(),hubSection:e,initialTab:this.options.params?.tab||this.options.params?.focus,onTheme:e=>{this.options.onThemeChange?.(e)}});t?.replaceChild(n,this.element),this.element=n,queueMicrotask(()=>Ft(this.element))}syncHubSectionFromLocation(){if(!this.element)return;let e=this.resolveAreaSection();e&&this.element.dataset.hubSettingsSection!==e&&this.remountSettings(e)}setupEventHandlers(){}loadSettings(){this.settings.value={...Gi}}saveSettings(){this.options.onSettingsChange?.(this.settings.value)}resetSettings(){this.settings.value={...Gi},this.updateUI()}updateUI(){if(!this.element)return;let e=this.element.querySelectorAll(`[data-setting]`);for(let t of e){let[e,n]=t.dataset.setting.split(`.`),r=this.settings.value[e][n];t.type===`checkbox`?t.checked=!!r:t.value=r||``}}showMessage(e){this.shellContext?.showMessage(e)}applySettingsStylesheet(){Ft(this.element)}clearSettingsStylesheet(){try{if(this.element?.querySelector(`style[data-settings-view-css]`)?.remove(),this._styleEl&&=(this._styleEl.remove(),null),this._shadowSheet){let{sheet:e,root:t}=this._shadowSheet;t.adoptedStyleSheets=t.adoptedStyleSheets.filter(t=>t!==e),this._shadowSheet=null}this._sheet&&=(i(this._sheet),null)}catch{}}canHandleMessage(e){return e===`settings-update`}async handleMessage(e){let t=e;t.data&&(this.settings.value={...this.settings.value,...t.data},this.updateUI())}invokeChannelApi(e,t){if(e===Ot.Patch||e===Ot.SettingsUpdate)return this.handleMessage({data:t}),(async()=>{try{let[{loadSettings:e},{applyTheme:n}]=await Promise.all([w(()=>import(`./Settings-C-3GRbtg.js`).then(e=>(e.a(),e.t)),[],import.meta.url),w(()=>import(`./Theme-D1ZVMssO.js`).then(e=>(e.r(),e.t)),[],import.meta.url)]),r=await e(),i=t;n({...r,...i,appearance:{...r.appearance||{},...i.appearance||{}}})}catch(e){console.warn(`[SettingsView] channel applyTheme failed:`,e)}})(),!0}}})))()}qi();export{Ki as SettingsView,Ti as applyContributions,Qe as clearSettingsSyncArms,Ei as collectContributions,tt as createMemorySettingsSyncArm,Hi as createSettingsView,Wi as createView,Wi as default,Ye as detectSettingsSurface,jn as getSettingsContributions,Ge as getSettingsDefaults,$e as getSettingsSnapshot,A as getSettingsSync,Pi as hydrateContributionsFromSync,Xe as mergeSettingsPatch,Ci as mountContributions,nt as patchSettingsSync,Fi as persistContributionsViaSync,mi as refreshInstalledSiblingSettingsSections,si as registerBuiltinSettingsContributions,or as registerCwspSettingsContribution,cr as registerDeviceSettingsContribution,ur as registerReaderSettingsContribution,B as registerSettingsContribution,qe as registerSettingsSyncArm,Er as registerWorkcenterSettingsContribution,Bi as resetSettingsViewCache,yi as resolveSettingsSurface,Je as resolveSettingsSyncArm,et as setSurfaceDetector,Ze as unregisterSettingsSyncArm};