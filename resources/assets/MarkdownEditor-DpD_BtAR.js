import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{i as t}from"./src-DRDuNLFE.js";import{Dt as n,Et as r,J as i,Mt as a,Ot as o,St as s,Tt as c,ct as l,jt as u,kt as d,t as f,ut as p,xt as m}from"./src-DQ3ENLm5.js";import{B as h,Bt as g,I as _,L as ee,Lt as te,N as ne,Nt as re,g as v,j as y,jt as ie,nt as ae}from"./OPFS-D1pjQjho.js";import{c as oe,g as se,p as ce,s as le,v as b,y as ue}from"./ecosystem-skus-Bz92tN57.js";import{n as de,t as x}from"./preload-helper-DFTwEg7x.js";import{_ as fe,a as pe,g as me,h as he,n as ge,v as _e}from"./registry-DPH9Npl0.js";import{a as ve,f as ye}from"./UnifiedMessaging-Ba94p4_5.js";import{a as be,n as xe,r as Se,t as Ce}from"./view-ingress-validation-BFwuw_Yo.js";import{h as we,m as Te,o as Ee,p as De,r as Oe,s as ke}from"./open-policy-DV4wO_gQ.js";import{a as Ae,o as je}from"./Settings-C-3GRbtg.js";import{a as Me,d as Ne,l as Pe,u as Fe}from"./Base64Data-Dn-vYTrP.js";import{S as Ie,a as Le,b as Re,d as S,g as ze,h as Be,i as Ve,l as He,o as Ue,p as We,u as Ge,v as C,x as Ke,y as qe}from"./markdown-assets-BJWIJZhE.js";import{i as Je,o as Ye,s as Xe}from"./icon-BBRnO5Ir.js";import{a as Ze,b as Qe,d as $e,h as w,l as T,n as et,o as tt,r as nt,s as E,u as rt,x as it,y as D}from"./storage-bridge-DsfpL-Y4.js";import{n as at,o as ot,r as st,s as ct}from"./render-DvApWfEK.js";import{l as O,n as lt,s as ut}from"./sku-ingress-BFTKjLWQ.js";import{n as dt,t as ft}from"./registry-Cb7op9kN.js";import{a as pt,i as k,t as A}from"./channel-actions-DkmBPovk.js";import{a as mt,i as ht,r as gt,t as j}from"./highlight-BeXsjyH3.js";function _t(e){return{load(){try{let t=localStorage.getItem(e);return t?JSON.parse(t):null}catch{return null}},save(t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}},clear(){try{localStorage.removeItem(e)}catch{}}}}function vt(){return i`
        <div
    ...
    `}function yt(){return i`
        ...
        >
            <div class="view-viewer__toolbar-left" data-toolbar-mode="edit" role="group" aria-label="Edit">
                <button class="view-viewer__btn" data-action="toggle-raw" type="button" title="Switch to rendered view">
                    <ui-icon class="view-viewer__toolbar-icon" icon="eye" icon-style="duotone" size="20" aria-hidden="true"></ui-icon>
                    <span>ToView</span>
                </button>
                <button class="view-viewer__btn" data-action="select-all" type="button" title="Select all in the editor">
                    <ui-icon class="view-viewer__toolbar-icon" icon="selection-all" icon-style="duotone" size="20" aria-hidden="true"></ui-icon>
                    <span>SelectAll</span>
                </button>
                <button class="view-viewer__btn" data-action="copy" type="button" title="Copy selected text">
                    <ui-icon class="view-viewer__toolbar-icon" icon="copy" icon-style="duotone" size="20" aria-hidden="true"></ui-icon>
                    <span>Copy</span>
                </button>
                <button class="view-viewer__btn" data-action="paste" type="button" title="Paste at the selection" aria-label="Paste at the selection">
                    <ui-icon class="view-viewer__toolbar-icon" icon="clipboard-text" icon-style="duotone" size="20" aria-hidden="true"></ui-icon>
                    <span>Paste</span>
                </button>
            </div>
            <div class="view-viewer__toolbar-left" data-toolbar-mode="view" role="group" aria-label="View">
                <button class="view-viewer__btn" data-action="toggle-raw" type="button" title="Switch to source">
                ...
                <button class="view-viewer__btn" data-action="copy" type="button" title="Copy raw markdown">
                    <ui-icon class="view-viewer__toolbar-icon" icon="copy" icon-style="duotone" size="20" aria-hidden="true"></ui-icon>
                    <span>Copy</span>
                </button>
                <button class="view-viewer__btn" data-action="paste" type="button" title="Paste from clipboard" aria-label="Paste from clipboard">
                    <ui-icon class="view-viewer__toolbar-icon" icon="clipboard-text" icon-style="duotone" size="20" aria-hidden="true"></ui-icon>
                    <span>Paste</span>
                </button>
            </div>
            ...
            <div class="view-viewer__toolbar-right" data-toolbar-mode="edit" role="group" aria-label="Edit file">
                <button class="view-viewer__btn" data-action="new" type="button" title="New document — clear content and path; Save will ask where">
                    <ui-icon class="view-viewer__toolbar-icon" icon="file-plus" icon-style="duotone" size="20" aria-hidden="true"></ui-icon>
                    <span>New</span>
                </button>
            ...
            <div class="view-viewer__toolbar-right" data-toolbar-mode="view" role="group" aria-label="View export">
            ...
            <div class="view-viewer__toolbar-hidden" data-toolbar-hidden hidden>
                <button class="view-viewer__btn" data-action="attach" type="button" title="Attach to Work Center" tabindex="-1">
                    <span>Attach</span>
                </button>
                <button class="view-viewer__btn" data-action="open-style-settings" type="button" title="Markdown styling, modules, plugins" tabindex="-1">
                    <span>Style</span>
                </button>
            </div>
        </div>
    `}function bt(){let e=i`<div class="view-viewer__chrome" data-viewer-chrome></div>`;return e.append(vt(),yt()),e}function M(){return(M=e((()=>{f()})))()}var N,P,xt;function St(){return(St=e((()=>{N=`
:host {
    display: block;
...
`,xt=e=>e?P:N})))()}function Ct(){return customElements.get(`cw-raw-editor`)||customElements.define(I,L),I}function wt(e){Ct();let t=document.createElement(I);return t.hidden=!0,e?.slot&&(t.slot=e.slot),t.sourceElement,t}var F,I,L,R;function Tt(){return(Tt=e((()=>{l(),ht(),St(),F=()=>{try{if(typeof document<`u`&&document.documentElement.dataset.cwspNativeShell===`capacitor`)return!0;let e=globalThis.Capacitor;return typeof e?.isNativePlatform==`function`&&!!e.isNativePlatform()}catch{return!1}},I=`cw-raw-editor`,L=class extends HTMLElement{#e=null;#t=null;#n=null;#r=null;#i=null;#a=null;#o=!1;get value(){let e=this.#t?.textContent??``;return e.endsWith(`
`)?e.slice(0,-1):e}set value(e){let t=this.#g();t.textContent=`${e}\n`}clearDraft(){let e=this.#g();e.textContent=`
`,this.#n&&(this.#n.scrollTop=0,this.#n.scrollLeft=0);try{this.highlight(`markdown`)}catch{}}placeCaretAtStart(){this.#p(),F()&&typeof requestAnimationFrame==`function`&&requestAnimationFrame(()=>this.#p())}get sourceElement(){return this.#g(),this.#t}hasFocus(){let e=typeof document<`u`?document.activeElement:null;return e?e===this||!!this.shadowRoot?.contains(e):!1}highlight(e){let t=this.#g(),n=e||mt(``)||`markdown`;j(t,{language:n,lineNumbers:!1})}connectedCallback(){try{p()}catch{}this.#g(),this.#d(),this.#s(),F()&&this.#m()}disconnectedCallback(){this.#r?.(),this.#r=null,this.#i?.(),this.#i=null,this.#a?.(),this.#a=null}#s(){let e=this.#t;if(!e||this.#a)return;let t=e=>{let t=e;(t.inputType===`insertParagraph`||t.inputType===`insertLineBreak`)&&(t.preventDefault(),this.#o=!0,this.#u())},n=e=>{e.key!==`Enter`||e.altKey||e.metaKey||e.ctrlKey||this.#o||(e.preventDefault(),e.stopPropagation(),this.#u())},r=e=>{e.key===`Enter`&&(this.#o=!1)};e.addEventListener(`beforeinput`,t),e.addEventListener(`keydown`,n),this.addEventListener(`keydown`,n),e.addEventListener(`keyup`,r),this.addEventListener(`keyup`,r),this.#a=()=>{e.removeEventListener(`beforeinput`,t),e.removeEventListener(`keydown`,n),this.removeEventListener(`keydown`,n),e.removeEventListener(`keyup`,r),this.removeEventListener(`keyup`,r)}}#c(){let e=this.#t;if(!e)return!1;let t=this.shadowRoot?.getSelection?.()??document.getSelection();if(!t||!t.rangeCount||!t.isCollapsed)return!1;let n=t.getRangeAt(0),r=e.firstChild;return r&&r.nodeType===Node.TEXT_NODE?n.endContainer===r&&n.endOffset>=r.textContent.length:n.endContainer===e}#l(){let e=this.#t,t=e?.firstChild;if(!e||!t||t.nodeType!==Node.TEXT_NODE)return;let n=t.textContent||``,r=n.endsWith(`
`)?Math.max(0,n.length-1):n.length,i=this.shadowRoot?.getSelection?.()??document.getSelection();if(!i)return;let a=document.createRange();a.setStart(t,r),a.collapse(!0),i.removeAllRanges(),i.addRange(a)}#u(){let e=this.#t;if(!e)return;e.focus({preventScroll:!0}),this.#c()&&this.#l();let t=!1;try{t=document.execCommand(`insertText`,!1,`
`)}catch{t=!1}if(!t){let e=this.shadowRoot?.getSelection?.()??document.getSelection();if(e&&e.rangeCount){let t=e.getRangeAt(0);t.deleteContents(),t.insertNode(document.createTextNode(`
`)),t.collapse(!1),e.removeAllRanges(),e.addRange(t)}}(e.textContent||``).endsWith(`
`)||e.append(`
`),e.dispatchEvent(new Event(`input`,{bubbles:!0,composed:!0}))}#d(){let e=this.#n;if(!e||this.#i)return;let t=e=>{if(e.button!==0)return;let t=this.#t;if(!t)return;let n=e.composedPath()[0];n instanceof Node&&(n===t||t.contains(n))||(e.preventDefault(),this.#f())};e.addEventListener(`pointerdown`,t),this.#i=()=>e.removeEventListener(`pointerdown`,t)}#f(){let e=this.#t;if(e){if(!(e.textContent||``).replace(/\n/g,``).trim()){this.#p();return}e.focus({preventScroll:!0}),this.#l()}}#p(){let e=this.#t;if(!e)return;e.focus({preventScroll:!0});let t=this.shadowRoot?.getSelection?.()??document.getSelection();if(!t)return;let n=document.createRange(),r=e.firstChild;r&&r.nodeType===Node.TEXT_NODE?(n.setStart(r,0),n.collapse(!0)):(n.selectNodeContents(e),n.collapse(!0)),t.removeAllRanges(),t.addRange(n),this.#n&&(this.#n.scrollTop=0,this.#n.scrollLeft=0)}#m(){if(this.#r)return;let e=()=>this.#h();window.addEventListener(`keyboardDidShow`,e),window.addEventListener(`keyboardWillShow`,e),window.addEventListener(`keyboardDidHide`,e),window.addEventListener(`keyboardWillHide`,e),window.visualViewport?.addEventListener(`resize`,e),this.#r=()=>{window.removeEventListener(`keyboardDidShow`,e),window.removeEventListener(`keyboardWillShow`,e),window.removeEventListener(`keyboardDidHide`,e),window.removeEventListener(`keyboardWillHide`,e),window.visualViewport?.removeEventListener(`resize`,e)},e()}#h(){try{let e=getComputedStyle(document.documentElement).getPropertyValue(`--virtual-keyboard-height`),t=`${Math.max(0,Number.parseFloat(e)||0)}px`;this.style.setProperty(`--virtual-keyboard-height`,t)}catch{}}#g(){this.toggleAttribute(`data-raw-target`,!0),this.classList.add(`markdown-viewer-raw`),this.hasAttribute(`aria-label`)||this.setAttribute(`aria-label`,`Raw content`);let e=this.shadowRoot??this.attachShadow({mode:`open`});if(!this.#t||!e.contains(this.#t)){let t=F();this.toggleAttribute(`data-capacitor`,t);let n=document.createElement(`style`);n.textContent=xt(t);let r=document.createElement(`div`);r.className=`cw-raw-editor__scroll`;let i=document.createElement(`pre`);i.className=`cw-raw-editor__pre markdown-viewer-raw`;let a=document.createElement(`code`);a.className=`cw-raw-editor__source code-highlight-source`,a.setAttribute(`contenteditable`,`plaintext-only`),a.setAttribute(`spellcheck`,`false`),a.setAttribute(`autocapitalize`,`off`),a.setAttribute(`autocorrect`,`off`),i.appendChild(a),r.appendChild(i),e.replaceChildren(n,r),this.#n=r,this.#e=i,this.#t=a}return this.#t}},R=e=>e instanceof L||!!(e&&e.localName===`cw-raw-editor`)})))()}function Et(){return(Et=e((()=>{Tt()})))()}function z(){return(z=e((()=>{l(),Et(),f()})))()}var Dt,Ot,kt,B;function At(){return(At=e((()=>{f(),ve(),Dt=e=>{if(typeof e==`string`||typeof Blob<`u`&&e instanceof Blob)return e;if(e&&typeof e==`object`&&`data`in e){let t=e.data;if(typeof t==`string`||t&&typeof Blob<`u`&&t instanceof Blob)return t}return null},Ot=e=>String(e||`attachment`).toLowerCase().replace(/[^a-z0-9-]/g,`-`).replace(/-+/g,`-`).replace(/^-+|-+$/g,``)||`attachment`,kt=async(e,t=`view-ipc`)=>{let n=[];for(let r of e){let e=Dt(r);if(e)try{let i=r&&typeof r==`object`&&`source`in r?String(r.source||t):t,a=await Fe(e,{namePrefix:Ot(i),uriComponent:!0});n.push({hash:String(a.hash||``),name:String(a.name||a.file?.name||`attachment`),mimeType:String(a.type||a.file?.type||`application/octet-stream`),size:Number(a.size||a.file?.size||0),source:i,data:a.file})}catch(e){console.warn(`[UniformViewTransport] Attachment normalization failed:`,e)}}return n},B=async e=>{let n=await kt(e.attachments||[],e.source),r={...e.data||{},...n.length>0?{attachments:n,file:n[0]?.data,files:n.map(e=>e.data)}:{}},i=t({type:e.type,source:e.source,destination:e.destination,contentType:e.contentType,data:r,purpose:e.purpose||(n.length>0?[`attach`,`deliver`]:[`deliver`,`mail`]),protocol:`window`,op:e.op||(n.length>0?`attach`:`deliver`),srcChannel:e.source,dstChannel:e.destination,metadata:{...e.metadata||{},attachmentCount:n.length}});return ye(i)}})))()}function jt(e){return e===`light`||e===`dark`?e:typeof globalThis.matchMedia==`function`&&globalThis.matchMedia(`(prefers-color-scheme: light)`).matches?`light`:`dark`}function V(e){if(e===`light`||e===`dark`||e===`system`)return e;if(typeof e==`string`){let t=e.trim().toLowerCase();if(t===`light`||t===`dark`||t===`system`)return t}}function Mt(e){if(e!=null){if(typeof e==`string`)return V(e.trim());if(typeof e==`object`){let t=e;return V(t.colorScheme??t.scheme??t.theme)}}}function Nt(e){if(e)return e.colorScheme?e.colorScheme:V(e.params?.colorScheme??e.params?.theme)}var H;function Pt(){return(Pt=e((()=>{H=`/*
...
@scope (markdown-view,
  ...
  /* WHY: unlayered — @layer hide lost to the flex rule above. :host covers shadow. */
  .view-viewer__toolbar [data-toolbar-mode=edit],
  .view-viewer__toolbar-hidden,
  .view-viewer__toolbar[data-toolbar-mode=view] [data-toolbar-mode=edit],
  .view-viewer__toolbar[data-toolbar-mode=edit] [data-toolbar-mode=view],
  :host([data-raw]) .view-viewer__toolbar [data-toolbar-mode=view] {
    display: none !important;
  }
  .view-viewer__toolbar[data-toolbar-mode=edit] [data-toolbar-mode=edit],
  :host([data-raw]) .view-viewer__toolbar [data-toolbar-mode=edit] {
  ...
  @layer components {
    ...
    */
    ...
    /* WHY: second row swaps edit vs view groups; Attach/Style stay in DOM, hidden. */
    .view-viewer__toolbar [data-toolbar-mode=edit],
    .view-viewer__toolbar-hidden {
      display: none;
    }
    [data-raw] .view-viewer__toolbar [data-toolbar-mode=edit] {
      display: flex;
    }
    [data-raw] .view-viewer__toolbar [data-toolbar-mode=view] {
      display: none;
    }
...
}`})))()}var U,W,G,Ft,K,It,Lt,Rt,q,J,Y,X,zt,Bt,Z,Q,Vt,Ht;function Ut(){return(Ut=e((()=>{f(),Le(),te(),re(),d(),ot(),Xe(),me(),fe(),pe(),dt(),pt(),M(),z(),Ze(),Ae(),At(),oe(),ut(),Ee(),Ce(),Pt(),ht(),st(),de(),U=e=>e===`launch-queue`||e===`share-target`||e===`clipboard`||e===`pending`,W=null,G=`rs-viewer-outline`,Ft=96e3,K=2097152,It=48e4,Lt=6e5,Rt={USE_PROFILES:{html:!0,mathMl:!0,svg:!0},ADD_ATTR:[`data-language`,`data-lang`],FORBID_TAGS:[`script`,`style`,`iframe`,`object`,`embed`,`applet`,`link`,`meta`,`base`,`form`,`noscript`,`template`],FORBID_CONTENTS:[`script`,`style`,`iframe`,`object`,`embed`,`applet`,`noscript`,`template`]},q=`g`,J=!1,Y=()=>{if(!J)try{Ye(),Je(),J=!0}catch(e){console.warn(`[Viewer] Failed to initialize icon runtime:`,e)}},X=async e=>{try{let{writeClipboardTextToDevice:t}=await x(async()=>{let{writeClipboardTextToDevice:e}=await import(`./clipboard-device-COza7uIZ.js`).then(e=>(e.n(),e.t));return{writeClipboardTextToDevice:e}},[],import.meta.url);return await t(e),!0}catch{}try{if(typeof navigator?.clipboard?.writeText==`function`)return await navigator.clipboard.writeText(e),!0}catch{}try{let t=document.createElement(`textarea`);t.value=e,t.setAttribute(`readonly`,``),t.style.position=`fixed`,t.style.left=`-9999px`,document.body.appendChild(t),t.select();let n=document.execCommand(`copy`);return t.remove(),n}catch{return!1}},zt=async()=>W||(W=(async()=>{let{marked:e}=await x(async()=>{let{marked:e}=await import(`./marked.esm-a4dfOpe6.js`).then(e=>(e.n(),e.r));return{marked:e}},[],import.meta.url);try{at()}catch(e){console.warn(`[ViewerView] markdown configure skipped`,e)}return async t=>await e.parse(t??``)})(),W),Bt=`rs-viewer-state`,Z=`# This is content`,Q=e=>{try{let t=new URL(e);if(t.hostname.replace(/^www\./i,``).toLowerCase()!==`github.com`)return e;let n=/\.(?:md|markdown|mdown|mkd|mkdn|mdtxt|mdtext)(?:$|[?#])/i,r=t.pathname.match(/^\/([^/]+)\/([^/]+)\/blob\/(.+)$/i);if(r&&n.test(r[3]))return`https://raw.githubusercontent.com/${r[1]}/${r[2]}/${r[3]}`;let i=t.pathname.match(/^\/([^/]+)\/([^/]+)\/raw\/(.+)$/i);return i&&n.test(i[3])?`https://raw.githubusercontent.com/${i[1]}/${i[2]}/${i[3]}`:e}catch{return e}},Vt=`cw-view-viewer`,Ht=ft(Vt,e=>class extends e{id=`viewer`;name=`Viewer`;icon=`eye`;options;shellContext;element=null;slotProjectingHost=null;contentRef=g(``);lastGoodBody=Z;userClearedDocument=!1;contentRefSubscriptionDispose=null;renderSeq=0;openEpoch=0;stateManager=_t(Bt);_sheet=null;pasteController=null;documentOpenListener=null;shareIntentListener=null;visibilityOpenListener=null;capacitorOpenPull=Promise.resolve();pendingBinaryPreview=null;binaryPreviewActive=!1;windowDnDController=null;isViewVisible=!1;isPointerInView=!1;sourceUrl=null;pathHistory=[];pathHistoryIndex=-1;suppressPathHistory=!1;boundMountRoot=null;boundDirectory=null;rawMode=!1;rawEditorDirty=!1;paintingRaw=!1;rememberedSaveHandle=null;rememberedNativeWriteUri=null;sidecarAssets=new Map;assetObjectUrls=[];sourceObserver=null;boundFsChangeTimer=0;customSheet=null;userStyleModules={screenCss:``,printCss:``};markdownSettings={preset:`default`,fontFamily:`system`,fontSizePx:16,lineHeight:1.7,contentMaxWidthPx:860,printScale:1,page:{size:`auto`,orientation:`portrait`,marginMm:12},modules:{typography:!0,lists:!0,tables:!0,codeBlocks:!0,blockquotes:!0,media:!0,printBreaks:!0},plugins:{smartTypography:!1,softBreaksAsBr:!1,externalLinksNewTab:!0},customCss:``,printCss:``,extensions:[]};markdownSettingsPromise=null;outlineVisible=!1;viewerColorScheme=`system`;documentThemeSnapshot=null;disposeContentRefSubscription(){try{this.contentRefSubscriptionDispose?.()}catch{}this.contentRefSubscriptionDispose=null}subscribeContentRefToCurrentTargets(e,t){this.disposeContentRefSubscription();let n=ie(this.contentRef,()=>{e&&this.renderMarkdown(this.paintBody(),e,t)});this.contentRefSubscriptionDispose=typeof n==`function`?()=>{n()}:null}lifecycle={onMount:()=>this.onMount(),onUnmount:()=>this.onUnmount(),onShow:()=>this.onShow(),onHide:()=>this.onHide(),onRefresh:()=>this.onRefresh()};constructor(e={}){super(),this.options=e,this.shellContext=e.shellContext,this.sourceUrl=this.normalizeSourceUrl(e.source),this.markdownSettingsPromise=this.loadMarkdownSettings();try{this.outlineVisible=globalThis.sessionStorage?.getItem(G)===`1`}catch{this.outlineVisible=!1}this.syncViewerColorSchemeFromOptions();let t=this.stateManager.load(),n=String(t?.content||``).trim(),r=String(e.initialContent||n||Z);if(this.lastGoodBody=r.trim()?r:Z,this.contentRef.value=this.lastGoodBody,!e.filename&&t?.filename&&(this.options.filename=t.filename),!e.source&&t?.source&&!U(t.source)&&(this.sourceUrl=this.normalizeSourceUrl(t.source),this.options.source=t.source),this.applyRouteParams(e.params),!e.initialContent){let t=(e.params?.content)?.trim?.();t&&(this.rememberPaintBody(t),this.contentRef.value=t)}}render=function(e){Y(),this.slotProjectingHost=null,e&&(this.options={...this.options,...e},this.shellContext=e.shellContext||this.shellContext,this.applyRouteParams(e.params)),this.syncViewerColorSchemeFromOptions(),this._sheet=a(H),this.element=this.createViewerShellElement();let t=this.element.querySelector(`[data-render-target]`),n=this.element.querySelector(`[data-raw-target]`);return this.setupEventHandlers(n||void 0),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),this.syncToolbarModeGroups(this.rawMode),this.flushPendingBinaryPreview(),!this.binaryPreviewActive&&t&&this.renderMarkdown(this.paintBody(),t,n),this.subscribeContentRefToCurrentTargets(t,n),this.refreshDocumentTheme(),this.syncOpenedPath(this.sourceUrl),this.pullCapacitorPendingOpen().then(()=>this.reloadNativeSourceIfEmpty()),this.element};shellNavigateHydrate(e,t){if(!this.element?.isConnected)return;e&&(this.options={...this.options,...e},this.shellContext=e.shellContext||this.shellContext,e.params!==void 0&&this.applyRouteParams(e.params),this.syncViewerColorSchemeFromOptions());let n=this.queryViewerSlotted(`[data-render-target]`),r=this.queryViewerSlotted(`[data-raw-target]`);n&&(this.subscribeContentRefToCurrentTargets(n,r),this.renderMarkdown(this.paintBody(),n,r)),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),this.syncToolbarModeGroups(this.rawMode),this.refreshDocumentTheme(),this.syncOpenedPath(this.sourceUrl)}renderIntoWebComponentHost(e,t){Y(),t&&(this.options={...this.options,...t},this.shellContext=t.shellContext||this.shellContext,this.applyRouteParams(t.params)),this.syncViewerColorSchemeFromOptions(),this.slotProjectingHost=e,this._sheet??=a(H),this.element=this.createViewerShellElement(),e.replaceChildren(this.element);let n=e.querySelector(`[data-raw-target]`),r=e.querySelector(`[data-render-target]`);e.setAttribute(`data-view-id`,`viewer`),e.toggleAttribute(`data-cw-view-host`,!0),this.syncAdoptedSheetsToShadow();let i=r,o=n;this.setupEventHandlers(o||void 0),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),this.syncToolbarModeGroups(this.rawMode),this.flushPendingBinaryPreview(),!this.binaryPreviewActive&&i&&this.renderMarkdown(this.paintBody(),i,o),this.subscribeContentRefToCurrentTargets(i,o),this.refreshDocumentTheme(),this.syncOpenedPath(this.sourceUrl),this.pullCapacitorPendingOpen().then(()=>this.reloadNativeSourceIfEmpty())}getToolbar(){return null}setContent(e,t,n){if(t&&(this.options.filename=t),n!==void 0){let e=this.normalizeSourceUrl(n);e!==this.sourceUrl&&(this.rememberedSaveHandle=null,this.rememberedNativeWriteUri=null),this.sourceUrl=e,this.options.source=n||void 0}this.rawEditorDirty=!1,this.rememberPaintBody(e),this.contentRef.value=e,this.syncToolbarDocumentTitle(),this.syncOpenedPath(this.sourceUrl),this.repaintMarkdown()}rememberPaintBody(e){let t=String(e??``);t.trim()&&(this.lastGoodBody=t,this.userClearedDocument=!1)}paintBody(){if(this.userClearedDocument)return String(this.contentRef.value||``);let e=String(this.contentRef.value||``);return e.trim()?e:this.lastGoodBody||Z}repaintMarkdown(){let e=this.queryViewerSlotted(`[data-render-target]`);if(!e)return;let t=this.queryViewerSlotted(`[data-raw-target]`);this.renderMarkdown(this.paintBody(),e,t)}ingestOpenedMarkdownBody(e,t,n){if(this.binaryPreviewActive=!1,this.pendingBinaryPreview=null,!String(e||``).trim())return;if(e.length>0&&Se(e)){this.setContent(`> This payload does not look like UTF-8 markdown (binary file or unsupported format).
>
> Open a \`.md\` / \`.txt\` file, paste as plain text, or attach binaries via Work Center.

`,t,n);return}this.setContent(e,t,n??void 0);let r=this.rawEditorEl();R(r)&&(r.value=e),this.saveState()}applyCapacitorLoadedDocument(e,t){let n=e.virtualPath||e.uri||null;this.ingestOpenedMarkdownBody(e.content,t||e.name,n),this.rememberOpenedWriteBack(e.uri||null,e.virtualPath||null),n&&this.syncOpenedPath(n)}getContent(){return this.flushRawEditor()}setViewerColorScheme(e){this.viewerColorScheme=e,this.options.colorScheme=e,this.refreshDocumentTheme()}refreshDocumentTheme(){typeof document>`u`||(this.applyViewerDocumentTheme(this.viewerColorScheme),this.bakeViewerScreenColors())}bakeViewerScreenColors(){let e=this.element;e instanceof HTMLElement&&r(e);let t=this.queryViewerSlotted(`[data-render-target]`);t instanceof HTMLElement&&t!==e&&r(t)}unbakeViewerScreenColors(){let e=this.element;e instanceof HTMLElement&&m(e);let t=this.queryViewerSlotted(`[data-render-target]`);t instanceof HTMLElement&&t!==e&&m(t)}applyViewerDocumentTheme(e){let t=document.documentElement;if(e===`system`)return;this.documentThemeSnapshot||={prevAttr:t.getAttribute(`data-theme`),prevInlineCs:t.style.getPropertyValue(`color-scheme`)};let n=jt(e);t.setAttribute(`data-theme`,n),t.style.setProperty(`color-scheme`,n)}restoreViewerDocumentTheme(){let e=this.documentThemeSnapshot;if(this.documentThemeSnapshot=null,!e||typeof document>`u`)return;let t=document.documentElement;e.prevAttr===null||e.prevAttr===``?t.removeAttribute(`data-theme`):t.setAttribute(`data-theme`,e.prevAttr),e.prevInlineCs.trim()?t.style.setProperty(`color-scheme`,e.prevInlineCs):t.style.removeProperty(`color-scheme`)}syncViewerColorSchemeFromOptions(){let e=Nt(this.options);e&&(this.viewerColorScheme=e)}createViewerShellElement(){let e=bt(),t=i`
