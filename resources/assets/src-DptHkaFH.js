import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{$ as t,A as n,F as r,G as i,J as a,N as o,Nt as s,Ot as c,P as l,Pt as u,Q as d,R as f,St as p,V as m,W as h,X as g,Z as _,_t as v,ct as y,gt as b,h as x,it as S,jt as C,kt as w,q as T,rt as E,t as D,tt as O,z as k}from"./src-TXtvocpz.js";import{Bt as A,Ct as j,Et as ee,Lt as te,Mt as ne,Nt as M,Rt as N,W as re,wt as ie,zt as ae}from"./OPFS-WcvpNv6j.js";import{n as oe,t as se}from"./preload-helper-DFTwEg7x.js";import{o as P,r as ce}from"./image-DYH74VgF.js";import{o as le,s as ue}from"./icon-C6atVd0v.js";import{i as F,l as I,o as de,p as fe,r as pe,t as me,u as he}from"./storage-bridge-BX3aqg3G.js";import{A as ge,C as _e,D as ve,E as ye,F as be,I as xe,L as Se,M as Ce,N as we,O as Te,P as Ee,S as De,T as Oe,_ as ke,a as Ae,b as je,c as Me,d as Ne,f as Pe,g as Fe,h as Ie,i as Le,j as Re,k as ze,l as Be,m as Ve,n as He,o as Ue,r as We,s as Ge,t as Ke,u as qe,v as Je,w as Ye,x as Xe,y as Ze}from"./launcher-state-CA32iob4.js";import{r as Qe}from"./render-DLWeqYav.js";function L(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}function $e(){return($e=e((()=>{})))()}var R,et;function z(){return(z=e((()=>{D(),c(),ue(),R=class extends h(){theme=`default`;render(e){return a`<slot></slot>`}constructor(){super()}onRender(){return super.onRender()}connectedCallback(){let e=super.connectedCallback?.()??this;return e.loadStyleLibrary(le()),p(e),e}onInitialize(){let e=super.onInitialize()??this;return e.loadStyleLibrary(le()),e}},L([T({source:`attr`})],R.prototype,`theme`,void 0),R=L([i(`ui-element`)],R),et=R})))()}var tt,nt,rt,it,at,ot,st,ct,lt,ut,B,dt,ft,pt;function mt(){return(mt=e((()=>{D(),tt=`2147483600`,nt=new Map,rt=new Map,it=null,at=[`[data-chrome-flyout-anchor]`,`.env-shell-taskbar__clock`,`.env-ui-statusbar__clock`,`.env-device-tray`,`.speed-dial-chrome-rail`,`.speed-dial-core-rail`],ot=e=>e&&(e.dataset.chromeFlyoutSide===`start`||e.closest?.(`.speed-dial-chrome-rail, [data-chrome-flyout-side='start']`))?`start`:`end`,st=()=>{if(typeof document<`u`){if(document.querySelector(`.env-shell-chrome[data-desktop]`))return!0;let e=document.querySelector(`[data-chrome-layout]`);if(e?.dataset.chromeLayout===`desktop`)return!0;if(e?.dataset.chromeLayout===`mobile`)return!1}return typeof matchMedia<`u`&&matchMedia(`(min-width: 641px)`).matches},ct=e=>{it=e},lt=e=>{let t=`data-env-shell-overlays`,n=e||it||document.querySelector(`.env-shell-root`)||document.querySelector(`#app`)||document.body,r=n.querySelector(`[${t}]`);if(r)return r.style.zIndex||(r.style.zIndex=tt),r;try{let e=globalThis.__ENV_OVERLAY_MOUNT__;if(typeof e==`function`)return e(n)}catch{}let i=document.createElement(`div`);return i.setAttribute(t,``),i.className=`env-shell-overlays`,i.setAttribute(`data-part`,`env-overlays`),i.style.cssText=`position:fixed;inset:0;pointer-events:none;z-index:${tt};box-sizing:border-box;`,n.appendChild(i),i},ut=(e,t,n)=>{let r=st(),i=n?.align??ot(n?.anchor);if(e.dataset.flyoutAlign=i,e.style.position=`fixed`,e.style.zIndex=String(Number(tt)+1),e.style.pointerEvents=`auto`,e.style.margin=`0`,r){e.style.top=`auto`,e.style.bottom=`4.5rem`,e.style.transform=`none`,i===`start`?(e.style.left=`0.75rem`,e.style.right=`auto`):(e.style.left=`auto`,e.style.right=`0.75rem`);return}if(t===`calendar`){e.style.top=`50%`,e.style.left=`50%`,e.style.right=`auto`,e.style.bottom=`auto`,e.style.transform=`translate(-50%, -50%)`;return}e.style.top=`calc(env(safe-area-inset-top, 0px) + 0.75rem)`,e.style.left=`50%`,e.style.right=`auto`,e.style.bottom=`auto`,e.style.transform=`translateX(-50%)`},B=e=>{let t=nt.get(e);if(!t)return;nt.delete(e);let n=rt.get(e);rt.delete(e),n?.disposeDismiss(),n?.unregisterBack();try{let e=t.el;typeof e.close==`function`?e.close():(e.removeAttribute(`open`),e.hidden=!0),e.dispatchEvent(new CustomEvent(`chrome-flyout-close`,{bubbles:!0}))}catch{}},dt=e=>{nt.has(e.kind)&&B(e.kind);for(let t of[...nt.keys()])t!==e.kind&&B(t);nt.set(e.kind,{...e,close:()=>B(e.kind)}),e.el.hidden=!1,e.el.removeAttribute(`hidden`),e.el.setAttribute(`open`,``),rt.set(e.kind,{disposeDismiss:r({root:document,inside:e.el,isInside:t=>e.contains(t.target),exceptSelectors:at,onDismiss:()=>B(e.kind)}),unregisterBack:o({id:`chrome-flyout-${e.kind}`,kind:`overlay`,element:e.el,isActive:()=>nt.get(e.kind)?.el===e.el&&e.el.isConnected&&!e.el.hidden&&e.el.hasAttribute(`open`),close:()=>(B(e.kind),!0)})})},ft=e=>nt.has(e),pt=(e,t)=>{if(ft(e)){B(e);return}let n=t();dt(n)}})))()}var ht;function gt(){return(gt=e((()=>{ht=`/*
...
@layer components {
  ...
  .ui-cal-flyout__day[data-today][data-selected] {
    box-shadow: 0 0 0 2px color-mix(in oklab, var(--cal-base-color) 70%, #fff 20%) inset;
...
}`})))()}function _t(e){try{let t=new Intl.Locale(e),n=(t.weekInfo??t.getWeekInfo?.())?.firstDay;if(typeof n==`number`&&n>=1&&n<=7)return n%7}catch{}return 0}function vt(e,t){let n=new Intl.DateTimeFormat(e,{weekday:`short`,timeZone:`UTC`}),r=[];for(let e=0;e<7;e++){let i=(t+e)%7;r.push(n.format(new Date(Tt+i*Et)))}return r}function yt(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}function bt(e,t,n){let r=new Date,i=new Date(e,t,1),a=new Date(e,t+1,0).getDate(),o=(i.getDay()-n+7)%7,s=Math.ceil((o+a)/7)*7,c=[];for(let n=0;n<s;n++){let i=n-o+1,a=new Date(e,t,i);c.push({date:a,day:a.getDate(),otherMonth:a.getMonth()!==t,isToday:yt(a,r)})}return c}function xt(){if(Ot?.isConnected)return Ot;let e=lt(),t=e.querySelector(`ui-calendar-flyout`);return t||(t=document.createElement(`ui-calendar-flyout`),t.hidden=!0,e.appendChild(t)),Ot=t,t}function St(e){pt(wt,()=>{let t=xt(),n=document.documentElement.getAttribute(`data-theme`);return(n===`light`||n===`dark`)&&(t.dataset.theme=n,t.style.colorScheme=n),ut(t,wt,{anchor:e}),t.open(),{kind:wt,el:t,close:()=>{t.close(),B(wt)},contains:e=>e instanceof Node&&t.contains(e)}})}var Ct,wt,Tt,Et,Dt,Ot;function kt(){return(kt=e((()=>{D(),y(),c(),z(),ue(),mt(),gt(),Ct=s(ht),wt=`calendar`,Tt=Date.UTC(2023,0,1),Et=864e5,Dt=class extends R{#e;#t;#n=null;#r=null;styles=function(){return Ct};render=function(){return a`<div class="ui-cal-flyout__panel" part="panel">
        ...
        </div>`};constructor(){super();let e=new Date;this.#e=e.getFullYear(),this.#t=e.getMonth()}onRender(){super.onRender(),this.#i(),this.#c()}disconnectedCallback(){this.#r?.(),this.#r=null,super.disconnectedCallback?.()}#i(){let e=this.shadowRoot;if(!e||this.#r)return;let t=v(e,`click`,e=>{let t=e.target,n=t?.closest?.(`[data-nav]`);if(n){n.dataset.nav===`prev`?this.#a(-1):n.dataset.nav===`next`&&this.#a(1);return}let r=t?.closest?.(`.ui-cal-flyout__day`);r&&this.#s(r)});this.#r=()=>t?.()}#a(e){this.#t+=e,this.#t<0?(this.#t=11,--this.#e):this.#t>11&&(this.#t=0,this.#e+=1),this.#c()}#o(){let e=new Date;this.#e=e.getFullYear(),this.#t=e.getMonth(),this.#c()}#s(e){let t=e.dataset.date;t&&(this.#n=new Date(t),this.shadowRoot?.querySelectorAll(`.ui-cal-flyout__day[data-selected]`)?.forEach(e=>e.removeAttribute(`data-selected`)),e.setAttribute(`data-selected`,``),this.dispatchEvent(new CustomEvent(`calendar-select`,{bubbles:!0,composed:!0,detail:{date:this.#n}})))}#c(){let e=this.shadowRoot;if(!e)return;let t=typeof navigator<`u`?navigator.language:void 0,n=_t(t??`en-US`),r=new Date,i=e.querySelector(`.ui-cal-flyout__today`);i&&(i.textContent=r.toLocaleDateString(t,{weekday:`long`,month:`long`,day:`numeric`,year:`numeric`}));let a=e.querySelector(`.ui-cal-flyout__month-label`);a&&(a.textContent=new Date(this.#e,this.#t,1).toLocaleDateString(t,{month:`long`,year:`numeric`}));let o=e.querySelector(`.ui-cal-flyout__weekdays`);o&&o.replaceChildren(...vt(t??`en-US`,n).map(e=>{let t=document.createElement(`span`);return t.className=`ui-cal-flyout__weekday`,t.setAttribute(`role`,`columnheader`),t.textContent=e,t}));let s=e.querySelector(`.ui-cal-flyout__grid`);if(s){let e=bt(this.#e,this.#t,n);s.replaceChildren(...e.map(e=>{let n=document.createElement(`button`);return n.type=`button`,n.className=`ui-cal-flyout__day`,n.textContent=String(e.day),n.dataset.date=e.date.toISOString(),n.setAttribute(`role`,`gridcell`),e.otherMonth&&n.setAttribute(`data-other-month`,``),e.isToday&&n.setAttribute(`data-today`,``),this.#n&&yt(e.date,this.#n)&&n.setAttribute(`data-selected`,``),n.setAttribute(`aria-label`,e.date.toLocaleDateString(t,{weekday:`long`,month:`long`,day:`numeric`,year:`numeric`})),n}))}}open(){this.#o(),this.removeAttribute(`hidden`),this.hidden=!1,this.setAttribute(`open`,``)}close(){this.hidden=!0,this.setAttribute(`hidden`,``),this.removeAttribute(`open`)}toggle(e){this.hasAttribute(`open`)?this.close():this.open()}},Dt=L([i(`ui-calendar-flyout`)],Dt),Ot=null})))()}function At(){let e=Pt.get();return typeof e==`function`?e:null}var jt,Mt,Nt,Pt;function Ft(){return(Ft=e((()=>{jt=`__CWSP_SPEED_DIAL_VIEW_OPENER_V1__`,Mt=`__CWSP_HOME_OVERLAY_MOUNT_V1__`,Nt=e=>{let t=globalThis;return{get:()=>e in t?t[e]:null,set:n=>{t[e]=n}}},Pt=Nt(jt),Nt(Mt)})))()}var It;function Lt(){return(Lt=e((()=>{It=`/*
...
}`})))()}function Rt(){if(_n?.isConnected)return _n;let e=lt(),t=e.querySelector(`ui-quick-settings`);return t||(t=document.createElement(`ui-quick-settings`),t.hidden=!0,e.appendChild(t)),_n=t,t}function zt(e){pt(Ht,()=>{let t=Rt(),n=document.documentElement.getAttribute(`data-theme`);return(n===`light`||n===`dark`)&&(t.dataset.theme=n,t.style.colorScheme=n),ut(t,Ht,{anchor:e}),t.open(),{kind:Ht,el:t,close:()=>{t.close(),B(Ht)},contains:e=>e instanceof Node&&t.contains(e)}})}function Bt(){B(Ht)}var Vt,Ht,Ut,Wt,Gt,Kt,qt,Jt,Yt,Xt,Zt,Qt,$t,en,tn,nn,rn,an,on,sn,cn,ln,un,dn,fn,pn,mn,hn,gn,_n;function vn(){return(vn=e((()=>{D(),y(),c(),z(),ue(),Ft(),mt(),Lt(),Vt=s(It),Ht=`quick-settings`,Ut=`data-theme`,Wt=`rs-appearance-theme`,Gt=`appearance.theme`,Kt=[`rs-settings`,`cwsp-settings`,`u2-settings`],qt=()=>{try{return matchMedia?.(`(prefers-color-scheme: dark)`)?.matches??!0}catch{return!0}},Jt=e=>{for(let t of Kt)try{let n=localStorage.getItem(t);if(!n)continue;let r=JSON.parse(n);if(!r||typeof r!=`object`)continue;r.appearance={...r.appearance??{},theme:e},localStorage.setItem(t,JSON.stringify(r))}catch{}},Yt=()=>{try{let e=document.documentElement.getAttribute(Ut);if(e===`light`||e===`dark`)return e;let t=localStorage.getItem(Wt);if(t===`light`||t===`dark`)return t}catch{}return qt()?`dark`:`light`},Xt=e=>{let t=document.documentElement,n=e===`auto`?qt()?`dark`:`light`:e,r=e===`auto`?`auto`:e;t.setAttribute(`data-scheme`,r),t.setAttribute(Ut,n),t.style.colorScheme=n;try{document.body&&(document.body.style.colorScheme=n)}catch{}try{document.querySelectorAll(`.env-shell-root, [data-shell], ui-window`).forEach(e=>{let t=e;t.dataset.theme=n,t.style.colorScheme=n;let r=t.shadowRoot?.querySelector?.(`.app-shell`);r&&(r.dataset.theme=n,r.style.colorScheme=n)})}catch{}try{localStorage.setItem(Wt,e===`auto`?`auto`:e),localStorage.setItem(Gt,e===`auto`?`auto`:e)}catch{}e!==`auto`&&Jt(e),t.dispatchEvent(new CustomEvent(`u2-theme-change`,{bubbles:!0,detail:{source:`quick-settings`,theme:n,preference:e}}))},Zt=()=>{try{let e=String(localStorage.getItem(Wt)||``).trim().toLowerCase();if(e===`light`||e===`dark`||e===`auto`)return e;let t=String(localStorage.getItem(Gt)||``).trim().toLowerCase();if(t===`light`||t===`dark`||t===`auto`)return t}catch{}return`auto`},Qt=()=>{let e=globalThis;if(e.__CWSP_AUTO_THEME_FOLLOW__)return;e.__CWSP_AUTO_THEME_FOLLOW__=!0;let t=typeof matchMedia==`function`?matchMedia(`(prefers-color-scheme: dark)`):null;if(!t)return;let n=()=>{Zt()===`auto`&&Xt(`auto`)};try{t.addEventListener(`change`,n)}catch{try{t.addListener(n)}catch{}}try{n()}catch{}},$t=e=>{document.documentElement.style.setProperty(`--orientation-lock`,e?`unlocked`:`locked`),document.documentElement.style.setProperty(`--orientation-lock-angle`,e?`0deg`:`90deg`),Promise.try(async()=>{try{let t=screen.orientation;if(e){t.unlock?.();return}if(typeof t.lock!=`function`)return;let n=t.lock(t.type||`natural`);n&&typeof n.catch==`function`&&await n.catch(()=>{})}catch(e){console.warn(e)}})?.catch?.(console.warn.bind(console))},en=`env-night-filter`,tn=`2147483001`,nn=`rs-night-filter`,rn=`rs-brightness-filter`,an=e=>Math.max(0,Math.min(100,Number.isFinite(e)?e:0)),on=()=>{let e=document.getElementById(en);if(e instanceof HTMLElement)return e;let t=document.createElement(`div`);return t.id=en,t.setAttribute(`aria-hidden`,`true`),t.style.cssText=[`dynamic-range-limit:no-limit`,`color-space:display-p3`,`position:fixed`,`inset:0`,`pointer-events:none`,`z-index:${tn}`,`background-color:color(display-p3 1 0.55 0.24)`,`mix-blend-mode:multiply`,`opacity:0`,`visibility:hidden`,`transition:opacity 160ms ease`].join(`;`),(document.body??document.documentElement).appendChild(t),t},sn=e=>{let t=an(e),n=on(),r=t/100;n.style.opacity=String(r),n.style.visibility=r>=.01?`visible`:`hidden`;try{localStorage.setItem(nn,String(t))}catch{}},cn=e=>{let t=an(e);on(),t<=50?.4+t/50*.6:1+(t-50)/50*.2;try{localStorage.setItem(rn,String(t))}catch{}},ln=(e,t)=>{try{let n=localStorage.getItem(e);if(n==null)return t;let r=Number(n);return Number.isFinite(r)?an(r):t}catch{return t}},un=()=>{let e=ln(nn,0),t=ln(rn,50);return sn(e),cn(t),{night:e,brightness:t}},typeof document<`u`&&(document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,()=>un(),{once:!0}):un()),dn=[`wifi`,`bluetooth`,`focus`,`airplane`,`orientation`],fn={light:`sun`,dark:`moon`},pn={light:`Light`,dark:`Dark`},mn=e=>{let t=e.querySelector(`[data-qs-tile="theme"]`);if(!t)return;let n=Yt();t.querySelector(`ui-icon`)?.setAttribute(`icon`,fn[n]);let r=t.querySelector(`[data-qs-tile-sub]`);r&&(r.textContent=pn[n]),t.setAttribute(`aria-pressed`,n===`dark`?`true`:`false`)},hn=e=>{let t=e.shadowRoot,n=t?.querySelector(`.qs-panel`);if(!t||!n||n.hasAttribute(`data-qs-wired`))return;n.setAttribute(`data-qs-wired`,``),mn(t),t.querySelector(`[data-qs-tile="theme"]`)?.addEventListener(`click`,()=>{let e=Yt()===`dark`?`light`:`dark`;Xt(e),mn(t)});let r=e=>!!e?.getAttribute?.(`aria-pressed`)&&e?.getAttribute?.(`aria-pressed`)===`true`;t.querySelector?.(`[data-qs-tile="orientation"]`)?.addEventListener?.(`click`,e=>{let t=b((e?.target?.matches?.(`[data-qs-tile="orientation"]`)?e?.target:e?.target?.querySelector?.(`[data-qs-tile="orientation"]`))||e?.target,`[data-qs-tile="orientation"]`),n=r(t);$t(n);let i=t?.matches?.(`ui-icon`)?t:t?.querySelector?.(`ui-icon`);i&&i.setAttribute?.(`icon`,n?`device-rotate`:`lock`),i&&i.setAttribute?.(`icon-style`,`duotone`)});for(let e of dn){let n=t.querySelector(`[data-qs-tile="${e}"]`);n&&n.addEventListener(`click`,()=>{let e=n.getAttribute(`aria-pressed`)!==`true`;n.setAttribute(`aria-pressed`,String(e));let t=n.querySelector(`[data-qs-tile-sub]`);t&&(t.textContent=e?`On`:`Off`)})}let{night:i,brightness:a}=un(),o=t.querySelector(`[data-qs-slider="night"]`),s=t.querySelector(`[data-qs-slider="brightness"]`);o&&(o.value=String(i),o.addEventListener(`input`,()=>sn(o.valueAsNumber))),s&&(s.value=String(a),s.addEventListener(`input`,()=>cn(s.valueAsNumber)));let c=e=>{Bt();let t=()=>{let t=At();if(typeof t==`function`){t(e,{});return}let n=`#${e}`;typeof location<`u`&&location.hash!==n&&E(n)};typeof requestAnimationFrame==`function`?requestAnimationFrame(t):queueMicrotask(t)};t.querySelectorAll(`[data-qs-open]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=String(e.getAttribute(`data-qs-open`)||``).trim();(t===`settings`||t===`explorer`)&&c(t)})})},gn=class extends R{constructor(){super()}styles=()=>Vt;render=()=>a`
...
</div>`;onRender(){return super.onRender(),hn(this),this}open(){mn(this.shadowRoot),this.removeAttribute(`hidden`),this.hidden=!1,this.setAttribute(`open`,``)}close(){this.hidden=!0,this.setAttribute(`hidden`,``),this.removeAttribute(`open`)}toggle(e){this.hasAttribute(`open`)?this.close():this.open()}},gn=L([i(`ui-quick-settings`)],gn),_n=null,Promise.try(()=>{typeof requestAnimationFrame==`function`&&requestAnimationFrame(()=>{Promise.try(async()=>{let e=screen?.orientation?.lock;if(typeof e!=`function`)return;let t=e.call(screen.orientation,`natural`);t&&typeof t.catch==`function`&&await t.catch(()=>{})}).catch(()=>{})})}).catch(()=>{});try{Qt()}catch{}})))()}var yn;function bn(){return(bn=e((()=>{yn=`/*
...
@layer components {
  ...
  env-shell-container[data-env-native-task] .env-shell-chrome[data-desktop] {
    ...
    </div>`,r=n.querySelector(`.env-status-bar__pct`);return r instanceof HTMLElement&&S(r,{properties:{textContent:e.batteryPct}}),n}function Mn(e,t,n){let r=document.createElement(`ui-statusbar`);r.className=`env-ui-statusbar wf-chrome-no-select`,r.setAttribute(`part`,`status-bar`);let i=document.createElement(`div`);i.slot=`left`,i.className=`env-ui-statusbar__left`;let a=document.createElement(`time`);a.className=`env-ui-statusbar__clock`,a.dateTime=``,a.textContent=En(),a.setAttribute(`role`,`button`),a.setAttribute(`tabindex`,`0`),a.setAttribute(`aria-label`,`Calendar`),a.setAttribute(`aria-haspopup`,`dialog`),a.setAttribute(`data-chrome-flyout-anchor`,`calendar`);let o=document.createElement(`div`);o.className=`env-ui-statusbar__intro`,t&&(o.innerHTML=t),i.append(a,o);let s=document.createElement(`div`);s.slot=`center`;let c=document.createElement(`p`);c.className=`env-status-bar__meta`,s.appendChild(c);let l=document.createElement(`div`);l.slot=`right`,l.className=`env-ui-statusbar__right`;let u=jn(n,`env-device-tray env-device-tray--footer`);u.setAttribute(`role`,`button`),u.setAttribute(`tabindex`,`0`),u.setAttribute(`aria-label`,`Quick settings`),u.setAttribute(`aria-haspopup`,`dialog`),u.setAttribute(`data-chrome-flyout-anchor`,`quick-settings`),l.appendChild(u);let d=e=>{e.preventDefault(),e.stopPropagation(),St(a)},f=e=>{e.preventDefault(),e.stopPropagation(),zt(u)};a.addEventListener(`click`,d),a.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&d(e)}),u.addEventListener(`click`,f),u.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&f(e)}),r.append(i,s,l),ne(()=>{let t=e.navEcho.value?` │ ${e.navEcho.value}`:``;c.textContent=`doc=${e.selectedPath.value} │ viewer=${e.viewerStatus.value} │ layout=${e.mqLabel.value}${t}`},[e.selectedPath,e.viewerStatus,e.mqLabel,e.navEcho],{triggerImmediately:!0});let p=()=>{let e=new Date;a.textContent=En(e),a.dateTime=e.toISOString()};p();let m=setInterval(p,15e3);return{element:r,dispose:()=>{clearInterval(m)}}}var Nn,Pn;function Fn(){return(Fn=e((()=>{D(),M(),te(),P(),kt(),vn(),z(),bn(),c(),Nn=s(yn),Pn=class extends et{constructor(){super()}styles=()=>Nn;render=()=>a`
<div style="background-color: transparent;" part="left"   class="left"  ><slot name="left"  ></slot></div>
        ...
        <div style="background-color: transparent;" part="right"  class="right" ><slot name="right" ></slot></div>`},Pn=L([i(`ui-statusbar`)],Pn)})))()}function In(){return(In=e((()=>{D(),Re(),F()})))()}function V(e){globalThis.dispatchEvent?.(new CustomEvent(`view:toast`,{detail:{type:`success`,message:n(e)}}))}function H(e){globalThis.dispatchEvent?.(new CustomEvent(`view:toast`,{detail:{type:`error`,message:n(e)}}))}function Ln(){return(Ln=e((()=>{D()})))()}function Rn(){if(U)return U;try{let e=localStorage.getItem(Kn);if(!e)return U={},U;let t=JSON.parse(e);U=t&&typeof t==`object`?t:{}}catch{U={}}return U}function zn(e){U=e;try{localStorage.setItem(Kn,JSON.stringify(e))}catch{}}function Bn(e){let t=e&&typeof e==`object`?e:{},n=t.extras&&typeof t.extras==`object`?t.extras:{},r={};for(let[e,t]of Object.entries(n)){let n=String(e||``).trim();n&&(typeof t==`boolean`||typeof t==`number`||typeof t==`string`)&&(r[n]=t)}let i=Array.isArray(t.flags)?t.flags.map(e=>String(e||``).trim().toUpperCase()).filter(Boolean):[],a=Array.isArray(t.categories)?t.categories.map(e=>String(e||``).trim()).filter(Boolean):[];return{action:String(t.action||``).trim(),data:Jn(String(t.data||``)),mimeType:String(t.mimeType||``).trim(),extras:r,flags:i,categories:a,componentName:String(t.componentName||``).trim()}}function Vn(e){return!e||!e.action&&!e.data&&!e.mimeType&&!e.componentName&&(!e.flags||e.flags.length===0)&&(!e.categories||e.categories.length===0)&&(!e.extras||Object.keys(e.extras).length===0)}function Hn(e){let t=qn(e);return!t||t===`app:`?{}:Bn(Rn()[t])}function Un(e,t){let n=qn(e);if(!n||n===`app:`)return{};let r=Bn(t),i={...Rn()};return Vn(r)?delete i[n]:i[n]=r,zn(i),r}function Wn(e){let t=qn(e);if(!t||t===`app:`)return;let n={...Rn()};delete n[t],zn(n)}function Gn(e){return Hn(e)}var Kn,U,qn,Jn;function Yn(){return(Yn=e((()=>{Kn=`cwsp-app-launch-spec-v1`,U=null,qn=e=>`app:${String(e||``).trim()}`,Jn=e=>{let t=String(e||``).trim();return!t||/^javascript:/i.test(t)?``:t}})))()}function Xn(e,t=64){let n=String(e||``).trim();if(!n||!/^https?:\/\//i.test(n))return``;try{let e=new URL(n).hostname;return e?`https://www.google.com/s2/favicons?domain=${encodeURIComponent(e)}&sz=${t}`:``}catch{return``}}function Zn(e){let t=String(e||``).trim().toLowerCase();return t?t.includes(`/_favicon/`)||t.includes(`s2/favicons`)||t.includes(`favicon`)?!0:(t.startsWith(`android-icon:`),!1):!1}function Qn(e){let t=String(e||``).trim();return t?/^[a-z][a-z0-9+.-]*:/i.test(t)?t:`https://${t}`:``}function $n(e){xr=e}function er(e){let t=e||(globalThis.chrome?.bookmarks??null);return!t?.getTree||!t?.getChildren?null:{resolveIconUrl:(e,t=128)=>{let n=String(e||``).trim();if(!/^https?:\/\//i.test(n))return``;let r=Xn(n,t);if(r)return r;try{let e=globalThis.chrome?.runtime;if(typeof e?.getURL==`function`){let r=new URL(e.getURL(`/_favicon/`));return r.searchParams.set(`pageUrl`,n),r.searchParams.set(`size`,String(t)),r.toString()}}catch{}return``},async listChildren(e){if(e)return(await Cr(t,`getChildren`,e)||[]).map(wr);let n=await Cr(t,`getTree`)||[],r=[];for(let e of n)for(let t of e.children||[])r.push(wr(t));return r},async search(e){let n=String(e||``).trim();if(!n)return this.listChildren();if(typeof t.search!=`function`){let e=await this.listChildren(),t=n.toLowerCase();return e.filter(e=>e.title.toLowerCase().includes(t)||String(e.url||``).toLowerCase().includes(t))}return(await Cr(t,`search`,n)||[]).map(wr)},async open(e){if(e.folder)return;let t=String(e.url||``).trim();if(t){try{let e=globalThis.chrome?.tabs;if(typeof e?.create==`function`){await Promise.resolve(e.create({url:t}));return}}catch{}globalThis.open?.(t,`_blank`,`noopener,noreferrer`)}},async remove(e){let n=String(e?.id||``).trim();if(!n)return!1;try{if(e.folder){if(typeof t.removeTree!=`function`)return!1;await Cr(t,`removeTree`,n)}else{if(typeof t.remove!=`function`)return!1;await Cr(t,`remove`,n)}return!0}catch{return!1}},async update(e,n){let r=String(e||``).trim();if(!r||typeof t.update!=`function`)return null;let i={};if(n.title!=null&&(i.title=String(n.title||``).trim()),n.url!=null){let e=Qn(n.url);e&&(i.url=e)}try{let e=await Cr(t,`update`,r,i);return e?wr(e):null}catch{return null}},async create(e,n){if(typeof t.create!=`function`)return null;let r=String(n.title||``).trim();if(!r)return null;let i={parentId:String(e||`0`),title:r};if(n.url!=null){let e=Qn(n.url);if(!e)return null;i.url=e}let a=async e=>{let n=await Cr(t,`create`,{...i,parentId:e});return n?wr(n):null};try{return await a(i.parentId)}catch{if(i.parentId===`0`)try{return await a(`1`)}catch{return null}return null}}}}function tr(){return xr||er()}function nr(){return!!tr()}function rr(){try{let e=localStorage.getItem(_r);if(!e)return[];let t=JSON.parse(e);return Array.isArray(t)?t.filter(e=>e&&e.id&&e.title).slice(0,yr):[]}catch{return[]}}function ir(e){if(!e?.id||e.folder)return;let t=[e,...rr().filter(t=>t.id!==e.id)].slice(0,yr);try{localStorage.setItem(_r,JSON.stringify(t))}catch{}}function ar(){return Tr(vr,br)}function or(e){return ar().some(t=>t.id===e)}function sr(e){if(!e?.id||e.folder||!String(e.url||``).trim())return!1;let t=[e,...ar().filter(t=>t.id!==e.id)].slice(0,br);try{return localStorage.setItem(vr,JSON.stringify(t)),!0}catch{return!1}}function cr(e){let t=String(e||``).trim();if(!t)return!1;let n=ar().filter(e=>e.id!==t);try{return localStorage.setItem(vr,JSON.stringify(n)),!0}catch{return!1}}function lr(e){let t=String(e?.id||``).trim();if(!t)return;let n=n=>n.map(n=>n.id===t?{...n,title:e.title||n.title,url:e.url||n.url}:n);try{Er(vr,n(ar()),br),Er(_r,n(rr()),yr)}catch{}}function ur(e){let t=String(e||``).trim();if(t){cr(t);try{Er(_r,rr().filter(e=>e.id!==t),yr)}catch{}}}function dr(e,t=Dr){let n=String(e||``).trim();if(!n)return``;try{let e=new URL(n,globalThis.location?.href);if(e.searchParams.has(`pageUrl`))return e.searchParams.set(`size`,String(t)),e.toString();if(e.hostname.endsWith(`google.com`)&&e.pathname.includes(`favicon`))return e.searchParams.set(`sz`,String(t)),e.toString()}catch{}return n}function fr(e,t){let n=String(e.url||``).trim();return n&&(Xn(n,Dr)||Xn(n,128)||Xn(n,64)||t?.resolveIconUrl?.(n,Dr)||t?.resolveIconUrl?.(n,128))||``}function pr(e,t,n,r=``){return hr(e,t,String(r||``).trim()||dr(fr(e,n),Dr))}function mr(e,t=``){let n=String(e.url||``).trim();return JSON.stringify({state:{icon:e.folder?`folder`:`link`,label:e.title||n||`Bookmark`,action:e.folder?`open-path`:`open-link`},desc:{action:e.folder?`open-path`:`open-link`,href:e.folder?``:n,path:e.folder?`/bookmarks/${e.id}/`:`/bookmarks/${e.id}`,meta:{entityType:`bookmark`,bookmarkId:e.id,...t?{iconUrl:t}:{}}}})}function hr(e,t,n=``){if(e.folder||!String(e.url||``).trim())return null;let r=t??Be(),i=Ie(mr(e,n),r);return i?(We(i),i):null}async function gr(e,t,n){if(e.replaceChildren(),t.folder)return Or(e,`folder`),e.toggleAttribute(`data-bookmark-bitmap`,!1),``;let r=String(t.url||``).trim(),i=[],a=Xn(r,Dr);a&&i.push(a);let o=Xn(r,128);o&&!i.includes(o)&&i.push(o);let s=Xn(r,64);s&&!i.includes(s)&&i.push(s);let c=n?.resolveIconUrl?.(r,Dr)||``;c&&!i.includes(c)&&i.push(c);let l=n?.resolveIconUrl?.(r,128)||``;l&&!i.includes(l)&&i.push(l);let u=n?.resolveIconUrl?.(r,64)||``;u&&!i.includes(u)&&i.push(u);try{let e=globalThis.chrome?.runtime;if(typeof e?.getURL==`function`&&r){let t=new URL(e.getURL(`/_favicon/`));t.searchParams.set(`pageUrl`,r),t.searchParams.set(`size`,String(Dr));let n=t.toString();n&&!i.includes(n)&&i.push(n)}}catch{}return Or(e,`link`),e.toggleAttribute(`data-bookmark-bitmap`,!1),i.length?await new Promise(t=>{let n=0,r=()=>{if(n>=i.length){t(``);return}let a=i[n++],o=document.createElement(`img`);o.className=`env-shell-app-menu__tile-favicon`,o.alt=``,o.decoding=`async`,o.loading=`eager`,o.referrerPolicy=`no-referrer`,o.draggable=!1,o.addEventListener(`load`,()=>{e.replaceChildren(o),e.toggleAttribute(`data-bookmark-bitmap`,!0),t(a)},{once:!0}),o.addEventListener(`error`,()=>{r()},{once:!0}),o.src=a};r()}):``}var _r,vr,yr,br,xr,Sr,Cr,wr,Tr,Er,Dr,Or;function kr(){return(kr=e((()=>{Ne(),_r=`rs-app-menu-bookmark-recent`,vr=`rs-app-menu-bookmark-pinned`,yr=12,br=16,xr=null,Sr=()=>{try{let e=globalThis.chrome?.runtime?.lastError;return e?Error(String(e.message||e)):null}catch{return null}},Cr=(e,t,...n)=>{let r=e[t];if(typeof r!=`function`)return Promise.reject(Error(`chrome.bookmarks.${String(t)} missing`));try{let t=r.apply(e,n);if(t!=null&&typeof t.then==`function`)return t}catch(e){return Promise.reject(e)}return new Promise((t,i)=>{try{r.apply(e,[...n,e=>{let n=Sr();n?i(n):t(e)}])}catch(e){i(e)}})},wr=e=>{let t=typeof e.url==`string`&&e.url?e.url:void 0;return{id:String(e.id),title:String(e.title||e.url||e.id||`Bookmark`),url:t,folder:!t,parentId:e.parentId}},Tr=(e,t)=>{try{let n=localStorage.getItem(e);if(!n)return[];let r=JSON.parse(n);return Array.isArray(r)?r.filter(e=>e&&e.id&&e.title&&!e.folder).slice(0,t):[]}catch{return[]}},Er=(e,t,n)=>{localStorage.setItem(e,JSON.stringify(t.slice(0,n)))},Dr=256,Or=(e,t)=>{let n=document.createElement(`ui-icon`);n.setAttribute(`icon`,t),n.setAttribute(`icon-style`,`duotone`),n.setAttribute(`aria-hidden`,`true`),n.style.setProperty(`--icon-size`,`1.75rem`),n.style.setProperty(`--icon-padding`,`0px`),n.style.setProperty(`--icon-color`,`currentColor`),n.style.color=`currentColor`,e.append(n),customElements.whenDefined(`ui-icon`).then(()=>{n.isConnected&&(n.getAttribute(`icon`)||n.setAttribute(`icon`,t),n.style.setProperty(`--icon-size`,`1.75rem`),n.style.setProperty(`--icon-padding`,`0px`))})}})))()}function Ar(e){let t=e.info||{},n=String(t.packageName||e.fallback.packageName||``).trim(),r=String(t.label||e.fallback.label||e.title||n).trim(),i=[[`Label`,r],[`Package`,n],[`Activity`,String(t.componentName||e.fallback.componentName||`—`)],[`Version`,`${t.versionName||`—`} (${t.versionCode??`—`})`],[`Installer`,String(t.installer||`—`)],[`Enabled`,t.enabled===!1?`no`:`yes`],[`System`,t.system?t.updatedSystem?`updated system`:`yes`:`no`],[`Installed`,Rr(t.firstInstallTime)],[`Updated`,Rr(t.lastUpdateTime)]],a=zr(`
        <form class="speed-dial-editor__form" autocomplete="off">
            <header class="modal-header">
                <h2 class="modal-title">App info</h2>
                <p class="modal-description">${W(r)}</p>
            </header>
            <div class="modal-fields">
                ${i.map(([e,t])=>`
                    <div class="modal-field">
                        <label>${W(e)}</label>
                        <input type="text" readonly value="${W(t)}" />
                    </div>`).join(``)}
            </div>
    ...
    `),o=a.__cwspClose;a.querySelector(`form`)?.addEventListener(`click`,t=>{let n=t.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`);n===`close`&&(t.preventDefault(),o?.()),n===`system`&&(t.preventDefault(),Promise.resolve(e.onOpenSystem?.()).finally(()=>o?.()))})}function jr(e){let t=Hn(e.packageName),n=new Set((t.flags||[]).map(e=>e.toUpperCase())),r=zr(`
        <form class="speed-dial-editor__form" autocomplete="off">
            <header class="modal-header">
                <h2 class="modal-title">Edit launch</h2>
                <p class="modal-description">${W(e.title)} — action, data URI, extras, flags</p>
            </header>
            <div class="modal-fields">
                <div class="modal-field">
                    <label for="am-launch-component">Activity</label>
                    <input id="am-launch-component" name="componentName" type="text" value="${W(t.componentName||e.defaultComponent||``)}" placeholder="pkg/.MainActivity" />
                </div>
                <div class="modal-field">
                    <label for="am-launch-action">Intent action</label>
                    <input id="am-launch-action" name="action" type="text" value="${W(t.action||``)}" placeholder="android.intent.action.MAIN" />
                </div>
                <div class="modal-field">
                    <label for="am-launch-data">Data URI</label>
                    <input id="am-launch-data" name="data" type="text" value="${W(t.data||``)}" placeholder="https://…  content://…  app scheme" />
                </div>
                <div class="modal-field">
                    <label for="am-launch-mime">MIME</label>
                    <input id="am-launch-mime" name="mimeType" type="text" value="${W(t.mimeType||``)}" placeholder="text/plain" />
                </div>
                <div class="modal-field">
                    <label for="am-launch-categories">Categories (comma)</label>
                    <input id="am-launch-categories" name="categories" type="text" value="${W((t.categories||[]).join(`, `))}" placeholder="android.intent.category.LAUNCHER" />
                </div>
                <div class="modal-field">
                    <label>Flags</label>
                    <div>
                ...
                <div class="modal-field">
                    ...
                    <textarea id="am-launch-extras" name="extras" rows="5" placeholder='{"debug": true}'>${W(Br(t.extras))}</textarea>
                </div>
            </div>
            <div class="modal-actions" role="group">
    ...
    `),i=r.__cwspClose,a=r.querySelector(`form`),o=()=>{let e=[...r.querySelectorAll(`input[name="flag"]:checked`)].map(e=>e.value),t=String(r.querySelector(`[name="categories"]`)?.value||``).split(`,`).map(e=>e.trim()).filter(Boolean);return Bn({componentName:r.querySelector(`[name="componentName"]`)?.value,action:r.querySelector(`[name="action"]`)?.value,data:r.querySelector(`[name="data"]`)?.value,mimeType:r.querySelector(`[name="mimeType"]`)?.value,categories:t,flags:e,extras:Vr(r.querySelector(`[name="extras"]`)?.value||``)})};a?.addEventListener(`click`,t=>{let n=t.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`);n===`cancel`&&(t.preventDefault(),i?.()),n===`reset`&&(t.preventDefault(),Wn(e.packageName),e.onSave?.({}),V(`Launch reset to default`),i?.())}),a?.addEventListener(`submit`,t=>{t.preventDefault();let n=o();Un(e.packageName,n),e.onSave?.(n),V(Vn(n)?`Launch reset to default`:`Launch saved`),i?.()})}function Mr(e,t=`Uninstall`){return globalThis.confirm?.(`${t} “${e}”?`)===!0}function Nr(e){let t=()=>{document.visibilityState===`visible`&&(document.removeEventListener(`visibilitychange`,t),e())};document.addEventListener(`visibilitychange`,t),globalThis.setTimeout?.(e,1600)}function Pr(e){let t=[[`Title`,e.title||`—`],[`URL`,e.url||`—`],[`Id`,e.id],[`Type`,e.folder?`Folder`:`Bookmark`]],n=zr(`
        <form class="speed-dial-editor__form" autocomplete="off">
            <header class="modal-header">
                <h2 class="modal-title">${e.folder?`Folder info`:`Bookmark info`}</h2>
                <p class="modal-description">${W(e.title)}</p>
            </header>
            <div class="modal-fields">
                ${t.map(([e,t])=>`
                    <div class="modal-field">
    ...
    `),r=n.__cwspClose;n.querySelector(`form`)?.addEventListener(`click`,e=>{e.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`)===`close`&&(e.preventDefault(),r?.())})}function Fr(e){let t=e.showUrl!==!1;return new Promise(n=>{let r=!1,i=zr(`
        <form class="speed-dial-editor__form" autocomplete="off">
            <header class="modal-header">
                <h2 class="modal-title">${W(e.heading)}</h2>
                ${e.description?`<p class="modal-description">${W(e.description)}</p>`:``}
            </header>
            <div class="modal-fields">
                <div class="modal-field">
                    <label for="am-bm-title">Title</label>
                    <input id="am-bm-title" name="title" type="text" value="${W(e.initialTitle||``)}" />
                </div>
                ${t?`<div class="modal-field">
                    <label for="am-bm-url">URL</label>
                    <input id="am-bm-url" name="url" type="url" value="${W(e.initialUrl||``)}" placeholder="https://" />
                </div>`:``}
            </div>
            <div class="modal-actions" role="group">
                <span></span>
                <button type="button" data-action="cancel" class="btn secondary">Cancel</button>
                <button type="submit" class="btn save">${W(e.submitLabel||`Save`)}</button>
            </div>
        </form>
    `),a=i.__cwspClose,o=e=>{r||(r=!0,a?.(),n(e))},s=i.querySelector(`form`);s?.addEventListener(`click`,e=>{e.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`)===`cancel`&&(e.preventDefault(),o(null))}),i.addEventListener(`cancel`,()=>o(null)),s?.addEventListener(`submit`,e=>{e.preventDefault();let n=String(i.querySelector(`[name="title"]`)?.value||``).trim();if(!n){H(`Title is required`);return}if(!t){o({title:n});return}let r=Qn(i.querySelector(`[name="url"]`)?.value||``);if(!r){H(`URL is required`);return}o({title:n,url:r})})})}function Ir(e){let t=e.entry;(async()=>{let n=await Fr({heading:t.folder?`Rename folder`:`Edit bookmark`,description:t.folder?t.title:`${t.title} — Chrome bookmark`,initialTitle:t.title,initialUrl:t.url||``,showUrl:!t.folder,submitLabel:`Save`});if(!n)return;if(!e.api.update){H(`Bookmark edit unavailable`);return}let r=await e.api.update(t.id,t.folder?{title:n.title}:{title:n.title,url:n.url});if(!r){H(t.folder?`Could not rename folder`:`Could not update bookmark`);return}lr(r),V(t.folder?`Folder renamed`:`Bookmark updated`),e.onSaved?.(r)})()}var Lr,W,Rr,zr,Br,Vr;function Hr(){return(Hr=e((()=>{Ln(),Yn(),kr(),Lr=[`NEW_TASK`,`CLEAR_TOP`,`SINGLE_TOP`,`CLEAR_TASK`,`NO_HISTORY`,`REORDER_TO_FRONT`,`MULTIPLE_TASK`],W=e=>String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`),Rr=e=>{let t=Number(e);if(!Number.isFinite(t)||t<=0)return`—`;try{return new Date(t).toLocaleString()}catch{return String(t)}},zr=e=>{let t=document.createElement(`dialog`);t.className=`speed-dial-editor env-shell-app-menu__chrome-editor`,t.innerHTML=e;let n=()=>{try{t.open&&t.close()}catch{}t.remove()};t.addEventListener(`cancel`,e=>{e.preventDefault(),n()}),t.__cwspClose=n,document.body.append(t);try{t.showModal()}catch{t.setAttribute(`open`,``)}return t},Br=e=>{if(!e||!Object.keys(e).length)return``;try{return JSON.stringify(e,null,2)}catch{return``}},Vr=e=>{let t=String(e||``).trim();if(!t)return{};if(t.startsWith(`{`))try{return Bn({extras:JSON.parse(t)}).extras||{}}catch{}let n={};for(let e of t.split(/\r?\n/)){let t=e.indexOf(`=`);if(t<1)continue;let r=e.slice(0,t).trim(),i=e.slice(t+1).trim();r&&(n[r]=i===`true`||i===`false`?i===`true`:/^-?\d+(\.\d+)?$/.test(i)?Number(i):i)}return n}})))()}function Ur(){return(Ur=e((()=>{Re(),In(),Hr(),D()})))()}var Wr,Gr,Kr,G,K,q,qr,Jr,Yr,J,Xr,Zr,Qr,$r,Y,ei,ti,ni,ri,ii,ai,oi,si,ci,li,ui,di,fi,pi;function mi(){return(mi=e((()=>{y(),D(),Ur(),In(),Wr=320,Gr=220,Kr=`2147483640`,G=`important`,K=0,q=null,qr=null,Jr=null,Yr=null,J=[],Xr=new Map,Zr=new Map,Qr=new Map,$r=new Map,Y=new Map,ei=[`left-start`,`right-end`,`left-end`,`bottom-start`,`top-start`],ti=(e,t)=>{let n=x(e,{...t,strategy:`js`});return typeof requestAnimationFrame==`function`&&requestAnimationFrame(()=>{n.update?.()}),n},ni=()=>{let e=document.documentElement,t=String(e.getAttribute(`data-theme`)||``).trim().toLowerCase();if(t===`light`||t===`dark`)return t;let n=String(e.getAttribute(`data-scheme`)||``).trim().toLowerCase();if(n===`light`||n===`dark`)return n;try{let e=String(localStorage.getItem(`rs-appearance-theme`)||``).trim().toLowerCase();if(e===`light`||e===`dark`)return e}catch{}return typeof matchMedia==`function`&&matchMedia(`(prefers-color-scheme: light)`).matches?`light`:`dark`},ri=(e,t)=>{e.style.setProperty(`position`,`fixed`,G),e.style.setProperty(`box-sizing`,`border-box`,G),e.style.setProperty(`min-width`,t?`188px`:`220px`,G),e.style.setProperty(`max-width`,`min(320px, calc(100vw - 24px))`,G),e.style.setProperty(`padding`,t?`0.3rem`:`0.4rem`,G),e.style.setProperty(`border-radius`,`14px`,G),e.style.setProperty(`pointer-events`,`auto`,G),e.style.setProperty(`backdrop-filter`,`blur(10px)`,G),e.style.setProperty(`-webkit-backdrop-filter`,`blur(10px)`,G),e.style.removeProperty(`border`),e.style.removeProperty(`background`),e.style.removeProperty(`color`),e.style.removeProperty(`box-shadow`);let n=ni();e.dataset.theme=n,e.style.setProperty(`color-scheme`,n===`light`?`light only`:`dark only`,G)},ii=e=>{e.style.setProperty(`list-style`,`none`,G),e.style.setProperty(`list-style-type`,`none`,G),e.style.setProperty(`margin`,`0`,G),e.style.setProperty(`padding`,`0`,G),e.style.setProperty(`display`,`flex`,G),e.style.setProperty(`flex-direction`,`column`,G),e.style.setProperty(`align-items`,`stretch`,G),e.style.setProperty(`gap`,`0.2rem`,G),e.style.setProperty(`width`,`100%`,G),e.style.setProperty(`box-sizing`,`border-box`,G)},ai=(e,t)=>{if(e.style.setProperty(`appearance`,`none`,G),e.style.setProperty(`-webkit-appearance`,`none`,G),e.style.setProperty(`box-sizing`,`border-box`,G),e.style.setProperty(`width`,`100%`,G),e.style.setProperty(`max-width`,`100%`,G),e.style.setProperty(`margin`,`0`,G),e.style.setProperty(`display`,`grid`,G),e.style.setProperty(`grid-template-columns`,`1.375rem minmax(0, 1fr) auto`,G),e.style.setProperty(`align-items`,`center`,G),e.style.setProperty(`justify-items`,`start`,G),e.style.setProperty(`gap`,`0.55rem`,G),e.style.setProperty(`border`,`none`,G),e.style.setProperty(`border-radius`,`10px`,G),e.style.setProperty(`padding`,`0.5rem 0.6rem`,G),e.style.setProperty(`min-height`,`2.35rem`,G),e.style.setProperty(`font`,`inherit`,G),e.style.setProperty(`font-size`,`0.8125rem`,G),e.style.setProperty(`line-height`,`1.25`,G),e.style.setProperty(`text-align`,`start`,G),e.style.setProperty(`cursor`,`pointer`,G),e.style.removeProperty(`background`),e.style.removeProperty(`background-color`),!t)e.style.setProperty(`color`,`inherit`,G);else{let t=ni()===`light`?`#9f1239`:`#fecaca`;e.style.setProperty(`color`,t,G),e.style.setProperty(`--cw-menu-fg`,t,G)}},oi=()=>{let e=document.getElementById(`cw-unified-context-menu-style`);e||(e=document.createElement(`style`),e.id=`cw-unified-context-menu-style`,document.head.appendChild(e)),e.textContent=`
        .cw-context-menu-layer {
            position: fixed;
            inset: 0;
            z-index: var(--cw-context-menu-layer-z, ${Kr});
            pointer-events: none;
        }
    ...
    `},si=()=>{for(let e of J)try{e()}catch{}J=[]},ci=e=>{for(let[t,n]of Array.from($r.entries()))t>=e&&(clearTimeout(n),$r.delete(t));for(let[t,n]of Array.from(Y.entries()))t>=e&&(clearTimeout(n),Y.delete(t))},li=e=>{ci(e);for(let[t,n]of Array.from(Xr.entries()))t>=e&&(Qr.get(t)?.dispose(),Qr.delete(t),n.remove(),Xr.delete(t),Zr.delete(t))},ui=e=>{for(let[t,n]of Array.from(Y.entries()))t>=e&&(clearTimeout(n),Y.delete(t))},di=(e,t,n,r,i)=>{let a=document.createElement(`div`);a.className=`cw-context-menu${t?` cw-context-menu--compact`:``}`,a.setAttribute(`role`,`menu`),a.dataset.menuDepth=String(n),a.style.zIndex=String(n+1);let o=document.createElement(`ul`);o.className=`cw-context-menu__list`,ii(o),a.appendChild(o);let s=(e,n,a)=>{if(r!==K||!qr?.isConnected||!q?.isConnected||(li(a),!e.children?.length))return;let o=di(e.children,t,a,r,i);o.classList.add(`cw-context-menu--submenu`),q.appendChild(o),Xr.set(a,o),Zr.set(a,n),Qr.set(a,ti(o,{origin:{type:`element`,element:n},placement:`right-start`,fallbacks:ei,strategy:`js`}))},c=(e,t,n)=>{let r=$r.get(n);r&&clearTimeout(r),ui(n);let i=setTimeout(()=>{$r.delete(n),s(e,t,n)},Wr);$r.set(n,i)},l=e=>{let t=Y.get(e);t&&clearTimeout(t);let n=setTimeout(()=>{Y.delete(e),li(e)},Gr);Y.set(e,n)};for(let t of e){let e=document.createElement(`button`);e.type=`button`,e.className=`cw-context-menu__item${t.danger?` cw-context-menu__item--danger`:``}`,e.setAttribute(`role`,`menuitem`),e.disabled=!!t.disabled,ai(e,!!t.danger);let i=!!t.children?.length;if(e.innerHTML=`
            ...
            <div class="modal-fields">
                <div class="modal-field">
                    ...
                    <select id="am-chrome-shape" name="shape">
                        ${De.map(e=>`<option value="${e.value}"${Te(t.shape,`circle`)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
                <div class="modal-field">
                    <label for="am-chrome-display">Icon display</label>
                    <select id="am-chrome-display" name="iconDisplay">
                        ${Xe.map(e=>`<option value="${e.value}"${(ve(t.iconDisplay)||`colored`)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
                <div class="modal-field">
                    <label for="am-chrome-icon-scale">Icon scale (inside plate)</label>
                    <select id="am-chrome-icon-scale" name="iconScale">
                        ${Ke.map(e=>`<option value="${e.value}"${Ve(t.iconScale)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
...
`))},Zo=class extends R{styles=()=>Ko;onInitialize(){let e=super.onInitialize();return queueMicrotask(()=>{Yo(this),Jo(this),de()?pe().then(e=>Xo(this,e)):Xo(this,null,`Browser / PWA: use Mount folder (showDirectoryPicker).`)}),e??this}render=function(){let e=this,t=de(),n=me();return a`<div class="explorer-settings" part="root">
            ...
            <section class="explorer-settings__card" hidden=${!t}>
                ...
                <div class="explorer-settings__actions">
                    <button class="btn btn--primary" type="button" disabled=${!t} on:click=${()=>{fe().then(()=>pe().then(t=>Xo(e,t,`Opened system all-files settings.`)))}}>Allow all files</button>
                    <button class="btn" type="button" disabled=${!t} on:click=${()=>{he().then(t=>{Xo(e,null,t?`SAF tree: ${t}`:`SAF pick cancelled.`),window.dispatchEvent(new CustomEvent(`cwsp:explorer-mount-change`))})}}>Pick SAF folder</button>
                </div>
            </section>
            <section class="explorer-settings__card">
                <h3 class="explorer-settings__title">
                ...
                <label class="explorer-settings__check">
                    <input type="checkbox" data-explorer-opfs-enabled checked=${ie()} disabled=${!j()} on:change=${e=>{ee(e.currentTarget.checked),re(),we(`/user/`),we(`/idb/`),ge(),window.dispatchEvent(new CustomEvent(`cwsp:explorer-mount-change`))}} />
            ...
            <section class="explorer-settings__card" hidden=${t||!n}>
                ...
                <div class="explorer-settings__actions">
                    <button class="btn" type="button" disabled=${!n} on:click=${()=>{I().then(t=>{t&&(Ee(t),Jo(e),window.dispatchEvent(new CustomEvent(`cwsp:explorer-mount-change`)))})}}>Mount folder</button>
                </div>
                <div data-explorer-mounts class="explorer-settings__mounts"></div>
            </section>
        </div>`}},Zo=L([i(`ui-explorer-settings`)],Zo),Qo=()=>{document.querySelectorAll(`ui-file-manager`).forEach(e=>{let t=e.shadowRoot?.querySelector(`.fm-root`);t?.classList.remove(`fm-root--settings`),t?.querySelector(`ui-explorer-settings`)?.remove()}),document.querySelector(`ui-explorer-settings`)?.remove()},v(window,`keydown`,e=>{e.key===`Escape`&&Qo()})})))()}var es,ts,ns,rs,is,as,os;function ss(){return(ss=e((()=>{D(),mi(),$o(),es=()=>document.querySelector(`ui-file-manager`),ts=()=>es()?.shadowRoot?.querySelector(`ui-explorer-settings`)??document.querySelector(`ui-explorer-settings`),ns=()=>d()&&_()?!0:document.querySelector(`.cw-context-menu, .cw-context-menu-layer`)?(fi(),!0):ts()?(Qo(),!0):!1,rs=()=>{let e=globalThis;e.__CWSP_NATIVE_BACK__={handleBackPress:ns};let t=e.__CWSP_LAUNCHER_HOME__?.handleBackPress;e.__CWSP_LAUNCHER_HOME__={...e.__CWSP_LAUNCHER_HOME__||{},handleBackPress:()=>ns()||typeof t==`function`&&t()}},is=()=>{let e=globalThis;if(e.__CWSP_CAP_BACK_BOUND__)return;let t=e.Capacitor?.Plugins?.App;if(typeof t?.addListener==`function`){e.__CWSP_CAP_BACK_BOUND__=!0;try{t.addListener(`backButton`,()=>{ns()})}catch(e){console.warn(`[overlay-back] Capacitor backButton bind failed`,e)}}},as=()=>{O({id:`app-menu-overlay`,priority:g.SIDEBAR,isActive:()=>!!document.querySelector(`.env-shell-app-menu[data-open]`),close:()=>(document.querySelector(`.env-shell-app-menu`)?.dispatchEvent(new CustomEvent(`env-app-menu-request-close`,{bubbles:!0})),!0)}),O({id:`speed-dial-editor`,priority:g.MODAL,isActive:()=>!!document.querySelector(`dialog.speed-dial-editor[open], dialog.sd-icon-picker[open]`),close:()=>(document.querySelectorAll(`dialog.speed-dial-editor[open], dialog.sd-icon-picker[open]`).forEach(e=>{try{e.close()}catch{e.remove()}}),!0)})},os=()=>{let e=globalThis;if(e.__CWSP_LAUNCHER_BACK_STACK__){is(),rs();return}e.__CWSP_LAUNCHER_BACK_STACK__=!0;try{t({preventDefaultNavigation:!0,pushInitialState:!1})}catch{}as(),is(),rs()}})))()}var cs;function ls(){return(ls=e((()=>{cs=`/*
...
}`})))()}var Rs;function zs(){return(zs=e((()=>{Ns(),c(),Fs(),Ls(),Rs=async e=>{await ks().catch(()=>void 0),await C(Ps)?.catch(()=>void 0),e?.includeGlobalNativeControls&&await C(Is)?.catch(()=>void 0)}})))()}var Bs;function Vs(){return(Vs=e((()=>{Bs=`:host(ui-task), :host(ui-task) * {
  box-sizing: border-box;
  user-select: none;
  touch-action: manipulation;
  -webkit-user-drag: none;
...
:host(ui-task:not([data-active])) {
  opacity: 0.6;
}`})))()}var Hs,Us,Ws,Gs;function Ks(){return(Ks=e((()=>{z(),c(),D(),Vs(),Hs=s(Bs),Us=e=>{let t=``;if(typeof e==`string`)t=e;else if(typeof e==`object`&&e&&`value`in e){let n=e.value;t=n==null?``:String(n)}else e!=null&&typeof e!=`object`&&(t=String(e));(!t||t===`undefined`||t===`null`||t===`[object Object]`)&&(t=``);let n=t.trim().charAt(0);return n?n.toUpperCase():`?`},Ws=(e,t,n)=>{let r=e.getAttribute(t);return r!=null&&String(r).trim()?String(r).trim():n},Gs=class extends et{title;icon;constructor(){super()}styles=()=>Hs;render=function(){let e=Ws(this,`title`,`Task`),t=Ws(this,`icon`,`app-window`),n=Us(e);return a`
        ...
        `}},L([T({source:`attr`})],Gs.prototype,`title`,void 0),L([T({source:`attr`})],Gs.prototype,`icon`,void 0),Gs=L([i(`ui-task`)],Gs)})))()}var qs;function Js(){return(Js=e((()=>{qs=`ui-taskbar[data-type=desktop] > ui-task[data-focus] {
...
:host(ui-taskbar[data-type=desktop]) ::slotted(ui-task[data-focus]) {
  ...
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}`})))()}function Ys(){return(Ys=e((()=>{y(),c(),Js(),s(qs)})))()}var Xs;function Zs(){return(Zs=e((()=>{Xs=`ui-taskbar[data-type=mobile] > ui-task[data-focus] {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}
...
}`})))()}var Ic,Lc,Rc,zc,Bc,Vc,Hc;function Uc(){return(Uc=e((()=>{D(),y(),c(),z(),ue(),ic(),Nc(),Fc(),Ic=s(Pc),Lc=`minus`,Rc=`corners-out`,zc=`corners-in`,Bc=`x`,Vc=Object.freeze({w:240,h:160}),Hc=class extends R{titleHandler;contentHandler;footerHandler;resizer;#e=N(0);#t=N(0);#n=null;#r=null;#i=null;#a=null;#o=null;#s=null;#c=null;#l=!1;#u=0;#d=0;#f=null;#p=null;#m=null;styles=function(){return Ic};render=function(){return a`<div class="window-container" part="window-container">
