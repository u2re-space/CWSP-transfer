import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{a as t,t as n}from"./cws-bridge-BQaWEBzp.js";import{Ct as r,Nt as i,Q as a,Z as o,ct as s,t as c,ut as l}from"./src-TXtvocpz.js";import{Bt as u,It as d,Lt as f,Mt as p,Nt as m,Rt as h}from"./OPFS-WcvpNv6j.js";import{n as g,r as _}from"./shell-preference-DNduHyVr.js";import{n as v,t as y}from"./preload-helper-DFTwEg7x.js";import{d as b,u as ee}from"./registry-D9EPHR_5.js";import{i as x,n as S,o as C,t as w}from"./image-DYH74VgF.js";import{o as T,s as E}from"./icon-C6atVd0v.js";import{_ as D,g as O,n as te,t as k,v as A,y as ne}from"./shells-hz-wANCW.js";import{_ as j,a as M,b as N,c as P,d as F,f as I,g as re,h as ie,i as ae,l as L,m as R,n as z,o as oe,p as se,r as ce,s as le,t as ue,u as de,v as fe,x as pe,y as me}from"./src-DptHkaFH.js";function he(){if(typeof document>`u`||!document.body)return{top:0,bottom:0};let e=document.createElement(`div`);e.style.cssText=`position:fixed;top:0;left:0;padding-top:env(safe-area-inset-top);padding-bottom:env(safe-area-inset-bottom);visibility:hidden;pointer-events:none;`,document.body.appendChild(e);let t=getComputedStyle(e),n=Number.parseFloat(t.paddingTop)||0,r=Number.parseFloat(t.paddingBottom)||0;return e.remove(),{top:n,bottom:r}}function ge(){try{if(!/android/i.test(navigator.userAgent))return 0}catch{return 0}return 28}function _e(e,t){H=Math.max(0,Math.round(e)),U=Math.max(0,Math.round(t));let n=`${H}px`,r=`${U}px`;document.documentElement.style.setProperty(B,n),document.documentElement.style.setProperty(V,r),document.documentElement.toggleAttribute(`data-capacitor-native`,!0);for(let e of document.querySelectorAll(`.env-shell-root, env-shell-container`))e instanceof HTMLElement&&(e.style.setProperty(B,n),e.style.setProperty(V,r),e.toggleAttribute(`data-capacitor-native`,!0))}function ve(){if(H<=0&&U<=0)return;let e=`${H}px`,t=`${U}px`;for(let n of document.querySelectorAll(`.env-shell-root, env-shell-container`))n instanceof HTMLElement&&n.style.getPropertyValue(B)!==e&&(n.style.setProperty(B,e),n.style.setProperty(V,t),n.toggleAttribute(`data-capacitor-native`,!0))}async function ye(){let e=0;try{let t=await n.getShellInfo();e=Number(t.statusBarHeightCss)||0}catch{}let t=he();return e=Math.max(e,t.top),e<=0&&(e=ge()),{top:e,bottom:0}}async function be(){if(!I())return;if(xe){ve();return}xe=!0;let e=async()=>{let{top:e,bottom:t}=await ye();_e(e,t)};await e(),window.addEventListener(`resize`,()=>void e()),window.visualViewport?.addEventListener(`resize`,()=>void e()),document.addEventListener(`orientationchange`,()=>void e()),ve(),globalThis.setTimeout?.(ve,400)}var B,V,H,U,xe;function Se(){return(Se=e((()=>{t(),F(),B=`--env-native-safe-top`,V=`--env-native-safe-bottom`,H=0,U=0,xe=!1})))()}var Ce;function we(){return(we=e((()=>{Ce=`/**
...
}`})))()}function Te(){return!Ae&&!customElements.get(`env-shell-container`)&&(customElements.define(W,ke),Ae=!0),ke}function Ee(){Te();let e=customElements.get(W);if(e)try{return new e}catch(e){console.warn("[env-shell-container] `new` failed, falling back to createElement",e)}return document.createElement(W)}function De(e){return e instanceof HTMLElement&&e.localName===`env-shell-container`}var W,Oe,ke,Ae;function je(){return(je=e((()=>{we(),D(),W=`env-shell-container`,Oe=document.createElement(`template`),Oe.innerHTML=`
...
</div>`,ke=class extends HTMLElement{#e=!1;get overlayMount(){return this.#t(),this.shadowRoot?.querySelector(`[data-shell-overlays]`)??null}constructor(){super(),this.#t()}connectedCallback(){this.#t()}#t(){if(this.#e&&this.shadowRoot)return;let e=this.shadowRoot??this.attachShadow({mode:`open`});if(e.querySelector(`.esc-stack`)||e.appendChild(Oe.content.cloneNode(!0)),e.adoptedStyleSheets.length===0){let t=new CSSStyleSheet;t.replaceSync(Ce),e.adoptedStyleSheets=[t]}this.#e=!0}},Ae=!1})))()}function Me(e){let t=`[${Ne}]`,n=e.querySelector(t);if(n)return n.style.zIndex||(n.style.zIndex=G),n.style.position||(n.style.position=De(e)?`absolute`:`fixed`),n;let r=document.createElement(`div`);return r.setAttribute(Ne,``),r.className=`env-shell-overlays`,r.setAttribute(`data-part`,`env-overlays`),De(e)?(r.slot=O.overlay,r.style.cssText=`position:absolute;inset:0;pointer-events:none;z-index:${G};box-sizing:border-box;`,e.appendChild(r),r):(r.style.cssText=`position:fixed;inset:0;pointer-events:none;z-index:${G};box-sizing:border-box;`,e.appendChild(r),r)}var Ne,G;function Pe(){return(Pe=e((()=>{je(),D(),Ne=`data-env-shell-overlays`,G=`2147483600`})))()}function Fe(){return(Fe=e((()=>{C()})))()}function Ie(e,t={}){let{x:n=48,y:r=48,w:i=640,h:a=480,z:o=10,demoRole:s}=t,c=matchMedia(`(max-width: 640px)`);return{demoRole:s,title:e,bounds:{x:h(n),y:h(r),w:h(i),h:h(a)},z:h(o),maximizedMobile:d(c.matches),minimized:d(!1),desktopMaximized:d(!1),nativeMode:d(!1),visible:d(!0),isMobileMq:c}}function Le(){return(Le=e((()=>{f(),Object.freeze({w:360,h:240})})))()}function K(e){let t=String(e??``).trim().toLowerCase();t=t.replace(/^#/,``);let n=/^todo:\s*(.*)$/i.exec(t);return n&&(t=String(n[1]??``).trim().toLowerCase()),t=t.replace(/\s+/g,``),t?t===`viewer`||ze.has(t)?q:t:``}function Re(e){return String(e||``).trim().toLowerCase()===q}var q,ze;function Be(){return(Be=e((()=>{q=`viewer`,ze=new Set([`markdown`,`markdown-view`,`markdown-viewer`,`reader`,`env-viewer`])})))()}function Ve(e){return!!(e&&typeof e==`object`&&typeof e.render==`function`)}function J(e,t){let n=e?.lifecycle?.[t];typeof n==`function`&&Promise.resolve(n())}function He(e){if(typeof e!=`function`)return!1;try{let t=e.prototype;return!!(t!=null&&typeof HTMLElement<`u`&&HTMLElement.prototype.isPrototypeOf(t))}catch{return!1}}function Ue(e,t){let n=e.default??e.createView??e.createHomeView;if(!n||typeof n!=`function`)throw Error(`window-frame view-mount: module has no default/createView factory`);let r=He(n)?new n(t):n(t);if(Ve(r)){let e=r,n=e.render(t);if(!(n instanceof HTMLElement))throw Error(`window-frame view-mount: view.render() must return HTMLElement`);return{root:n,view:e}}if(r instanceof HTMLElement)return{root:r};throw Error(`window-frame view-mount: factory did not return View or HTMLElement`)}function We(e,t){return e.replaceChildren(t),()=>{t.remove(),e.replaceChildren()}}async function Ge(e,t,n){let r=await e();typeof requestAnimationFrame==`function`&&await new Promise(e=>requestAnimationFrame(()=>e()));let{root:i,view:a}=Ue(r,n);i.classList.add(`wf-mounted-view`);let o=We(t,i);return J(a,`onMount`),J(a,`onShow`),()=>{J(a,`onHide`),J(a,`onUnmount`),o()}}function Ke(){try{if(document.documentElement.dataset.cwspNativeShell===`capacitor`)return!0;let e=globalThis.Capacitor;return typeof e?.isNativePlatform==`function`&&!!e.isNativePlatform()}catch{return!1}}function Y(e){let t=e?.closest?.(`.env-shell-root`)??e?.closest?.(`env-shell-container`);if(!(t instanceof HTMLElement))return 0;if(Z?.shell===t)return Z.n;let n=t.style.getPropertyValue(`--env-window-z-boost`).trim()||getComputedStyle(t).getPropertyValue(`--env-window-z-boost`).trim(),r=Number.parseInt(n,10),i=Number.isFinite(r)?r:0;return Z={shell:t,n:i},i}function qe(e){let t=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??document.querySelector?.(`.env-shell-root, env-shell-container`);return t instanceof HTMLElement?t:null}function X(e){let t=qe(e);if(!t)return;let n=!!t.querySelector?.(`ui-window[native-mode], ui-window[data-native-active]`);t.toggleAttribute(`data-env-native-task`,n)}function Je(e,t,n,r,i={}){let{bounds:a,z:o,maximizedMobile:s,minimized:c,desktopMaximized:l,visible:u,isMobileMq:f}=t;t.nativeMode||=d(!!i.startNative);let m=t.nativeMode;i.startNative&&(m.value=!0);let h=document.createElement(`ui-window`);h.setAttribute(`managed`,``),h.className=`env-ui-window`,h.setAttribute(`part`,`window`);{let e=document.documentElement.getAttribute(`data-theme`)||document.documentElement.style.colorScheme||``;(e===`light`||e===`dark`)&&(h.dataset.theme=e,h.style.colorScheme=e)}let g=document.createElement(`span`);g.slot=`title`,g.className=`env-ui-window__title`,g.textContent=t.title,n.slot=`content`,n.classList.add(`env-ui-window__body`),h.append(g,n),e.appendChild(h);let _=String(i?.managedViewKey??``).trim();_&&(h.setAttribute(`data-ui-window-view`,_),h.setAttribute(`data-wf-managed-view`,_));let v=null,y=()=>{i.onChromeChange?.(),X(e)},b=()=>{h.style.right=``,h.style.bottom=``},ee=()=>{h.style.left=`0`,h.style.top=`0`,h.style.right=`0`,h.style.bottom=`var(--env-shell-chrome-stack-reserve, 2.5rem)`,h.style.width=`auto`,h.style.height=`auto`,h.style.removeProperty(`--ui-win-width`),h.style.removeProperty(`--ui-win-height`)},x=()=>{h.style.left=`0`,h.style.top=`0`,h.style.right=`0`,h.style.bottom=`0`,h.style.width=`100%`,h.style.height=`100%`,h.style.removeProperty(`--ui-win-width`),h.style.removeProperty(`--ui-win-height`)},S=()=>{let t=!!f.matches,n=Y(e),r=(o.value??10)+n;h.style.zIndex=String(r),t&&(l.value&&=!1,!c.value&&!m.value&&!s.value&&(s.value=!0));let i=!!m.value,d=!!c.value,p=!t&&!!l.value&&!i&&!d,g=t&&!i&&!d,_=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??document.querySelector?.(`.env-shell-root, env-shell-container`),v=_ instanceof HTMLElement&&_.hasAttribute(`data-status-overlay`)||document.documentElement.hasAttribute(`data-env-status-overlay`),y=_ instanceof HTMLElement&&_.hasAttribute(`data-standalone`)||document.documentElement.hasAttribute(`data-env-standalone`),S=v&&!i&&!d&&(g||p),C=Ke(),w=y&&t&&!i&&!d||C&&t&&!i&&!d;if(h.toggleAttribute(`native-mode`,i&&!d),h.toggleAttribute(`minimized`,d),h.toggleAttribute(`data-mobile-max`,g),h.toggleAttribute(`data-desk-max`,p),h.toggleAttribute(`data-status-gap`,S),h.toggleAttribute(`data-no-titlebar`,w),h.toggleAttribute(`maximized`,!d&&(p||g||i)),d){h.setVisible(!1),X(e);return}if(h.setVisible(!!u.value),!u.value){X(e);return}if(i){x(),X(e);return}if(g){h.style.left=`0`,h.style.top=`0`,h.style.right=`0`,h.style.bottom=`0`,h.style.width=`100%`,h.style.height=`auto`,X(e);return}if(p){ee(),X(e);return}b(),h.applyBounds({x:a.x.value,y:a.y.value,w:a.w.value,h:a.h.value,z:r}),X(e)},C=()=>{f.matches&&(m.value||(s.value=!0),l.value&&(l.value=!1,v&&=(a.x.value=v.x,a.y.value=v.y,a.w.value=v.w,a.h.value=v.h,null))),S(),y()};f.matches&&!m.value&&!c.value&&(s.value=!0);let w=p(()=>{S()},[a.x,a.y,a.w,a.h,o,s,c,l,m,u],{triggerImmediately:!0});f.addEventListener(`change`,C);let T=()=>{S(),y()},E=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??document.documentElement;E?.addEventListener?.(`env-chrome-surface`,T);let D=()=>{c.value&&(c.value=!1,u.value=!0),r();let t=Y(e),n=(o.value??10)+t;typeof h.bringToFront==`function`?h.bringToFront(n):(h.style.zIndex=String(n),h.toggleAttribute(`data-focused`,!0)),y()},O=e=>{let t=e.detail;m.value||l.value||s.value||c.value||(typeof t?.x==`number`&&(a.x.value=t.x),typeof t?.y==`number`&&(a.y.value=t.y))},te=e=>{let t=e.detail;m.value||l.value||s.value||c.value||(typeof t?.w==`number`&&(a.w.value=t.w),typeof t?.h==`number`&&(a.h.value=t.h))},k=()=>{m.value&&=!1,l.value&&(l.value=!1,v&&=(a.x.value=v.x,a.y.value=v.y,a.w.value=v.w,a.h.value=v.h,null)),c.value=!0,S(),y()},A=()=>{if(m.value){j();return}if(f.matches){c.value=!1,s.value=!0,S(),y();return}if(c.value&&=!1,l.value){M();return}v={x:a.x.value,y:a.y.value,w:a.w.value,h:a.h.value},l.value=!0,S(),y()},ne=()=>{c.value&&(c.value=!1,u.value=!0),!m.value&&!l.value&&!s.value&&(v={x:a.x.value,y:a.y.value,w:a.w.value,h:a.h.value}),l.value=!1,s.value=!1,m.value=!0,S(),y()},j=()=>{m.value&&(m.value=!1,v&&=(a.x.value=v.x,a.y.value=v.y,a.w.value=v.w,a.h.value=v.h,null),f.matches&&(s.value=!0),S(),y())},M=()=>{if(m.value){j();return}c.value&&(c.value=!1,u.value=!0),f.matches?s.value&&=!1:l.value&&(l.value=!1,v&&=(a.x.value=v.x,a.y.value=v.y,a.w.value=v.w,a.h.value=v.h,null)),S(),y()},N=!1,P=!1,F=t=>{if(t.preventDefault(),!(N||P)){N=!0;try{m.value&&=!1,u.value=!1,i.onClose?.()}catch(e){console.error(`[mount-ui-window] onClose failed`,e)}finally{if(!P){P=!0,w?.(),f.removeEventListener(`change`,C),E?.removeEventListener?.(`env-chrome-surface`,T);try{h.isConnected&&h.remove()}catch{}}X(e)}}},I=0,re=()=>{let e=typeof performance<`u`?performance.now():Date.now();return e-I<280?!1:(I=e,!0)},ie=e=>{if(!(N||P)&&re()){if(e===`close`){F(new Event(`window-close`,{cancelable:!0}));return}if(e===`exit-native`){j();return}if(e===`maximize`){m.value||l.value||s.value?M():A();return}c.value?M():k()}},ae=e=>{let t=typeof e.composedPath==`function`?e.composedPath():[];for(let e of t){if(!(e instanceof Element))continue;let t=e.getAttribute?.(`data-ui-win-action`);if(t===`close`||t===`exit-native`||t===`maximize`||t===`minimize`)return t;if(e.matches?.(`.title-close`))return`close`;if(e.matches?.(`.title-exit-native`))return`exit-native`;if(e.matches?.(`.title-maximize`))return`maximize`;if(e.matches?.(`.title-minimize`))return`minimize`}return null},L=e=>{if(N||P||e.defaultPrevented)return;let t=ae(e);t&&(e.preventDefault(),e.stopPropagation(),ie(t))},R=null,z=()=>{let e=h.shadowRoot;if(!e||N||P)return;let t=e.querySelectorAll(`[data-ui-win-action], .title-minimize, .title-maximize, .title-close, .title-exit-native`);for(let e of t){let t=e.getAttribute(`data-ui-win-action`);if(t||(e.classList.contains(`title-close`)?t=`close`:e.classList.contains(`title-exit-native`)?t=`exit-native`:e.classList.contains(`title-maximize`)?t=`maximize`:e.classList.contains(`title-minimize`)&&(t=`minimize`)),!t)continue;e.setAttribute(`data-ui-win-action`,t);let n=t,r=e=>{e.defaultPrevented||(e.preventDefault(),e.stopPropagation(),ie(n))};e.onclick=r,e.onpointerup=e=>{e.button===0&&r(e)}}};if(z(),queueMicrotask(z),requestAnimationFrame(z),typeof MutationObserver<`u`){R=new MutationObserver(()=>z());let e=()=>{h.shadowRoot?R?.observe(h.shadowRoot,{childList:!0,subtree:!0}):requestAnimationFrame(e)};e()}return h.addEventListener(`window-focus`,D),h.addEventListener(`window-move`,O),h.addEventListener(`window-resize`,te),h.addEventListener(`window-minimize`,k),h.addEventListener(`window-maximize`,A),h.addEventListener(`window-restore`,M),h.addEventListener(`window-native`,ne),h.addEventListener(`window-exit-native`,j),h.addEventListener(`window-close`,F),h.addEventListener(`click`,L),h.addEventListener(`pointerup`,L),()=>{if(!P){P=!0,N=!0,w?.(),R?.disconnect(),R=null,f.removeEventListener(`change`,C),E?.removeEventListener?.(`env-chrome-surface`,T),h.removeEventListener(`window-focus`,D),h.removeEventListener(`window-move`,O),h.removeEventListener(`window-resize`,te),h.removeEventListener(`window-minimize`,k),h.removeEventListener(`window-maximize`,A),h.removeEventListener(`window-restore`,M),h.removeEventListener(`window-native`,ne),h.removeEventListener(`window-exit-native`,j),h.removeEventListener(`window-close`,F),h.removeEventListener(`click`,L),h.removeEventListener(`pointerup`,L);try{m.value&&=!1,h.isConnected&&h.remove()}catch{}X(e)}}}var Z;function Ye(){return(Ye=e((()=>{f(),m(),ue(),Z=null})))()}function Q(e,t){let n=typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(t):t.replace(/\\/g,`\\\\`).replace(/"/g,`\\"`),r=e.querySelector(`:scope > ui-window[data-ui-window-view="${n}"]`)||e.querySelector(`:scope > ui-window[data-wf-managed-view="${n}"]`)||e.querySelector(`:scope > section.wf-frame[data-wf-managed-view="${n}"]`);return r instanceof HTMLElement?r:null}function Xe(e){let t=String(e||``).trim();if(!t)return`browser`;let n=2166136261;for(let e=0;e<t.length;e++)n^=t.charCodeAt(e),n=Math.imul(n,16777619);return`browser:${(n>>>0).toString(36)}`}function Ze(e){try{return new URL(e).hostname.replace(/^www\./i,``)||`Browser`}catch{return`Browser`}}function Qe(e){let t=String(e||``).trim().toLowerCase();return t===`browser`||t===`web`||t===`iframe`||t===`web-view`||t===`webview`?`browser`:t}function $e(e){let t=String(e||``).trim().toLowerCase();return it[t]?it[t]:t.startsWith(`browser:`)?it.browser:`app-window`}function et(e){return Qe(e)===`browser`?()=>y(()=>import(`./browser-view-BS6Mffes.js`),[],import.meta.url):null}function tt(e){if(!e||typeof e!=`object`)return``;let t=e,n=t.params&&typeof t.params==`object`&&!Array.isArray(t.params)?t.params:{};return String(n.url||n.href||n.src||t.url||t.href||t.src||``).trim()}function $(e,t){let n=K(e)||String(e||``).trim().toLowerCase(),r=n.startsWith(`browser:`)?`browser`:n;if(t?.[n])return t[n];if(t?.[r])return t[r];if(at[r])return at[r];let i=String(e||``).trim();return i?i.charAt(0).toUpperCase()+i.slice(1):`View`}function nt(e,t){let n=document.createElement(`div`);return n.className=`wf-view-placeholder`,n.setAttribute(`part`,`placeholder`),n.innerHTML=`<p class="wf-view-placeholder__title">${$(e,t)}</p>
<p class="wf-view-placeholder__hint">No window module is registered for this shortcut in environment-shell yet.</p>`,n}function rt(e,t={}){let n=h(120),r=new Map,i=!1,a=null;Y(e);let o=0,s=()=>{i||(o||=requestAnimationFrame(()=>{o=0,i||t.onTaskingChange?.(c())}))},c=()=>{let n=[];for(let i of r.values())Q(e,i.key)&&n.push({id:i.key,title:i.model.title||$(i.key,t.viewTitles),icon:$e(i.key),focused:a===i.key,minimized:!!i.model.minimized.value,visible:!!i.model.visible.value});return n},l=()=>{for(let t of r.values()){let n=Q(e,t.key);if(!n)continue;n.toggleAttribute(`data-focused`,!1);let r=n.clearFocused;typeof r==`function`&&r.call(n)}},u=e=>{for(let[t,n]of r)e&&t===e||n.model.nativeMode?.value&&(n.model.nativeMode.value=!1)},d=(t,r)=>{if(a===r&&!t.minimized.value){let t=Q(e,r);if(t&&t===e.lastElementChild)return}n.value+=1,t.z.value=n.value,t.minimized.value=!1,t.visible.value=!0,a=r,t.nativeMode?.value&&u(r);let i=Q(e,r);if(i){let n=Y(e),r=(t.z.value??10)+n;l(),i.style.zIndex=String(r),i.toggleAttribute(`data-focused`,!0);let a=i.bringToFront;typeof a==`function`&&a.call(i,r),i.parentElement===e&&i!==e.lastElementChild&&e.appendChild(i)}s()},f={showMessage:e=>{console.log(`[environment] ${typeof e==`string`?e:String(e??``)}`)}},p=t.overlayMountHost?Me(t.overlayMountHost):null;f.resolveOverlayMountPoint=e=>{if(p)return p;if(t.environmentShellHost){let e=ne(t.environmentShellHost);if(e)return e}return A(e??null)};let m=e=>{let n=Qe(K(e)||String(e||``).trim().toLowerCase());return t.viewLoaders?.[n]||et(n)},g=()=>{let i=t.readerWindow;if(!i?.content)return;let o=q,c=r.get(o);if(c&&Q(e,o)){d(c.model,o);return}if(c&&!Q(e,o)){r.delete(o);try{c.disposeFrame()}catch{}}let l=i.seed||{},u=Ie(i.title||$(o,t.viewTitles),{x:l.x??96,y:l.y??96,w:l.w??420,h:l.h??340,z:l.z??n.value+1});n.value=u.z.value;let f=()=>{};f=Je(e,u,i.content,()=>d(u,o),{managedViewKey:o,onChromeChange:s,onClose:()=>{let e=r.get(o);if(e){r.delete(o),a===o&&(a=null);try{e.disposeFrame()}catch{}s()}}}),r.set(o,{key:o,model:u,disposeFrame:f}),d(u,o)},_=(e,t)=>{if(i)return;let n=K(String(e||``).trim());if(n=Qe(n),n&&n!==`home`&&n!==`airpad`){try{let e=document.documentElement.dataset.cwspNativeShell===`capacitor`||!!globalThis.Capacitor?.isNativePlatform?.();if(document.documentElement.dataset.cwspSku===`launcher`&&e){M(n).then(e=>{e||v(n,t)});return}}catch{}v(n,t)}},v=(o,c)=>{if(i)return;let l={...c?.params||{}},p=tt(c);p&&(l.url=p,l.href=p);let h=o===`browser`?String(l.windowKey||``).trim()||Xe(p):o;if(Re(o)&&t.readerWindow?.content){g();return}let _=new Set((t.startNativeViewIds||[]).map(e=>K(String(e||``)))).has(o)||String(c?.native||``)===`1`||String(l.native||``)===`1`,v=r.get(h);if(v&&Q(e,h)){if(d(v.model,h),_&&v.model.nativeMode&&(v.model.nativeMode.value=!0,v.model.minimized.value=!1,v.model.visible.value=!0,u(h)),Re(o)){let e=String(l.src||l.source||l.path||``).trim(),t=String(l.filename||l.name||``).trim(),n=String(l.content||``);if(e||n.trim())try{globalThis.dispatchEvent(new CustomEvent(`cwsp:document-open`,{detail:{src:e,filename:t,content:n}}))}catch{}}if(o===`browser`&&p)try{let t=Q(e,h),n=t?.querySelector?.(`iframe.wf-browser__frame`),r=t?.querySelector?.(`input.wf-browser__url`);if(n&&n.src!==p&&(n.src=p),r&&(r.value=p),p)try{v.model.title=Ze(p)}catch{}}catch{}return}if(v&&!Q(e,h)){v.disposeView?.(),r.delete(h);try{v.disposeFrame()}catch{}}let y=m(o),b=document.createElement(`div`);b.className=`wf-view-host env-ui-window__view-host`,b.setAttribute(`part`,`view-host`);{let e=document.createElement(`p`);e.className=`wf-view-placeholder__hint`,e.style.cssText=`margin:1rem;font:400 .9rem/1.4 system-ui,sans-serif;opacity:.8`,e.textContent=`Loading ${$(o,t.viewTitles)}…`,b.append(e)}let ee=r.size*24,x=Ie(o===`browser`&&p?Ze(p):$(o,t.viewTitles),{x:72+ee,y:72+ee,w:o===`browser`?720:640,h:o===`browser`?520:480,z:n.value+1});n.value=x.z.value;let S=()=>{};S=Je(e,x,b,()=>d(x,h),{managedViewKey:h,startNative:_,onChromeChange:s,onClose:()=>{let e=r.get(h);if(e){r.delete(h),a===h&&(a=null);try{e.disposeView?.()}catch{}try{e.disposeFrame()}catch{}s()}}}),_&&(x.nativeMode.value=!0,u(h));let C={key:h,model:x,disposeFrame:S,disposeView:void 0};r.set(h,C),d(x,h);let w={...c||{},shellContext:f};if((o===`browser`&&p||p&&!(w.params&&(w.params.url||w.params.href)))&&(w.params={...w.params||{},url:p,href:p}),!y){b.replaceChildren(nt(o,t.viewTitles));return}Ge(y,b,w).then(e=>{if(i){e();return}let t=r.get(h);t&&(t.disposeView=e),(_||x.nativeMode?.value)&&(x.nativeMode.value=!0,x.minimized.value=!1,x.visible.value=!0,u(h),d(x,h))},e=>{console.error(`[workspace-window-layer] mountViewModule failed for view "${o}"`,e),b.replaceChildren(nt(o,t.viewTitles))})};return f.navigate=(e,t)=>{_(String(e),t)},f.openView=(e,t)=>{_(String(e),t)},{shellContext:f,dispose:()=>{if(!i){i=!0,o&&=(cancelAnimationFrame(o),0);for(let e of r.values())e.disposeView?.(),e.disposeFrame();r.clear(),a=null,s()}},focusWindow:t=>{let n=K(String(t||``)),i=r.get(n);return!i||!Q(e,n)?!1:(d(i.model,n),!0)},minimizeWindow:t=>{let n=K(String(t||``)),i=r.get(n);return!i||!Q(e,n)?!1:(i.model.nativeMode?.value&&(i.model.nativeMode.value=!1),i.model.desktopMaximized?.value&&(i.model.desktopMaximized.value=!1),i.model.visible.value=!0,i.model.minimized.value=!0,a===n&&(a=null,l()),s(),!0)},minimizeAllWindows:()=>{if(!i){u(null),a=null,l();for(let t of r.values())Q(e,t.key)&&(t.model.desktopMaximized?.value&&(t.model.desktopMaximized.value=!1),t.model.visible.value=!0,t.model.minimized.value=!0);s()}},closeWindow:e=>{let t=K(String(e||``)),n=r.get(t);if(!n)return!1;r.delete(t),a===t&&(a=null);try{n.disposeView?.()}catch{}try{n.disposeFrame()}catch{}return s(),!0},blurWindows:()=>{u(null),a=null,l(),s()},closeAllWindows:()=>{if(!i){u(null);for(let e of[...r.values()]){try{e.disposeView?.()}catch{}try{e.disposeFrame()}catch{}}r.clear(),a=null,s()}},enterNative:t=>{let n=K(String(t||``)),i=r.get(n);return!i||!Q(e,n)?!1:(u(n),i.model.nativeMode.value=!0,i.model.minimized.value=!1,i.model.visible.value=!0,d(i.model,n),!0)},exitNative:e=>{if(e){let t=K(String(e||``)),n=r.get(t);n?.model.nativeMode&&(n.model.nativeMode.value=!1),s();return}u(null),s()},listWindowTasks:c,getFocusedKey:()=>a}}var it,at;function ot(){return(ot=e((()=>{f(),D(),Le(),Be(),Pe(),Ye(),ae(),v(),it={home:`house`,viewer:`article`,markdown:`article`,browser:`globe`,web:`globe`,explorer:`books`,settings:`gear-six`,apps:`squares-four`,workcenter:`briefcase`,history:`clock-counter-clockwise`,editor:`pencil-simple-line`,network:`wifi-high`,task:`list-checks`,event:`calendar`,bonus:`gift`,person:`address-book`},at={home:`Home`,viewer:`Markdown`,browser:`Browser`,web:`Browser`,explorer:`Explorer`,settings:`Settings`,apps:`Apps`,workcenter:`Work Center`,history:`History`,editor:`Editor`,network:`Network`,task:`Plan`,event:`Events`,bonus:`Bonuses`,person:`Contacts`}})))()}function st(e,t=lt){try{localStorage.getItem(t)||localStorage.setItem(t,e)}catch{}}function ct(e,t){l();let n=L(),r=I();r&&be();let i,a;if(r)i=document.createElement(`ui-statusbar`),i.className=`env-ui-statusbar`,i.hidden=!0,a=()=>{i.remove()};else{let e=ie(t.shell,t.introHtml,n);i=e.element,a=e.dispose}let o=document.createElement(`div`);o.className=`env-shell-chrome wf-chrome-no-select`;let s;if(t.taskbar){try{let e=oe();e&&P(e)}catch{}s=ce({...t.taskbar,device:n}),o.append(s.element,i)}else o.append(i);let c=(e.classList?.contains(`env-shell-root`)?e:null)||e.closest?.(`.env-shell-root`)||e.closest?.(`env-shell-container`)||e;pe(c),globalThis.__ENV_OVERLAY_MOUNT__=Me,Me(c),fe();let u=typeof matchMedia==`function`?matchMedia(`(min-width: 641px) and (not ((pointer: coarse) or (hover: none)))`):null,d=typeof matchMedia==`function`?[`(display-mode: standalone)`,`(display-mode: fullscreen)`,`(display-mode: minimal-ui)`,`(display-mode: browser)`,`(display-mode: window-controls-overlay)`].map(e=>matchMedia(e)):[],f=()=>{let e=!u||u.matches,t=R(),n=se(),r=re({desktop:e,standalone:n,displayMode:t});o.toggleAttribute(`data-desktop`,e),o.toggleAttribute(`data-standalone`,n),o.toggleAttribute(`data-status-overlay`,r),o.dataset.chromeLayout=e?`desktop`:`mobile`,o.dataset.displayMode=t,c.toggleAttribute(`data-standalone`,n),c.toggleAttribute(`data-status-overlay`,r),c.dataset.displayMode=t,c.style.setProperty(`--env-status-inset-top`,r?`max(2rem, env(safe-area-inset-top, 0px))`:`0px`),document.documentElement.toggleAttribute(`data-env-status-overlay`,r),document.documentElement.toggleAttribute(`data-env-standalone`,n);try{c.dispatchEvent(new CustomEvent(`env-chrome-surface`,{bubbles:!0,detail:{statusOverlay:r,standalone:n,displayMode:t,desktop:e}}))}catch{}};f(),u?.addEventListener?.(`change`,f);for(let e of d)e.addEventListener?.(`change`,f);document.addEventListener(`fullscreenchange`,f),document.addEventListener(`webkitfullscreenchange`,f);let p=r?()=>{}:de(c);return De(e)&&(o.slot=O.overlay),e.appendChild(o),{root:o,device:n,statusBar:i,taskbar:s,disposeDevice:()=>{u?.removeEventListener?.(`change`,f);for(let e of d)e.removeEventListener?.(`change`,f);document.removeEventListener(`fullscreenchange`,f),document.removeEventListener(`webkitfullscreenchange`,f),p(),a(),n.dispose(),pe(null)}}}var lt;function ut(){return(ut=e((()=>{F(),Se(),z(),le(),je(),Pe(),D(),N(),me(),j(),s(),Fe(),ot(),Ye(),lt=`rs-wallpaper-image`})))()}function dt(e){pt().set(e)}var ft,pt;function mt(){return(mt=e((()=>{ft=`__CWSP_LAUNCHER_HOME_HOOKS_V1__`,pt=()=>{let e=globalThis;return{get:()=>ft in e?e[ft]:null,set:t=>{e[ft]=t}}}})))()}var ht;function gt(){return(gt=e((()=>{ht=`*,
*::before,
*::after {
    box-sizing: border-box;
}
